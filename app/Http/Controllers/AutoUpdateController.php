        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Artisan::call('view:clear');
                    Artisan::call('route:clear');
                    // optimize:clear deletes the package/service manifests
                    // (bootstrap/cache/packages.php + services.php). Regenerate them
                    // here, while still in maintenance mode, so they are not rebuilt
                    // (and raced by concurrent boots, e.g. the scheduler) under live
                    // traffic once the app comes back up — which intermittently broke
