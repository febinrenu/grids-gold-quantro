...
class CustomerDisplayController extends Controller
{
    ...
    public function broadcastCart(Request $request)
    {
        ...
        // Best-effort real-time push. The cached last-cart above is what the
        // polling display actually reads, so a broadcasting failure (driver
        // misconfig, transport down, etc.) must never break the POS request.
        try {
