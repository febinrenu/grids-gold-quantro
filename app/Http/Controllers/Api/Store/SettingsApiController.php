...
class SettingsApiController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'theme' => 'nullable|string|in:default,aurumeclat,elegance,naturae,nexgold,monolith,kiosk,atlas,ledger,deco,draft,poeme,cobalt,lumen,nocturne,solstice,verdant,vermeil,meridian,orbit',
