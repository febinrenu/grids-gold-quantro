...
class SmsOtpSender
{
     ...
     * (twilio | infobip | termii | custom). Provider credentials are read from
     * the environment. Used by both tenant-scoped (OTP) and central
     * (platform reminders) callers so the provider logic lives in one place.
     */
    public function sendVia(string $gatewayTitle, string $toPhone, string $message): void
    {
