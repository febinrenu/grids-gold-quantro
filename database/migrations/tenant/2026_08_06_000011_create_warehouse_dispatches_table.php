...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('warehouse_dispatches', function (Blueprint $table) {
            ...
            $table->id();
            $table->string('dispatch_number', 40);
            ...
            $table->unique('dispatch_number', 'warehouse_dispatches_number_unique');
            $table->index(['source_type', 'source_id'], 'warehouse_dispatches_source_index');
        });
    }
