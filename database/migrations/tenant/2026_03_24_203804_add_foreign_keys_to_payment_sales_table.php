...
return new class extends Migration
{
    ...
    {
        Schema::table('payment_sales', function (Blueprint $table) {
            $table->dropForeign('payment_sales_sale_id_foreign');
            $table->dropForeign('payment_sales_account_id_foreign');
            $table->dropForeign('payment_sales_payment_method_id_foreign');
            $table->dropForeign('payment_sales_user_id_foreign');
        });
    }
};
