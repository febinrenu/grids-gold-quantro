...
return new class extends Migration
{
    ...
    {
        Schema::table('quotation_details', function (Blueprint $table) {
            $table->dropForeign('quotation_details_product_id_foreign');
            $table->dropForeign('quotation_details_quotation_id_foreign');
            $table->dropForeign('quotation_details_product_variant_id_foreign');
            $table->dropForeign('quotation_details_sale_unit_id_foreign');
        });
    }
};
