...
return new class extends Migration
{
    ...
    {
        Schema::table('sale_return_details', function (Blueprint $table) {
            $table->dropForeign('sale_return_details_product_id_foreign');
            $table->dropForeign('sale_return_details_sale_return_id_foreign');
            $table->dropForeign('sale_return_details_product_variant_id_foreign');
            $table->dropForeign('sale_return_details_sale_unit_id_foreign');
        });
    }
};
