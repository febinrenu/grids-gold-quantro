    ...
    <div class="row mt-3 p-5">
        <div class="col-12">
            <form action="{{route('setupStep1')}}" method="post">
                ...
                <div class="form-group">
                    <label for="app_url">Application URL</label> <span class="tip" title="The full URL where this application will be accessed (e.g. https://yourdomain.com)"><i class="fa fa-question-circle" aria-hidden="true"></i></span>
                    <input type="url" class="form-control" id="app_url" name="app_url" placeholder="https://yourdomain.com" value="{{ old('app_url', session('env.APP_URL') ?: request()->getSchemeAndHttpHost()) }}" required>
                    <small class="form-text text-muted">Enter your domain name, not the server IP address.</small>
                </div>
