...
<div class="theme-nexgold bg-nx-sand text-nx-ink">
    ...
    <div class="grid md:grid-cols-3 md:grid-rows-2 gap-3 md:gap-4" style="min-height: 460px;">
      <div class="md:col-span-2 md:row-span-2 relative rounded-xl2 overflow-hidden min-h-[280px]">
        ...
        <div class="relative z-10 h-full flex flex-col justify-center p-6 md:p-10 max-w-md">
          <span class="eyebrow text-nx-gold mb-3 block">{{ __('messages.Nexgold_EstTrustCertifiedQuality') }}</span>
          <h1 class="font-serif italic text-4xl md:text-5xl text-white leading-[1.05] mb-4">{{ $s->hero_title ?? __('messages.Nexgold_EverythingInFineJewelry') }}</h1>
          <p class="text-white/75 text-sm md:text-base mb-6">{{ $s->hero_subtitle ?? __('messages.Nexgold_HeroSubtitle') }}</p>
          <div class="flex flex-wrap gap-3">
            <a href="{{ route('store.shop') }}" class="bg-nx-gold hover:bg-white transition text-nx-navy font-bold px-6 py-3 rounded-lg text-sm">{{ __('messages.Nexgold_ShopAllJewelry') }}</a>
            <a href="{{ route('store.contact') }}" class="border border-white/50 text-white font-bold px-6 py-3 rounded-lg text-sm hover:bg-white/10 transition">{{ __('messages.Nexgold_BookConsultation') }}</a>
          </div>
        </div>
      </div>
      ...
      <a href="{{ route('store.shop', ['category' => optional(($categories ?? collect())->first())->id]) }}"
        ...
        <div class="relative z-10 h-full flex flex-col justify-end p-5">
          <span class="eyebrow text-nx-gold mb-1 block">{{ __('messages.Nexgold_Gemstones') }}</span>
          <p class="font-serif italic text-2xl text-white">{{ __('messages.Nexgold_RareColoredStones') }}</p>
        </div>
      </a>
      ...
      <a href="{{ route('store.shop') }}" class="relative rounded-xl2 overflow-hidden min-h-[130px] group">
        ...
        <div class="relative z-10 h-full flex flex-col justify-end p-5">
          <span class="eyebrow text-nx-gold mb-1 block">{{ __('messages.Nexgold_MensJewelry') }}</span>
          <p class="font-serif italic text-2xl text-white">{{ __('messages.Nexgold_BoldUnderstated') }}</p>
        </div>
      </a>
    </div>
  </section>
  ...
  <section class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-4">
      <h2 class="font-serif italic text-2xl text-nx-navy">{{ __('messages.Nexgold_ShopByCategory') }}</h2>
      <a href="{{ route('store.shop') }}" class="text-sm font-bold text-nx-navy hover:text-nx-gold transition">{{ __('messages.ViewAll') }} →</a>
    </div>
    @php
      $catIconPaths = [
      ...
      $catNames = [__('messages.Nexgold_CatRings'), __('messages.Nexgold_CatNecklaces'), __('messages.Nexgold_CatEarrings'), __('messages.Nexgold_CatBangles'), __('messages.Nexgold_CatBracelets'), __('messages.Nexgold_CatPearls'), __('messages.Nexgold_Gemstones'), __('messages.Nexgold_CatBridal'), __('messages.Nexgold_CatGoldCoins'), __('messages.Nexgold_CatNewIn')];
    @endphp
  ...
  <section class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-4">
      <div>
        <span class="eyebrow text-nx-gold mb-1 block">{{ __('messages.Nexgold_JustLanded') }}</span>
        <h2 class="font-serif italic text-2xl text-nx-navy">{{ __('messages.Nexgold_NewArrivals') }}</h2>
      </div>
      <a href="{{ route('store.shop', ['sort' => 'latest']) }}" class="text-sm font-bold text-nx-navy hover:text-nx-gold transition">{{ __('messages.ViewAll') }} →</a>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 md:gap-4">
      ...
      @empty
        <p class="col-span-full text-nx-ink/50 text-sm">{{ __('messages.Nexgold_NoProductsYet') }}</p>
      @endforelse
    </div>
  </section>
  ...
  <section class="max-w-7xl mx-auto px-4 py-4">
    <div class="grid md:grid-cols-2 gap-4">
      <div class="relative rounded-xl2 overflow-hidden min-h-[200px] bg-nx-navy p-7 flex flex-col justify-center">
        <span class="eyebrow text-nx-gold mb-2 block">{{ __('messages.Nexgold_CertifiedInsured') }}</span>
        <h3 class="font-serif italic text-2xl md:text-3xl text-white mb-2">{{ __('messages.Nexgold_EveryPieceGuaranteed') }}</h3>
        <p class="text-white/60 text-sm mb-5 max-w-sm">{{ __('messages.Nexgold_CertifiedInsuredDesc') }}</p>
        <a href="{{ route('store.shop') }}" class="inline-flex items-center gap-2 bg-white text-nx-navy font-bold px-5 py-2.5 rounded-lg text-sm w-fit hover:bg-nx-gold transition">{{ __('messages.Nexgold_ShopWithConfidence') }}</a>
      </div>
  ...
  <section class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-4">
      <div>
        <span class="eyebrow text-nx-gold mb-1 block">{{ __('messages.Nexgold_CustomerFavorites') }}</span>
        <h2 class="font-serif italic text-2xl text-nx-navy">{{ __('messages.Nexgold_Bestsellers') }}</h2>
      </div>
      <a href="{{ route('store.shop') }}" class="text-sm font-bold text-nx-navy hover:text-nx-gold transition">{{ __('messages.ViewAll') }} →</a>
    </div>
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 md:gap-4">
  ...
  <section class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-4">
      <div>
        <span class="eyebrow text-nx-gold mb-1 block">{{ __('messages.Nexgold_ForEveryOccasion') }}</span>
        <h2 class="font-serif italic text-2xl text-nx-navy">{{ __('messages.Nexgold_GoldGiftIdeas') }}</h2>
      </div>
      <a href="{{ route('store.shop') }}" class="text-sm font-bold text-nx-navy hover:text-nx-gold transition">{{ __('messages.ViewAll') }} →</a>
    </div>
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 md:gap-4">
  ...
  <section class="bg-nx-card border-y border-nx-border py-8">
    <div class="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-5 gap-6">
      <div class="flex items-center gap-2.5">
        ...
        <div><p class="font-bold text-xs md:text-sm text-nx-navy">{{ __('messages.Nexgold_CertifiedDiamonds') }}</p><p class="text-[10px] md:text-xs text-nx-ink/50">{{ __('messages.Nexgold_IgiGiaGraded') }}</p></div>
      </div>
      <div class="flex items-center gap-2.5">
        ...
        <div><p class="font-bold text-xs md:text-sm text-nx-navy">{{ __('messages.Nexgold_InsuredShipping') }}</p><p class="text-[10px] md:text-xs text-nx-ink/50">{{ __('messages.Nexgold_OnEveryOrder') }}</p></div>
      </div>
      <div class="flex items-center gap-2.5">
        ...
        <div><p class="font-bold text-xs md:text-sm text-nx-navy">{{ __('messages.Nexgold_LifetimeService') }}</p><p class="text-[10px] md:text-xs text-nx-ink/50">{{ __('messages.Nexgold_PolishResizeRepair') }}</p></div>
      </div>
      <div class="flex items-center gap-2.5">
        ...
        <div><p class="font-bold text-xs md:text-sm text-nx-navy">{{ __('messages.Nexgold_EasyReturns') }}</p><p class="text-[10px] md:text-xs text-nx-ink/50">{{ __('messages.Nexgold_30DayPolicy') }}</p></div>
      </div>
      <div class="hidden md:flex items-center gap-2.5">
        ...
        <div><p class="font-bold text-sm text-nx-navy">{{ __('messages.SecurePayment') }}</p><p class="text-xs text-nx-ink/50">{{ __('messages.Nexgold_EncryptedCheckout') }}</p></div>
      </div>
    </div>
  </section>
  ...
  <section class="max-w-7xl mx-auto px-4 py-10">
    <div class="bg-nx-navy rounded-xl2 p-6 md:p-10 grid md:grid-cols-2 gap-6 items-center">
      <div>
        <span class="eyebrow text-nx-gold mb-2 block">{{ __('messages.Nexgold_NexgoldInsider') }}</span>
        <h2 class="font-serif italic text-2xl md:text-3xl text-white mb-2">{{ __('messages.Nexgold_GoldRateAlertsHeading') }}</h2>
        <p class="text-white/60 text-sm">{{ __('messages.Nexgold_NewsletterDesc') }}</p>
      </div>
      <form action="{{ route('newsletter.subscribe') }}" method="POST" class="flex gap-2">
        @csrf
        <input type="email" name="email" required placeholder="{{ __('messages.Nexgold_EnterYourEmail') }}" class="flex-1 min-w-0 px-4 py-3 rounded-lg bg-white/10 border border-white/15 outline-none text-sm text-white placeholder:text-white/40" />
        <button type="submit" class="px-6 py-3 rounded-lg bg-nx-gold text-nx-navy font-bold text-sm hover:bg-white transition shrink-0">{{ __('messages.Subscribe') }}</button>
      </form>
    </div>
  </section>
