      ...
      <nav class="vertical-nav-menu">
        <ul class="nav-list">
          ...
          <li
            ...
            :class="{ active: isActiveRoute('billing'), 'has-submenu': true, open: openMenus.includes('billing') }"
            class="nav-item"
          >
            <a href="#" @click.prevent="toggleSubmenu('billing')" class="nav-link">
              <lucide-icon class="nav-icon" name="credit-card" />
              <span class="nav-text" v-if="!isCollapsed">{{ $t('Billing') || 'Billing' }}</span>
              <lucide-icon class="submenu-arrow" name="chevron-down" v-if="!isCollapsed" />
            </a>
            <ul class="submenu" v-if="openMenus.includes('billing') && !isCollapsed">
              <li class="submenu-item">
                <router-link to="/app/billing/current-plan" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="id-card" />
                  <span>{{ $t('Current_Plan') || 'Current Plan' }}</span>
                </router-link>
              </li>
              <li class="submenu-item">
                <router-link to="/app/billing/change-plan" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="arrow-up-circle" />
                  <span>{{ $t('Change_Plan') || 'Change Plan' }}</span>
                </router-link>
              </li>
              <li class="submenu-item">
                <router-link to="/app/billing/history" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="history" />
                  <span>{{ $t('Billing_History') || 'Billing History' }}</span>
                </router-link>
              </li>
            </ul>
          </li>
          ...
          <li
            ...
            class="nav-item"
          >
            <router-link to="/app/support/tickets" class="nav-link">
              <lucide-icon class="nav-icon" name="life-buoy" />
              <span class="nav-text" v-if="!isCollapsed">{{ $t("support_center") }}</span>
            </router-link>
          </li>
          ...
          >
            ...
            <ul class="submenu" v-if="openMenus.includes('Store') && !isCollapsed">
              ...
              <!-- Real Estate (nested submenu) -->
              <li
                class="submenu-item has-nested"
                :class="{ open: openNestedMenus.includes('realestate') }"
              ...
              >
                <a href="#" @click.prevent="toggleNestedSubmenu('realestate')" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="building" />
                  <span>{{ $t('Real_Estate') }}</span>
                  <lucide-icon class="nested-arrow" name="chevron-down" />
                </a>
                <ul class="nested-submenu" v-if="openNestedMenus.includes('realestate')">
                  <li v-if="currentUserPermissions && currentUserPermissions.includes('realestate_properties')">
                    <router-link to="/app/realestate/properties" class="nested-link">{{ $t('Properties') }}</router-link>
                  </li>
                  <li v-if="currentUserPermissions && currentUserPermissions.includes('realestate_categories')">
                    <router-link to="/app/realestate/categories" class="nested-link">{{ $t('Property_Categories') }}</router-link>
                  </li>
                  <li v-if="currentUserPermissions && currentUserPermissions.includes('realestate_inquiries')">
                    <router-link to="/app/realestate/inquiries" class="nested-link">{{ $t('Property_Inquiries') }}</router-link>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          >
            ...
            <ul class="submenu" v-if="openMenus.includes('products') && !isCollapsed">
              ...
              <li class="submenu-item" v-if="showPharmacyModule && currentUserPermissions && (currentUserPermissions.includes('view_batches') || currentUserPermissions.includes('batch_view'))">
                <router-link to="/app/products/Batches" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="heart-pulse" />
                  <span>{{ $t('Batches') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('serial_numbers')">
                <router-link to="/app/serial_numbers/list" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="scan-barcode" />
                  <span>{{ $t('Serial_Numbers') }}</span>
                </router-link>
              </li>
            </ul>
          </li>
          ...
          >
            ...
            <ul class="submenu" v-if="openMenus.includes('sales') && !isCollapsed">
              ...
              <li class="submenu-item" v-if="planFeature('pos') && currentUserPermissions && currentUserPermissions.includes('Pos_view')">
                <router-link to="/app/pos" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="files" />
                  <span>POS</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="showOperationalSalesExtras && currentUserPermissions && currentUserPermissions.includes('customer_display_screen_setup')">
                <router-link to="/app/customer-display/setup" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="files" />
                  <span>{{$t('Customer_Screen')}}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="showOperationalSalesExtras && currentUserPermissions && currentUserPermissions.includes('shipment')">
                <router-link to="/app/sales/shipment" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="files" />
                  <span>{{ $t('Shipments') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="showOperationalSalesExtras && currentUserPermissions && currentUserPermissions.includes('real_time_sales_counter')">
              ...
              <li class="submenu-item" v-if="showOperationalSalesExtras && currentUserPermissions && currentUserPermissions.includes('kitchen_display_view')">
                <router-link to="/app/kitchen-display" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="chef-hat" />
                  <span>{{ $t("KitchenDisplay") || "Kitchen Display" }}</span>
                </router-link>
              </li>
            </ul>
          </li>
          ...
          <!-- Transfers -->
          <li
            v-show="planFeature('transfers') && currentUserPermissions && (
          ...
          <!-- HRM -->
          <li
            v-show="showJewelryMenu('hrm') && planFeature('hrm') && currentUserPermissions && (
          ...
          <!-- Recruit -->
          <li
            v-show="showJewelryMenu('recruit') && currentUserPermissions && (
            ...
            :class="{ active: isActiveRoute('recruit'), 'has-submenu': true, open: openMenus.includes('recruit') }"
            class="nav-item"
          >
            <a href="#" @click.prevent="toggleSubmenu('recruit')" class="nav-link">
              <lucide-icon class="nav-icon" name="users" />
              <span class="nav-text" v-if="!isCollapsed">{{ $t('Recruit') }}</span>
              <lucide-icon class="submenu-arrow" name="chevron-down" v-if="!isCollapsed" />
            </a>
            <ul class="submenu" v-if="openMenus.includes('recruit') && !isCollapsed">
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('recruit_job')">
                <router-link to="/app/recruit/dashboard" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="layout-dashboard" />
                  <span>{{ $t('Dashboard') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('recruit_job')">
                <router-link to="/app/recruit/jobs" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="briefcase-business" />
                  <span>{{ $t('Jobs') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('recruit_candidate')">
                <router-link to="/app/recruit/candidates" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="user" />
                  <span>{{ $t('Candidates') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('recruit_application')">
                <router-link to="/app/recruit/applications" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="file-text" />
                  <span>{{ $t('Applications') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('recruit_interview')">
                <router-link to="/app/recruit/interviews" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="calendar" />
                  <span>{{ $t('Interviews') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('recruit_category')">
                <router-link to="/app/recruit/categories" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="list" />
                  <span>{{ $t('Job_Categories') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('recruit_job')">
                <router-link to="/app/recruit/reports" class="submenu-link">
          ...
          <!-- Meeting Management -->
          <li
            v-show="showJewelryMenu('meeting') && currentUserPermissions && (
            ...
            :class="{ active: isActiveRoute('meeting'), 'has-submenu': true, open: openMenus.includes('meeting') }"
            class="nav-item"
          >
            <a href="#" @click.prevent="toggleSubmenu('meeting')" class="nav-link">
              <lucide-icon class="nav-icon" name="calendar-days" />
              <span class="nav-text" v-if="!isCollapsed">{{ $t('Meetings') }}</span>
              <lucide-icon class="submenu-arrow" name="chevron-down" v-if="!isCollapsed" />
            </a>
            <ul class="submenu" v-if="openMenus.includes('meeting') && !isCollapsed">
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('meeting')">
                <router-link to="/app/meeting/dashboard" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="layout-dashboard" />
                  <span>{{ $t('Dashboard') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('meeting')">
                <router-link to="/app/meeting/meetings" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="calendar-check" />
                  <span>{{ $t('Meetings') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('meeting')">
                <router-link to="/app/meeting/calendar" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="calendar" />
                  <span>{{ $t('Calendar') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('meeting_report')">
                <router-link to="/app/meeting/reports" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="bar-chart-3" />
                  <span>{{ $t('Reports') }}</span>
                </router-link>
              </li>
          ...
          <li
            v-show="showJewelryMenu('marketing') && currentUserPermissions && (
            ...
            :class="{ active: isActiveRoute('marketing'), 'has-submenu': true, open: openMenus.includes('marketing') }"
            class="nav-item"
          >
            <a href="#" @click.prevent="toggleSubmenu('marketing')" class="nav-link">
              <lucide-icon class="nav-icon" name="megaphone" />
              <span class="nav-text" v-if="!isCollapsed">{{ $t('Marketing') }}</span>
              <lucide-icon class="submenu-arrow" name="chevron-down" v-if="!isCollapsed" />
            </a>
            <ul class="submenu" v-if="openMenus.includes('marketing') && !isCollapsed">
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_dashboard')">
                <router-link to="/app/marketing/dashboard" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="layout-dashboard" />
                  <span>{{ $t('Dashboard') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_campaigns')">
                <router-link to="/app/marketing/campaigns" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="megaphone" />
                  <span>{{ $t('Campaigns') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_segments')">
                <router-link to="/app/marketing/segments" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="users" />
                  <span>{{ $t('Customer_Segments') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_templates')">
                <router-link to="/app/marketing/templates/sms" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="message-square" />
                  <span>{{ $t('sms_templates') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_templates')">
                <router-link to="/app/marketing/templates/whatsapp" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="message-circle" />
                  <span>{{ $t('WhatsApp_Templates') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_templates')">
                <router-link to="/app/marketing/templates/email" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="mail" />
                  <span>{{ $t('email_templates') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_reports')">
                <router-link to="/app/marketing/reports" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="bar-chart-3" />
                  <span>{{ $t('Reports') }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_settings')">
                <router-link to="/app/marketing/settings" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="settings" />
                  <span>{{ $t('Marketing_Settings') }}</span>
                </router-link>
              </li>
            </ul>
          </li>
          ...
          <!-- Accounting -->
          <li
            v-show="planFeature('accounting') && currentUserPermissions && (
          ...
          >
           ...
           <li
           v-if="showJewelryMenu('woocommerce_settings') && planFeature('woocommerce') && currentUserPermissions && currentUserPermissions.includes('woocommerce_settings')"
          ...
          <!-- Knowledge Base -->
          <li
            v-show="showJewelryMenu('knowledge_base') && currentUserPermissions && currentUserPermissions.includes('knowledge_base_view')"
          ...
          <li
            ...
            :class="{ active: isActiveRoute('whatsapp_settings') || isActiveRoute('whatsapp_templates') || isActiveRoute('whatsapp_logs'), 'has-submenu': true, open: openMenus.includes('whatsapp') }"
            class="nav-item"
          >
            <a href="#" @click.prevent="toggleSubmenu('whatsapp')" class="nav-link">
              <lucide-icon class="nav-icon" name="message-square" />
              <span class="nav-text" v-if="!isCollapsed">WhatsApp</span>
              <lucide-icon class="submenu-arrow" name="chevron-down" v-if="!isCollapsed" />
            </a>
            <ul class="submenu" v-if="openMenus.includes('whatsapp') && !isCollapsed">
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('whatsapp_settings')">
                <router-link to="/app/whatsapp/settings" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="settings" />
                  <span>Settings</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('whatsapp_templates')">
                <router-link to="/app/whatsapp/templates" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="message-square" />
                  <span>Templates</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('whatsapp_logs')">
                <router-link to="/app/whatsapp/logs" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="list" />
          ...
          >
            ...
            <ul class="submenu" v-if="openMenus.includes('reports') && !isCollapsed">
              ...
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('serial_numbers_report')">
                <router-link to="/app/reports/serial_available_report" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="scan-barcode" />
                  <span>{{ $t('Available_Serial_Numbers') || 'Available Serials' }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('serial_numbers_report')">
                <router-link to="/app/reports/serial_sold_report" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="scan-barcode" />
                  <span>{{ $t('Sold_Serial_Numbers') || 'Sold Serials' }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('serial_numbers_report')">
                <router-link to="/app/reports/serial_movement_report" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="history" />
                  <span>{{ $t('Serial_Movement_Log') || 'Serial Movements' }}</span>
                </router-link>
              </li>
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('serial_numbers_report')">
                <router-link to="/app/reports/serial_inventory_report" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="layers" />
                  <span>{{ $t('Product_Serial_Inventory') || 'Serial Inventory' }}</span>
                </router-link>
              </li>
    ...
    hasVisibleSalesMenu() {
      ...
      return permissions.includes('Sales_view')
        ...
        || (this.showOperationalSalesExtras && (
          ...
          || permissions.includes('kitchen_display_view')
        ));
    },
