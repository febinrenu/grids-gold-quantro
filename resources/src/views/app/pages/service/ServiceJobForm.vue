                ...
                <b-row>
                  ...
                  <b-col md="4">
                    <b-form-group :label="$t('End_Time')">
                      <b-form-input v-model="form.scheduled_end_date" type="datetime-local" />
                    </b-form-group>
                  </b-col>
                </b-row>
...
export default {
  ...
  methods: {
    ...
    async loadJobIfNeeded() {
      ...
      this.form.scheduled_end_date = job.scheduled_end_date ? String(job.scheduled_end_date).slice(0, 16).replace(' ', 'T') : '';
