        ...
        tooltip: {
          y: {
            formatter: (val, opts) => {
              ...
              return `${this.$t('Stock_Value_by_Price') || 'Stock Value by Price'}: ${this.formatNumber(val, this.priceDecimals)}\n${this.$t('Stock_Value_by_Cost') || 'Stock Value by Cost'}: ${this.formatNumber(extra, this.priceDecimals)}`;
            }
          }
        }
      };
