                            ...
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input
                                  type="checkbox"
                                  v-model="permissions"
                                  value="kitchen_display_manage"
                                >
                                <span>{{ $t('KitchenDisplay') || 'Kitchen Display' }} - {{ $t('Manage') || 'Manage' }}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                  ...
                  <b-card no-body class="ul-card__border-radius">
                    <b-card-header header-tag="header" class="p-1" role="tab">
                      <b-button
                        ...
                        block
                        href="#"
                        v-b-toggle.panel-Billing
                        variant="transparent"
                      >{{ $t('Billing') || 'Billing' }}</b-button>
                    </b-card-header>
                    <b-collapse
                      id="panel-Billing"
                      :visible="true"
                      accordion="my-accordion-billing"
                      role="tabpanel"
                    >
                      <b-card-body>
                        <b-card-text>
                ...
                <b-col md="4">
                  <b-card no-body class="ul-card__border-radius">
                    ...
                    <b-collapse
                      id="panel-recruit"
                      :visible="true"
                      accordion="my-accordion-recruit"
                      role="tabpanel"
                    >
                      <b-card-body>
                        <b-card-text>
                          <b-row>
                            ...
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="recruit_job">
                                <span>{{$t('Jobs')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            ...
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="recruit_category">
                            ...
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="recruit_candidate">
                            ...
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="recruit_application">
                            ...
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="recruit_interview">
                  ...
                  <b-card no-body class="ul-card__border-radius">
                    <b-card-header header-tag="header" class="p-1" role="tab">
                      <b-button
                        ...
                        block
                        href="#"
                        v-b-toggle.panel-meeting
                        variant="transparent"
                      >{{$t('Meeting_Management')}}</b-button>
                    </b-card-header>
                    <b-collapse
                      id="panel-meeting"
                      :visible="true"
                      accordion="my-accordion-meeting"
                      role="tabpanel"
                    >
                      <b-card-body>
                        <b-card-text>
                          <b-row>
                            ...
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="meeting">
                            ...
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="meeting_attendance">
                                <span>{{$t('Manage_Attendance')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <!-- meeting_report -->
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="meeting_report">
                                <span>{{$t('Reports')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                  ...
                  <b-card no-body class="ul-card__border-radius">
                    <b-card-header header-tag="header" class="p-1" role="tab">
                      <b-button
                        ...
                        block
                        href="#"
                        v-b-toggle.panel-marketing
                        variant="transparent"
                      >{{$t('Marketing_Management')}}</b-button>
                    </b-card-header>
                    <b-collapse
                      id="panel-marketing"
                      :visible="true"
                      accordion="my-accordion-marketing"
                      role="tabpanel"
                    >
                      <b-card-body>
                        <b-card-text>
                          <b-row>
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="marketing_dashboard">
                                <span>{{$t('Marketing_Dashboard')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="marketing_campaigns">
                            ...
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="marketing_segments">
                            ...
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="marketing_templates">
                                <span>{{$t('Marketing_Templates')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="marketing_reports">
                                <span>{{$t('Marketing_Reports')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input type="checkbox" v-model="permissions" value="marketing_settings">
