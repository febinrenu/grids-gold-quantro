                  ...
                  <table class="table table-striped table-sm">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>{{currentUser.currency}} {{transfer.TaxNet.toFixed(priceDecimals)}} ({{formatNumber(transfer.tax_rate ,2)}} %)</span>
                        </td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Discount')}}</td>
                        <td>{{currentUser.currency}} {{transfer.discount.toFixed(priceDecimals)}}</td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Shipping')}}</td>
                        <td>{{currentUser.currency}} {{transfer.shipping.toFixed(priceDecimals)}}</td>
                      </tr>
                      <tr>
                        <td>
