      ...
      <div class="header-left">
        <div class="brand">
          <div class="brand-icon">
            <img v-if="currentUser && currentUser.logo" :src="$imgUrl('settings', currentUser.logo)" alt="logo" style="width:100%;height:100%;object-fit:cover;border-radius:12px;" />
...
export default {
  ...
  methods: {
    ...
    resolveProductImage(imagePath) {
      ...
      return this.$imgUrl('products', clean);
    },
