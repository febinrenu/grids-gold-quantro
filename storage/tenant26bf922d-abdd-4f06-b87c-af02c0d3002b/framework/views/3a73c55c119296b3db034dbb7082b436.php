...
<head>
    ...
    <meta name="description" content="<?php echo e(__('landing.admin_login')); ?> — <?php echo e($appName); ?>">
    <title><?php echo e(__('landing.admin_login')); ?> — <?php echo e($appName); ?></title>
    ...
    <link href="<?php echo e(asset('assets_super/css/auth.css')); ?>" rel="stylesheet">
</head>
<body>
    ...
    <div class="login-hero">
        ...
        <div class="hero-content">
            ...
            <h2><?php echo e(__('landing.login_hero_title')); ?></h2>
            <p><?php echo e(__('landing.login_hero_desc')); ?></p>
            <div class="hero-stats">
                <div class="stat">
                    <div class="stat-value">100%</div>
                    <div class="stat-label"><?php echo e(__('landing.stat_secure')); ?></div>
                </div>
                <div class="stat">
                    <div class="stat-value">24/7</div>
                    <div class="stat-label"><?php echo e(__('landing.stat_access')); ?></div>
                </div>
                <div class="stat">
                    <div class="stat-value">Real-time</div>
                    <div class="stat-label"><?php echo e(__('landing.stat_analytics')); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="login-panel">
        <div class="login-form-wrapper">
            ...
            <a class="brand-logo" href="<?php echo e(route('central.welcome')); ?>">
                <div class="logo-icon">
                    <img src="<?php echo e($generalSettings->getLogoUrl() ?: asset('images/logo-default.png')); ?>" alt="<?php echo e($appName); ?>">
                </div>
                <span><?php echo e($appName); ?></span>
            </a>

            <div class="form-heading">
                <h1><?php echo e(__('landing.welcome_back')); ?></h1>
                <p><?php echo e(__('landing.login_subtitle')); ?></p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('central.login.submit')); ?>" autocomplete="on">
                <?php echo csrf_field(); ?>

                <div class="form-group">
                    <label for="email"><?php echo e(__('landing.email_address')); ?></label>
                ...
                <div class="form-group">
                    <label for="password"><?php echo e(__('landing.password')); ?></label>
                    <div class="input-wrapper">
                        <input
                            id="password"
                            name="password"
                ...
                <div class="form-options">
                    <label class="remember-check">
                        ...
                        <span><?php echo e(__('landing.remember_me')); ?></span>
                    </label>
                    <a href="<?php echo e(route('central.password.request')); ?>" class="forgot-link"><?php echo e(__('landing.forgot_password')); ?></a>
                </div>

                <button type="submit" class="btn-login" id="btn-login">
                    <span class="btn-text"><?php echo e(__('landing.sign_in_btn')); ?></span>
            ...
            <div class="divider"><span><?php echo e(__('landing.or')); ?></span></div>
    ...
    <script src="<?php echo e(asset('assets_super/js/login.js')); ?>"></script>
</body>
</html>
<?php /**PATH /home/quantrocousr/public_html/resources/views/central/login.blade.php ENDPATH**/ ?>