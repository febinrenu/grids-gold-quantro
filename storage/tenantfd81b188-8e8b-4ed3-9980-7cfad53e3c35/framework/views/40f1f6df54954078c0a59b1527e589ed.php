...
<div id="subReminderBanner" class="sub-reminder-banner sub-reminder-<?php echo e($level); ?>" data-dismiss-key="<?php echo e($dismissKey); ?>" role="alert" hidden>
    <div class="sub-reminder-inner">
        <span class="sub-reminder-icon">
            <?php if($banner['type'] === 'expired'): ?>
        ...
        <div class="sub-reminder-body">
            <strong class="sub-reminder-title"><?php echo e($title); ?></strong>
            <span class="sub-reminder-text"><?php echo e($text); ?></span>
        </div>
        <a href="<?php echo e(route('billing.plans')); ?>" class="sub-reminder-cta"><?php echo e(__('central.banner_renew')); ?></a>
        <button type="button" class="sub-reminder-close" id="subReminderClose" aria-label="<?php echo e(__('central.banner_dismiss')); ?>">&times;</button>
    </div>
</div>
...
<?php endif; ?>
<?php /**PATH C:\Users\fkr77\Downloads\gridsgoldcode\resources\views/partials/subscription-reminder-banner.blade.php ENDPATH**/ ?>