...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Tenant-aware: do not add 'central' => true. Stancl tenancy injects tenant_id into
        // job payload when jobs are dispatched from tenant context so the worker runs in the correct tenant DB.
        'database' => [
            'driver' => 'database',
            'table' => 'jobs',
            'queue' => 'default',
