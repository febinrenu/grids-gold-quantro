...
// Per-tenant manifest (PwaManifestController). The shared /pwa_images icons are
// precached as an offline fallback; each tenant's own icons under /images/...
// are cached lazily on first fetch by the static-asset handler below.
const PRECACHE_URLS = [
  OFFLINE_URL,
  '/pwa/app.webmanifest',
