...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "d-flex align-items-center justify-content-between customize-toggle-row"
  }, [_c("div", [_c("div", {
    staticClass: "customize-toggle-title"
  }, [_vm._v("Show the floating Customize button")]), _vm._v(" "), _c("div", {
    staticClass: "customize-toggle-hint"
    ...
    staticClass: "switch switch-primary ml-3 mb-0"
  }, [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.setting.customize_button_visible,
      expression: "setting.customize_button_visible"
    }],
    attrs: {
      type: "checkbox"
    },
    domProps: {
      checked: Array.isArray(_vm.setting.customize_button_visible) ? _vm._i(_vm.setting.customize_button_visible, null) > -1 : _vm.setting.customize_button_visible
    },
    on: {
      change: function change($event) {
        var $$a = _vm.setting.customize_button_visible,
          $$el = $event.target,
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && _vm.$set(_vm.setting, "customize_button_visible", $$a.concat([$$v]));
          } else {
            $$i > -1 && _vm.$set(_vm.setting, "customize_button_visible", $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.$set(_vm.setting, "customize_button_visible", $$c);
        }
      }
    }
  }), _vm._v(" "), _c("span", {
    ...
    staticClass: "customize-toggle-title"
  }, [_vm._v(_vm._s(_vm.$t("hide_site_name")))]), _vm._v(" "), _c("div", {
    staticClass: "customize-toggle-hint"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.setting.hide_site_name,
      expression: "setting.hide_site_name"
    }],
    attrs: {
      type: "checkbox"
    },
    domProps: {
      checked: Array.isArray(_vm.setting.hide_site_name) ? _vm._i(_vm.setting.hide_site_name, null) > -1 : _vm.setting.hide_site_name
    },
    on: {
      change: function change($event) {
        var $$a = _vm.setting.hide_site_name,
          $$el = $event.target,
          $$c = $$el.checked ? true : false;
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && _vm.$set(_vm.setting, "hide_site_name", $$a.concat([$$v]));
          } else {
            $$i > -1 && _vm.$set(_vm.setting, "hide_site_name", $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.$set(_vm.setting, "hide_site_name", $$c);
        }
      }
    }
  }), _vm._v(" "), _c("span", {
  ...
  }), _vm._v(" " + _vm._s(_vm.$t("submit")))], 1)], 1)], 1)], 1)], 1)], 1)], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mt-3",
    attrs: {
      lg: "12",
      md: "12",
    ...
    staticClass: "mb-0"
  }, [_vm._v(_vm._s(_vm.$t("Appearance_Settings")) + " - Login Page")])]), _vm._v(" "), _c("b-card-body", [_c("b-row", [_c("b-col", {
    attrs: {
      lg: "6",
      md: "6",
      sm: "12"
    ...
    staticClass: "form-control",
    model: {
      value: _vm.setting.login_hero_title,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "login_hero_title", $$v);
      },
      expression: "setting.login_hero_title"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "6",
    ...
    staticClass: "form-control",
    model: {
      value: _vm.setting.login_hero_subtitle,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "login_hero_subtitle", $$v);
      },
      expression: "setting.login_hero_subtitle"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "6",
    ...
    attrs: {
      label: "Login panel title"
    }
  }, [_c("b-form-input", {
    staticClass: "form-control",
    model: {
      value: _vm.setting.login_panel_title,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "login_panel_title", $$v);
      },
      expression: "setting.login_panel_title"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "6",
    ...
    attrs: {
      label: "Login panel subtitle"
    }
  }, [_c("b-form-input", {
    staticClass: "form-control",
    model: {
      value: _vm.setting.login_panel_subtitle,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "login_panel_subtitle", $$v);
      },
      expression: "setting.login_panel_subtitle"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "6",
    ...
    model: {
      value: _vm.setting.login_hero_badge,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "login_hero_badge", $$v);
      },
      expression: "setting.login_hero_badge"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "6",
    ...
    model: {
      value: _vm.setting.login_hero_feature_1,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "login_hero_feature_1", $$v);
      },
      expression: "setting.login_hero_feature_1"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "6",
    ...
    model: {
      value: _vm.setting.login_hero_feature_2,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "login_hero_feature_2", $$v);
      },
      expression: "setting.login_hero_feature_2"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "6",
    ...
    model: {
      value: _vm.setting.login_hero_feature_3,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "login_hero_feature_3", $$v);
      },
      expression: "setting.login_hero_feature_3"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "6",
    ...
    model: {
      value: _vm.setting.login_btn_text,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "login_btn_text", $$v);
      },
      expression: "setting.login_btn_text"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "6",
    ...
    model: {
      value: _vm.setting.login_footer_text,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "login_footer_text", $$v);
      },
      expression: "setting.login_footer_text"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "12"
