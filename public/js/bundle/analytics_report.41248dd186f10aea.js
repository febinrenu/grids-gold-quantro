(self["webpackChunk"] = self["webpackChunk"] || []).push([["analytics_report"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=script&lang=js"
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=script&lang=js ***!
  \************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    var end = moment__WEBPACK_IMPORTED_MODULE_2___default()().endOf('day').toDate();
    var start = moment__WEBPACK_IMPORTED_MODULE_2___default()().startOf('day').toDate();
    return {
      isLoading: true,
      warehouses: [],
      warehouse_id: null,
      ...
      locale: {
        ...
        daysOfWeek: moment__WEBPACK_IMPORTED_MODULE_2___default().weekdaysMin(),
        monthNames: moment__WEBPACK_IMPORTED_MODULE_2___default().monthsShort(),
        firstDay: 1
      },
      data: {
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(["currentUser"])), {}, {
    ...
    warehouseLabel: function warehouseLabel() {
      var _this = this;
      var w = this.warehouses.find(function (w) {
        return w.id === _this.warehouse_id;
      });
      return w ? w.name : null;
    },
    // Calculate total purchase price (opening stock + purchases)
    totalPurchasePrice: function totalPurchasePrice() {
      return Number(this.data.opening_stock_purchase_price || 0) + Number(this.data.total_purchase_excl_tax || 0);
    },
    // Calculate total sell price (closing stock + sales)
    totalSellPrice: function totalSellPrice() {
      return Number(this.data.closing_stock_sale_price || 0) + Number(this.data.total_sales_excl_tax || 0);
    },
    ...
    netProfit: function netProfit() {
      var deductions = Number(this.data.total_expense || 0) + Number(this.data.total_transfer_shipping_charge || 0);
  ...
  methods: {
    ...
    updatePickerPlacement: function updatePickerPlacement() {
      var isXs = window.matchMedia('(max-width: 576px)').matches;
      this.picker.opens = isXs ? 'center' : 'right';
      this.picker.drops = 'auto';
    },
    fmtDate: function fmtDate(d) {
      return moment__WEBPACK_IMPORTED_MODULE_2___default()(d).format('YYYY-MM-DD');
    },
    fmtShort: function fmtShort(d) {
      return moment__WEBPACK_IMPORTED_MODULE_2___default()(d).format('MMM D');
    },
    ...
    applyQuick: function applyQuick(kind) {
    ...
    money: function money(v) {
      try {
        ...
        var formatted = (0,_utils_priceFormat__WEBPACK_IMPORTED_MODULE_5__.formatPriceDisplay)(n, 2, effectiveKey);
        return "".concat(this.currency, " ").concat(formatted);
      } catch (e) {
        try {
          ...
          return "".concat(this.currency, " ").concat(this.num(v).toLocaleString());
        }
      }
    },
    fetchReport: function fetchReport() {
      ...
      axios.get("report/analytics_summary?".concat(params.toString())).then(function (_ref) {
        var data = _ref.data;
        _this2.data = {
        ...
        _this2.isLoading = false;
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        var msg = error && error.response && error.response.data && error.response.data.message || (_this2.$t ? _this2.$t('Error') : null) || 'Failed to load analytics report';
        if (_this2.$swal && typeof _this2.$swal.fire === 'function') {
          _this2.$swal.fire({
            icon: 'error',
            title: msg,
            timer: 3000,
    ...
    printReport: function printReport() {
      var title = "".concat(this.$t("Reports"), " / ").concat(this.$t("Analytics_Report"));
      var dateRangeText = "".concat(this.fmtDate(this.dateRange.startDate), " \u2014 ").concat(this.fmtDate(this.dateRange.endDate));
      var warehouseText = this.warehouseLabel ? " (".concat(this.warehouseLabel, ")") : '';
      var root = this.$el;
      if (!root) {
        window.print();
        return;
      }
      var reportContent = root.querySelector(".analytics-report");
      if (!reportContent) {
        window.print();
        return;
      }
      ...
      var reportHtml = "<div class=\"analytics-report\">";
      ...
      var leftFields = [{
        ...
        value: this.money(this.data.opening_stock_purchase_price)
      }, {
        label: "Opening Stock (By sale price)",
        value: this.money(this.data.opening_stock_sale_price)
      }, {
        label: "Total Purchase (Excl. tax, Discount)",
        value: this.money(this.data.total_purchase_excl_tax)
      }, {
        label: "Total Stock Adjustment",
        value: this.money(this.data.total_stock_adjustment)
      }, {
        label: "Total Expense",
        value: this.money(this.data.total_expense)
      }, {
        label: "Total purchase shipping charge",
        value: this.money(this.data.total_purchase_shipping_charge)
      }, {
        label: "Total transfer shipping charge",
        value: this.money(this.data.total_transfer_shipping_charge)
      }, {
        label: "Total Sell discount",
        value: this.money(this.data.total_sell_discount)
      }, {
        label: "Total customer reward",
        value: this.money(this.data.total_customer_reward)
      }, {
        label: "Total Sell Return",
        value: this.money(this.data.total_sell_return)
      }];
      leftFields.forEach(function (field) {
        reportHtml += "<tr style=\"border-bottom: 1px solid #e0e0e0;\">\n          <td style=\"padding: 8px; text-align: left;\">".concat(field.label, "</td>\n          <td style=\"padding: 8px; text-align: right;\">").concat(field.value, "</td>\n        </tr>");
      });
      ...
      var rightFields = [{
        label: "Closing stock (By purchase price)",
        value: this.money(this.data.closing_stock_purchase_price)
      }, {
        label: "Closing stock (By sale price)",
        value: this.money(this.data.closing_stock_sale_price)
      }, {
        label: "Total Sales (Excl. tax, Discount)",
        value: this.money(this.data.total_sales_excl_tax)
      }, {
        label: "Total sell shipping charge",
        value: this.money(this.data.total_sell_shipping_charge)
      }, {
        label: "Total Purchase Return",
        value: this.money(this.data.total_purchase_return)
      }, {
        label: "Total Purchase discount",
        value: this.money(this.data.total_purchase_discount)
      }];
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=template&id=7e4b8bfa&scoped=true"
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=template&id=7e4b8bfa&scoped=true ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", {
    staticClass: "main-content p-2 p-md-4"
  }, [_c("breadcumb", {
    attrs: {
      page: _vm.$t("Analytics_Report"),
      folder: _vm.$t("Reports")
    }
  }), _vm._v(" "), _c("b-card", {
    staticClass: "toolbar-card shadow-soft mb-3 border-0"
  }, [_c("div", {
    staticClass: "d-flex flex-wrap align-items-center"
  }, [_c("div", {
    staticClass: "mr-3 mb-2"
  }, [_c("label", {
    staticClass: "mb-1 d-block text-muted"
    ...
    attrs: {
      ...
      autoApply: true,
      showDropdowns: true,
      opens: _vm.picker.opens,
      drops: _vm.picker.drops,
      parentEl: "body"
    },
    on: {
      update: _vm.onDateChange
    },
    scopedSlots: _vm._u([{
      key: "input",
      fn: function fn(pickerSlot) {
        return [_c("b-button", {
        ...
        }, [_vm._v("\n                " + _vm._s(_vm.fmtDate(pickerSlot.startDate)) + " — " + _vm._s(_vm.fmtDate(pickerSlot.endDate)) + "\n              ")]), _vm._v(" "), _c("span", {
          staticClass: "d-inline d-sm-none"
        }, [_vm._v("\n                " + _vm._s(_vm.fmtShort(pickerSlot.startDate)) + "–" + _vm._s(_vm.fmtShort(pickerSlot.endDate)) + "\n              ")])], 1)];
      }
    }]),
    model: {
      value: _vm.dateRange,
    ...
    staticClass: "btn-group quick-ranges"
  }, [_c("b-button", {
    attrs: {
      size: "sm",
    ...
    on: {
      click: function click($event) {
        return _vm.applyQuick("today");
      }
    }
  }, [_vm._v(_vm._s(_vm.$t("Today") || "Today"))]), _vm._v(" "), _c("b-button", {
    attrs: {
      size: "sm",
      variant: "outline-primary"
    },
    on: {
      click: function click($event) {
        return _vm.applyQuick("yesterday");
      }
    }
  }, [_vm._v(_vm._s(_vm.$t("Yesterday") || "Yesterday"))]), _vm._v(" "), _c("b-button", {
    attrs: {
      size: "sm",
      variant: "outline-primary"
    },
    on: {
      click: function click($event) {
        return _vm.applyQuick("7d");
      }
    }
  }, [_vm._v("7D")]), _vm._v(" "), _c("b-button", {
    attrs: {
      size: "sm",
      variant: "outline-primary"
    },
    on: {
      click: function click($event) {
        return _vm.applyQuick("30d");
      }
    }
  }, [_vm._v("30D")]), _vm._v(" "), _c("b-button", {
    attrs: {
      size: "sm",
      variant: "outline-primary"
    },
    on: {
      click: function click($event) {
        return _vm.applyQuick("90d");
      }
    }
  }, [_vm._v("90D")]), _vm._v(" "), _c("b-button", {
    attrs: {
      size: "sm",
      variant: "outline-primary"
    },
    ...
    staticClass: "mb-1 d-block text-muted"
  }, [_vm._v(_vm._s(_vm.$t("warehouse")))]), _vm._v(" "), _c("v-select", {
    staticClass: "w-280",
    attrs: {
    ...
    return _c("b-col", {
      ...
      staticClass: "rounded-xl shadow-soft",
      attrs: {
        height: "400px"
      }
    })], 1);
  ...
  })], 1), _vm._v(" "), _c("div", [_c("strong", [_vm._v(_vm._s(_vm.fmtDate(_vm.dateRange.startDate)))]), _vm._v(" — "), _c("strong", [_vm._v(_vm._s(_vm.fmtDate(_vm.dateRange.endDate)))]), _vm._v(" "), _vm.warehouseLabel ? _c("span", {
    staticClass: "ml-2 badge badge-light"
  }, [_vm._v(_vm._s(_vm.warehouseLabel))]) : _vm._e()])])])], 1)], 1), _vm._v(" "), _c("b-row", [_c("b-col", {
    staticClass: "mb-3",
    attrs: {
      md: "6"
    }
  }, [_c("b-card", {
    staticClass: "analytics-card shadow-soft border-0"
  }, [_c("h6", {
    staticClass: "card-title mb-3"
  }, [_vm._v("Opening/Purchase")]), _vm._v(" "), _c("div", {
    staticClass: "analytics-rows"
  }, [_c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Opening Stock (By purchase price)")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.opening_stock_purchase_price)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Opening Stock (By sale price)")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.opening_stock_sale_price)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total Purchase (Excl. tax, Discount)")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_purchase_excl_tax)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total Stock Adjustment")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_stock_adjustment)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total Expense")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_expense)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total purchase shipping charge")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_purchase_shipping_charge)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total transfer shipping charge")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_transfer_shipping_charge)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total Sell discount")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_sell_discount)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total customer reward")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_customer_reward)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total Sell Return")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_sell_return)))])])])])], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
      md: "6"
    }
    ...
    staticClass: "card-title mb-3"
  }, [_vm._v("Closing/Sales")]), _vm._v(" "), _c("div", {
    staticClass: "analytics-rows"
  }, [_c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Closing stock (By purchase price)")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.closing_stock_purchase_price)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Closing stock (By sale price)")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.closing_stock_sale_price)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total Sales (Excl. tax, Discount)")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_sales_excl_tax)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total sell shipping charge")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_sell_shipping_charge)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total Purchase Return")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_purchase_return)))])]), _vm._v(" "), _c("div", {
    staticClass: "analytics-row"
  }, [_c("span", {
    staticClass: "label"
  }, [_vm._v("Total Purchase discount")]), _vm._v(" "), _c("span", {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.money(_vm.data.total_purchase_discount)))])])])])], 1)], 1), _vm._v(" "), _c("b-row", {
    staticClass: "mt-3"
  }, [_c("b-col", {
    attrs: {
      md: "12"
    ...
    staticClass: "profit-card shadow-soft border-0"
  }, [_c("div", {
    staticClass: "profit-section"
  }, [_c("div", {
    staticClass: "profit-row"
  }, [_c("div", {
    staticClass: "profit-label"
  }, [_vm._v("Gross Profit:")]), _vm._v(" "), _c("div", {
    staticClass: "profit-value"
  }, [_vm._v(_vm._s(_vm.money(_vm.grossProfit)))])]), _vm._v(" "), _c("div", {
    staticClass: "profit-formula"
  }, [_vm._v("\n              Formula: (Total sell price - Total purchase price)\n            ")])]), _vm._v(" "), _c("div", {
    staticClass: "profit-section mt-3"
  }, [_c("div", {
    staticClass: "profit-row"
  }, [_c("div", {
    staticClass: "profit-label"
  }, [_vm._v("Net Profit:")]), _vm._v(" "), _c("div", {
    staticClass: "profit-value"
  }, [_vm._v(_vm._s(_vm.money(_vm.netProfit)))])]), _vm._v(" "), _c("div", {
    staticClass: "profit-formula"
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.rounded-xl[data-v-7e4b8bfa] {\r\n  border-radius: 1rem;\n}\n.shadow-soft[data-v-7e4b8bfa] {\r\n  box-shadow: 0 12px 24px rgba(0, 0, 0, 0.06), 0 2px 6px rgba(0, 0, 0, 0.05);\n}\n.toolbar-card[data-v-7e4b8bfa] {\r\n  background: #fff;\n}\n.btn-pill[data-v-7e4b8bfa] {\r\n  border-radius: 999px;\n}\n.analytics-card[data-v-7e4b8bfa] {\r\n  min-height: 450px;\n}\n.card-title[data-v-7e4b8bfa] {\r\n  font-weight: 600;\r\n  font-size: 1rem;\r\n  color: #333;\r\n  border-bottom: 1px solid #e0e0e0;\r\n  padding-bottom: 12px;\n}\n.analytics-rows[data-v-7e4b8bfa] {\r\n  display: flex;\r\n  flex-direction: column;\n}\n.analytics-row[data-v-7e4b8bfa] {\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  padding: 10px 0;\r\n  border-bottom: 1px solid #e0e0e0;\n}\n.analytics-row[data-v-7e4b8bfa]:last-child {\r\n  border-bottom: none;\n}\n.analytics-row .label[data-v-7e4b8bfa] {\r\n  flex: 1;\r\n  text-align: left;\r\n  color: #555;\r\n  font-size: 0.9rem;\n}\n.analytics-row .value[data-v-7e4b8bfa] {\r\n  flex: 0 0 auto;\r\n  text-align: right;\r\n  font-weight: 500;\r\n  color: #333;\r\n  font-size: 0.9rem;\r\n  margin-left: 16px;\n}\n.profit-card[data-v-7e4b8bfa] {\r\n  background: #fafbfc;\n}\n.profit-section[data-v-7e4b8bfa] {\r\n  padding: 8px 0;\n}\n.profit-row[data-v-7e4b8bfa] {\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  margin-bottom: 4px;\n}\n.profit-label[data-v-7e4b8bfa] {\r\n  font-weight: 600;\r\n  font-size: 1rem;\r\n  color: #333;\n}\n.profit-value[data-v-7e4b8bfa] {\r\n  font-weight: 700;\r\n  font-size: 1.1rem;\r\n  color: #333;\n}\n.profit-formula[data-v-7e4b8bfa] {\r\n  font-size: 0.75rem;\r\n  color: #666;\r\n  font-style: italic;\r\n  margin-top: 4px;\n}\r\n\r\n/* Mobile responsive */\n@media (max-width: 767.98px) {\n.analytics-card[data-v-7e4b8bfa] {\r\n    min-height: auto;\n}\n.analytics-row[data-v-7e4b8bfa] {\r\n    flex-direction: column;\r\n    align-items: flex-start;\n}\n.analytics-row .value[data-v-7e4b8bfa] {\r\n    margin-left: 0;\r\n    margin-top: 4px;\r\n    text-align: left;\n}\n}\n.w-280[data-v-7e4b8bfa] {\r\n  width: 280px;\n}\r\n\r\n/* Date range picker responsiveness */\n@media (max-width: 575.98px) {\n.daterangepicker[data-v-7e4b8bfa] {\r\n    left: 8px !important;\r\n    right: 8px !important;\r\n    width: auto !important;\r\n    max-width: calc(100vw - 16px) !important;\n}\n.daterangepicker .drp-calendar[data-v-7e4b8bfa],\r\n  .daterangepicker .ranges[data-v-7e4b8bfa] {\r\n    float: none !important;\r\n    width: 100% !important;\n}\n.quick-ranges[data-v-7e4b8bfa] {\r\n    display: flex !important;\r\n    flex-wrap: wrap;\r\n    width: 100%;\n}\n.quick-ranges .btn[data-v-7e4b8bfa] {\r\n    flex: 1 1 calc(50% - 6px);\r\n    margin-bottom: 6px;\n}\n}\r\n\r\n/* Keep the picker above navbars/modals/offcanvas */\n.daterangepicker[data-v-7e4b8bfa] {\r\n  z-index: 2055 !important;\n}\r\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Analytics_Report_vue_vue_type_style_index_0_id_7e4b8bfa_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Analytics_Report.vue?vue&type=style&index=0&id=7e4b8bfa&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=style&index=0&id=7e4b8bfa&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Analytics_Report_vue_vue_type_style_index_0_id_7e4b8bfa_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/src/views/app/pages/reports/Analytics_Report.vue"
/*!********************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/Analytics_Report.vue ***!
  \********************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Analytics_Report_vue_vue_type_template_id_7e4b8bfa_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Analytics_Report.vue?vue&type=template&id=7e4b8bfa&scoped=true */ "./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=template&id=7e4b8bfa&scoped=true");
/* harmony import */ var _Analytics_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Analytics_Report.vue?vue&type=script&lang=js */ "./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=script&lang=js");
/* harmony import */ var _Analytics_Report_vue_vue_type_style_index_0_id_7e4b8bfa_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Analytics_Report.vue?vue&type=style&index=0&id=7e4b8bfa&scoped=true&lang=css */ "./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=style&index=0&id=7e4b8bfa&scoped=true&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _Analytics_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _Analytics_Report_vue_vue_type_template_id_7e4b8bfa_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _Analytics_Report_vue_vue_type_template_id_7e4b8bfa_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "7e4b8bfa",
  null
...
{ var api; }
component.options.__file = "resources/src/views/app/pages/reports/Analytics_Report.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ },

/***/ "./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=script&lang=js"
/*!********************************************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=script&lang=js ***!
  \********************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Analytics_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Analytics_Report.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Analytics_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ },

/***/ "./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=template&id=7e4b8bfa&scoped=true"
/*!**************************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=template&id=7e4b8bfa&scoped=true ***!
  \**************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Analytics_Report_vue_vue_type_template_id_7e4b8bfa_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Analytics_Report_vue_vue_type_template_id_7e4b8bfa_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Analytics_Report_vue_vue_type_template_id_7e4b8bfa_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Analytics_Report.vue?vue&type=template&id=7e4b8bfa&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=template&id=7e4b8bfa&scoped=true");


/***/ },

/***/ "./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=style&index=0&id=7e4b8bfa&scoped=true&lang=css"
/*!****************************************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=style&index=0&id=7e4b8bfa&scoped=true&lang=css ***!
  \****************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Analytics_Report_vue_vue_type_style_index_0_id_7e4b8bfa_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Analytics_Report.vue?vue&type=style&index=0&id=7e4b8bfa&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Analytics_Report.vue?vue&type=style&index=0&id=7e4b8bfa&scoped=true&lang=css");
