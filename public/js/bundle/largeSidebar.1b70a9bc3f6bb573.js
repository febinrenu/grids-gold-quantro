...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_2__.mapGetters)(["getSideBarToggleProperties", "currentUserPermissions"])), {}, {
    ...
    jewelryHiddenMenus: function jewelryHiddenMenus() {
      return new Set(['realestate', 'hrm', 'recruit', 'meeting', 'marketing', 'subscription_product', 'service', 'assets', 'projects', 'contracts', 'tasks', 'bookings', 'commissions', 'woocommerce_settings', 'knowledge-base', 'ai_reports']);
    },
