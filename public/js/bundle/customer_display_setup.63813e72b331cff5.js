...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    screenUrl: function screenUrl(screenNumber) {
      if (!this.url) return '';
      var sep = this.url.indexOf('?') >= 0 ? '&' : '?';
      return this.url + sep + 'screen=' + screenNumber;
    },
    openScreenQrModal: function openScreenQrModal(n) {
      var _this5 = this;
      this.qrModalScreen = n;
      this.$nextTick(function () {
        _this5.drawQrIntoModal(_this5.screenUrl(n));
      });
    },
    closeScreenQrModal: function closeScreenQrModal() {
      this.qrModalScreen = null;
      var el = this.$refs.qrModalContainer;
      if (el) el.innerHTML = '';
    },
    drawQrIntoModal: function drawQrIntoModal(text) {
      var _this6 = this;
      var container = this.$refs.qrModalContainer;
      ...
      var draw = function draw() {
        ...
        _this6.drawQrCanvasFallbackInto(container, text);
      };
      if (!window.QRCode) {
        var script = document.createElement('script');
        script.src = 'https://cdnjs.cloudflare.com/ajax/libs/qrcodejs/1.0.0/qrcode.min.js';
        script.onload = draw;
        script.onerror = function () {
          return _this6.drawQrCanvasFallbackInto(container, text);
        };
        document.head.appendChild(script);
      } else {
        draw();
    ...
    drawQrCanvasFallbackInto: function drawQrCanvasFallbackInto(container, text) {
      if (!container) return;
      container.innerHTML = '';
      try {
        ...
        ctx.font = '14px Arial';
        ctx.textAlign = 'center';
        ctx.fillText(this.$t('QR_Code'), 100, 90);
        ctx.fillText(this.$t('Not_Available'), 100, 110);
        ctx.font = '11px Arial';
        ctx.fillStyle = '#666';
        var _short = text.length > 35 ? text.substring(0, 35) + '...' : text;
        ctx.fillText(_short, 100, 160);
      } catch (e) {
        console.error(e);
      }
    }
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "info-section multi-screen-section"
  }, [_c("div", {
    staticClass: "section-header"
  }, [_c("svg", {
    attrs: {
  ...
  })]), _vm._v(" "), _c("label", [_vm._v(_vm._s(_vm.$t("Multiple_Displays")))])]), _vm._v(" "), _c("p", {
    staticClass: "multi-screen-hint"
  }, [_vm._v(_vm._s(_vm.$t("Use_one_URL_per_screen_In_POS_select_matching_screen")))]), _vm._v(" "), _c("div", {
    staticClass: "screen-url-list"
  }, _vm._l(5, function (n) {
    return _c("div", {
      key: n,
      staticClass: "screen-url-row"
    }, [_c("span", {
      staticClass: "screen-label"
    }, [_vm._v(_vm._s(_vm.$t("Screen")) + " " + _vm._s(n))]), _vm._v(" "), _c("input", {
      staticClass: "url-input url-input-sm",
      attrs: {
        readonly: ""
      },
      domProps: {
        value: _vm.screenUrl(n)
      },
      on: {
        focus: function focus($event) {
          return _vm.select($event);
      ...
      staticClass: "btn btn-copy btn-copy-sm",
      attrs: {
        type: "button",
        title: _vm.$t("Copy_to_clipboard")
      },
      on: {
        click: function click($event) {
          _vm.copy(_vm.screenUrl(n));
        }
      }
    }, [_vm._v("\n                " + _vm._s(_vm.$t("Copy")) + "\n              ")]), _vm._v(" "), _c("button", {
      staticClass: "btn btn-qr-icon",
      attrs: {
        type: "button",
        title: _vm.$t("Show_QR_Code")
      },
      on: {
        click: function click($event) {
          return _vm.openScreenQrModal(n);
        }
      }
    }, [_c("svg", {
      attrs: {
  ...
  }), 0)]) : _vm._e(), _vm._v(" "), _vm.qrModalScreen !== null ? _c("div", {
    staticClass: "qr-modal-overlay",
    on: {
      click: function click($event) {
        if ($event.target !== $event.currentTarget) return null;
        return _vm.closeScreenQrModal.apply(null, arguments);
      }
    }
  }, [_c("div", {
    staticClass: "qr-modal-card"
  }, [_c("div", {
    staticClass: "qr-modal-header"
  }, [_c("h4", [_vm._v(_vm._s(_vm.$t("Screen")) + " " + _vm._s(_vm.qrModalScreen) + " – " + _vm._s(_vm.$t("QR_Code")))]), _vm._v(" "), _c("button", {
    staticClass: "btn btn-close-modal",
    attrs: {
      type: "button",
      title: _vm.$t("Close")
    },
    on: {
      click: _vm.closeScreenQrModal
    }
  }, [_c("svg", {
    attrs: {
      width: "24",
    ...
    staticClass: "qr-modal-body"
  }, [_c("div", {
    ref: "qrModalContainer",
    staticClass: "qr-modal-container"
  }), _vm._v(" "), _c("p", {
    staticClass: "qr-modal-hint"
  }, [_vm._v(_vm._s(_vm.$t("Scan_QR_to_open_display")))])])])]) : _vm._e(), _vm._v(" "), _vm.url ? _c("div", {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomerDisplaySetup_vue_vue_type_style_index_0_id_afaeea06_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CustomerDisplaySetup.vue?vue&type=style&index=0&id=afaeea06&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/customer/CustomerDisplaySetup.vue?vue&type=style&index=0&id=afaeea06&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomerDisplaySetup_vue_vue_type_style_index_0_id_afaeea06_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomerDisplaySetup_vue_vue_type_style_index_0_id_afaeea06_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CustomerDisplaySetup.vue?vue&type=style&index=0&id=afaeea06&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/customer/CustomerDisplaySetup.vue?vue&type=style&index=0&id=afaeea06&scoped=true&lang=css");
