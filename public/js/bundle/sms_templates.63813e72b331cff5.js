...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)(["refreshUserPermissions"])), {}, {
    ...
    get_sms_template: function get_sms_template() {
      ...
      axios.get("get_sms_template?locale=" + encodeURIComponent(locale)).then(function (response) {
        ...
        _this2.sms_body_subscription_reminder = response.data.sms_body_subscription_reminder;
        _this2.sms_body_asset_validation_due = response.data.sms_body_asset_validation_due || '';
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("Edit_templates_per_language") || "Templates are saved per language. When sending SMS, the system default language is used."))])], 1)])]), _vm._v(" "), _c("div", {
    ...
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.update_sms_body("subscription_reminder");
      }
    }
  }, [_c("div", {
    staticClass: "row"
    ...
    attrs: {
      "for": "sms_body_subscription_reminder"
    }
  }, [_vm._v(_vm._s(_vm.$t("sms_body")))]), _vm._v(" "), _c("textarea", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.sms_body_subscription_reminder,
      expression: "sms_body_subscription_reminder"
    }],
    staticClass: "form-control",
    staticStyle: {
      height: "200px!important"
    ...
    attrs: {
      type: "text",
      name: "sms_body_subscription_reminder",
      id: "sms_body_subscription_reminder",
      placeholder: _vm.$t("sms_body")
    },
    domProps: {
      value: _vm.sms_body_subscription_reminder
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.sms_body_subscription_reminder = $event.target.value;
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "row mt-3"
    ...
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.update_sms_body("asset_validation_due");
      }
    }
  }, [_c("div", {
    staticClass: "row"
    ...
    attrs: {
      "for": "sms_body_asset_validation_due"
    }
  }, [_vm._v(_vm._s(_vm.$t("sms_body")))]), _vm._v(" "), _c("textarea", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.sms_body_asset_validation_due,
      expression: "sms_body_asset_validation_due"
    }],
    staticClass: "form-control",
    staticStyle: {
      height: "200px!important"
    ...
    attrs: {
      type: "text",
      name: "sms_body_asset_validation_due",
      id: "sms_body_asset_validation_due",
      placeholder: _vm.$t("sms_body")
    },
    domProps: {
      value: _vm.sms_body_asset_validation_due
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.sms_body_asset_validation_due = $event.target.value;
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "row mt-3"
