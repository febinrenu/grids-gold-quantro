...
/* harmony import */ var _components_RichTextEditor_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/components/RichTextEditor.vue */ "./resources/src/components/RichTextEditor.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    VueEditor: _components_RichTextEditor_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  metaInfo: {
  ...
  computed: {
    languageOptions: function languageOptions() {
      var list = this.languages && this.languages.length ? this.languages : [{
        name: 'English',
        locale: 'en'
      }];
      return list.filter(function (l) {
        return l.is_active == true || l.is_active === 1 || l.is_active === '1';
      }).map(function (l) {
        return {
          name: l.name,
          locale: l.locale
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)(["refreshUserPermissions"])), {}, {
    ...
    get_emails_template: function get_emails_template() {
      var _this2 = this;
      var locale = this.selectedLocale || 'en';
      axios.get("get_emails_template?locale=" + encodeURIComponent(locale)).then(function (response) {
        ...
        _this2.booking = response.data.booking || {
          subject: '',
          body: ''
        };
        _this2.asset_validation_due = response.data.asset_validation_due || {
          subject: '',
          body: ''
        };
    ...
    fetchLanguages: function fetchLanguages() {
      var _this3 = this;
      axios.get("/languages_setting").then(function (response) {
        _this3.languages = response.data || [];
        if (!_this3.selectedLocale && _this3.languages.length) {
          var defaultLang = _this3.languages.find(function (l) {
            return l.is_default;
          }) || _this3.languages[0];
          if (defaultLang) _this3.selectedLocale = defaultLang.locale;
        }
      })["catch"](function () {
        _this3.languages = [];
      });
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("Template_Language") || "Template language"))]), _vm._v(" "), _c("b-form-select", {
    ...
    staticClass: "text-muted small mt-1 mb-0"
  }, [_vm._v(_vm._s(_vm.$t("Edit_templates_per_language") || "Templates are saved per language. When sending emails, the system default language is used."))])], 1)])]), _vm._v(" "), _c("div", {
    ...
    attrs: {
      title: _vm.$t("Custom_Template_Booking") || "Custom Template for Booking"
    }
  }, [_c("form", {
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.update_custom_email("booking");
      }
    }
  }, [_c("div", {
    staticClass: "row"
    ...
    attrs: {
      "for": "email_subject_booking"
    }
  }, [_vm._v(_vm._s(_vm.$t("Email_Subject")) + " ")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.booking.subject,
      expression: "booking.subject"
    }],
    staticClass: "form-control",
    attrs: {
      type: "text",
      name: "email_subject_booking",
      id: "email_subject_booking",
      placeholder: _vm.$t("Email_Subject")
    },
    domProps: {
      value: _vm.booking.subject
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.booking, "subject", $event.target.value);
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "form-group col-md-12"
    ...
    model: {
      value: _vm.booking.body,
      callback: function callback($$v) {
        _vm.$set(_vm.booking, "body", $$v);
      },
      expression: "booking.body"
    }
  })], 1)]), _vm._v(" "), _c("div", {
    staticClass: "row mt-3"
  }, [_c("div", {
    ...
    staticClass: "card-header"
  }, [_c("h4", [_vm._v(_vm._s(_vm.$t("Asset_Validation_Due") || "Asset validation due"))])]), _vm._v(" "), _c("div", {
    staticClass: "card-body"
  }, [_c("b-tabs", {
    attrs: {
      "active-nav-item-class": "nav nav-tabs",
    ...
    attrs: {
      title: _vm.$t("Asset_Validation_Due") || "Asset validation due"
    }
  }, [_c("form", {
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.update_custom_email("asset_validation_due");
      }
    }
  }, [_c("div", {
    staticClass: "row"
    ...
    attrs: {
      "for": "email_subject_asset_validation_due"
    }
  }, [_vm._v(_vm._s(_vm.$t("Email_Subject")) + " ")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.asset_validation_due.subject,
      expression: "asset_validation_due.subject"
    }],
    staticClass: "form-control",
    attrs: {
      type: "text",
      name: "email_subject_asset_validation_due",
      id: "email_subject_asset_validation_due",
      placeholder: _vm.$t("Email_Subject")
    },
    domProps: {
      value: _vm.asset_validation_due.subject
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.asset_validation_due, "subject", $event.target.value);
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "form-group col-md-12"
    ...
    attrs: {
      "for": "email_body_asset_validation_due"
    }
  }, [_vm._v(_vm._s(_vm.$t("Email_body")) + " ")]), _vm._v(" "), _c("vue-editor", {
    attrs: {
      id: "editor_asset_validation_due",
      "editor-toolbar": _vm.customToolbar
    },
    model: {
      value: _vm.asset_validation_due.body,
      callback: function callback($$v) {
        _vm.$set(_vm.asset_validation_due, "body", $$v);
      },
      expression: "asset_validation_due.body"
    }
  })], 1)]), _vm._v(" "), _c("div", {
    staticClass: "row mt-3"
  }, [_c("div", {
