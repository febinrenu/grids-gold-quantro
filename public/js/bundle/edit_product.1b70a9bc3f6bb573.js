...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_3__.mapGetters)(["currentUserPermissions", "currentUser"])), {}, {
    ...
    hasPendingGalleryUploads: function hasPendingGalleryUploads() {
      return (this.product_images || []).some(function (r) {
        return r && r._file;
      });
    },
  ...
  methods: {
    ...
    touchGalleryOrder: function touchGalleryOrder() {
      (this.product_images || []).forEach(function (r, i) {
        r.sort_order = i;
      });
    },
    setGalleryMain: function setGalleryMain(row) {
      (this.product_images || []).forEach(function (r) {
        r.is_main = r === row;
      });
    },
    removeGalleryRow: function removeGalleryRow(index) {
      var row = this.product_images[index];
      if (row && row.id) {
      ...
      if (!this.product_images.some(function (r) {
        return r && r.is_main;
      }) && this.product_images.length) {
        this.$set(this.product_images[0], "is_main", true);
      }
    },
    onGalleryExtraSelected: function onGalleryExtraSelected(e) {
      var _this7 = this;
      var files = Array.from(e.target.files || []).filter(function (f) {
        return f.type && f.type.indexOf("image/") === 0;
      });
      files.forEach(function (f) {
        _this7.galleryUidSeed += 1;
        _this7.product_images.push({
          id: null,
          _uid: "n-" + _this7.galleryUidSeed,
          url: URL.createObjectURL(f),
          image_path: f.name,
          is_main: false,
          sort_order: _this7.product_images.length,
          _file: f
        });
      });
      this.touchGalleryOrder();
    ...
    get_products_materiels: function get_products_materiels(value) {
      ...
      axios.get("get_products_materiels").then(function (_ref) {
        var data = _ref.data;
        return _this8.products_ing = data;
      });
    },
    ...
    search: function search() {
      ...
      this.timer = setTimeout(function () {
        var product_filter = _this9.products_ing.filter(function (ingredient) {
          return ingredient.code === _this9.search_input;
        });
        if (product_filter.length === 1) {
          _this9.SearchProduct(product_filter[0]);
        } else {
          _this9.product_filter = _this9.products_ing.filter(function (ingredient) {
            return ingredient.name.toLowerCase().includes(_this9.search_input.toLowerCase()) || ingredient.code.toLowerCase().includes(_this9.search_input.toLowerCase());
          });
        }
      }, 800);
    },
    ...
    Submit_Product: function Submit_Product() {
      ...
      this.$refs.Edit_Product.validate().then(function (success) {
        if (!success) {
          ...
          if (!_this0.validateJewelryForm()) {
            return;
          }
          if (_this0.product.type == 'is_variant' && _this0.variants.length <= 0) {
            _this0.makeToast("danger", "The variants array is required.", _this0.$t("Failed"));
          } else if (!_this0.validatePacks()) {
            // validatePacks already shows a toast
          } else {
            _this0.Update_Product();
          }
        }
      });
    },
    ...
    submitQuickWarehouseLocation: function submitQuickWarehouseLocation() {
      ...
      this.$refs.QuickWarehouseLocation.validate().then(/*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(success) {
          var payload, _yield$axios$post, data, newLoc, wid, label, _t;
          return _regenerator().w(function (_context) {
            while (1) switch (_context.p = _context.n) {
              case 0:
                if (success) {
                ...
                return _context.a(2);
              case 1:
                _this1.quickWarehouseLocationSubmitting = true;
                _context.p = 2;
                payload = {
                  warehouse_id: _this1.quickWarehouseLocation.warehouse_id,
                  code: _this1.quickWarehouseLocation.code,
                  name: _this1.quickWarehouseLocation.name || "",
                  is_active: true
                };
                _context.n = 3;
              ...
              case 3:
                ...
                if (newLoc && newLoc.id) {
                  ...
                  label = newLoc.name ? "".concat(newLoc.code, " - ").concat(newLoc.name) : newLoc.code;
                  if (!_this1.locationsByWarehouse[wid]) {
                    _this1.$set(_this1.locationsByWarehouse, wid, []);
                  }
                  _this1.locationsByWarehouse[wid].push({
                    id: newLoc.id,
                    label: label,
                    is_active: true
                  });
                  ...
                  _this1.$set(_this1.warehouse_location_map, wid, newLoc.id);
                }
                _this1.$bvModal.hide("Quick_Add_Warehouse_Location");
              ...
              case 5:
                _context.p = 5;
                _this1.quickWarehouseLocationSubmitting = false;
                return _context.f(5);
              case 6:
                return _context.a(2);
            }
    ...
    GetElements: function GetElements() {
      ...
      axios.get("products/".concat(id, "/edit")).then(function (response) {
        _this10.product = _objectSpread(_objectSpread({}, _this10.product), response.data.product || {});
        _this10.hydrateJewelryFields(response.data.product || {});
        _this10.variants = response.data.product.ProductVariant;
        _this10.metalTypes = response.data.metal_types || [];
        _this10.karats = response.data.karats || [];
        _this10.stoneTypes = response.data.stone_types || [];
        _this10.jewelryModeEnabled = response.data.jewelry_mode === true;
        _this10.jewelryDefaults = _objectSpread(_objectSpread({}, _this10.jewelryDefaults), response.data.jewelry_defaults || {});
        // System Settings toggle: show/hide the Barcode (GTIN/UPC/EAN/ISBN) column
        _this10.show_product_gtin = response.data.show_product_gtin !== false;
        _this10.show_serial_tracking = response.data.show_serial_tracking === true;
        // System Settings toggle: master switch for Multi-Pack Selling
        _this10.enable_multi_pack_selling = response.data.enable_multi_pack_selling === true;
        _this10.packs = (response.data.product.packs || []).map(function (p) {
          return {
            id: p.id,
            name: p.name,
        ...
        if (_this10.enable_multi_pack_selling && _this10.product.type == 'is_single') {
          _this10.ensureDefaultPack();
        }
        _this10.warehouses = response.data.warehouses || [];
        _this10.warehouse_locations = response.data.warehouse_locations || [];
        var byWh = {};
        (_this10.warehouse_locations || []).forEach(function (loc) {
        ...
        _this10.locationsByWarehouse = byWh;

        // init map (reactive)
        var existing = {};
        (response.data.product_warehouse_locations || []).forEach(function (r) {
          existing[r.warehouse_id] = r.warehouse_location_id || null;
        });
        _this10.warehouses.forEach(function (wh) {
          _this10.$set(_this10.warehouse_location_map, wh.id, existing[wh.id] || null);
        });
        _this10.categories = response.data.categories;
        _this10.allSubcategories = response.data.all_subcategories || [];
        if (!Array.isArray(_this10.product.assigned_category_ids)) {
          _this10.$set(_this10.product, "assigned_category_ids", []);
        }
        if (!Array.isArray(_this10.product.assigned_subcategory_ids)) {
          _this10.$set(_this10.product, "assigned_subcategory_ids", []);
        }
        if ((!_this10.product.assigned_category_ids || !_this10.product.assigned_category_ids.length) && _this10.product.category_id) {
          _this10.$set(_this10.product, "assigned_category_ids", [_this10.product.category_id]);
        }
        if ((!_this10.product.assigned_subcategory_ids || !_this10.product.assigned_subcategory_ids.length) && _this10.product.sub_category_id) {
          _this10.$set(_this10.product, "assigned_subcategory_ids", [_this10.product.sub_category_id]);
        }
        _this10.$nextTick(function () {
          _this10.pruneInvalidSubcategories();
          _this10.syncLegacyCategoryFields();
        });
        _this10.brands = response.data.brands;
        _this10.units = response.data.units;
        _this10.units_sub = response.data.units_sub;
        _this10.galleryRemoveIds = [];
        _this10.galleryUidSeed = 0;
        var imgs = response.data.product.product_images || [];
        _this10.product_images = imgs.map(function (r) {
          return _objectSpread(_objectSpread({}, r), {}, {
            _uid: "e-" + r.id
          });
        });
        if (_this10.product.type == 'is_combo') {
          _this10.get_products_materiels();
          _this10.materiels = response.data.materiels;
        }
    ...
    Get_Units_SubBase: function Get_Units_SubBase(value) {
      var _this11 = this;
      axios.get("get_sub_units_by_base?id=" + value).then(function (_ref4) {
        var data = _ref4.data;
        return _this11.units_sub = data;
      });
    },
    ...
    Update_Product: function Update_Product() {
      ...
      Object.entries(prodRest).forEach(function (_ref5) {
      ...
      if (self.variants.length) {
        for (var i = 0; i < self.variants.length; i++) {
          Object.entries(self.variants[i]).forEach(function (_ref7) {
            var _ref8 = _slicedToArray(_ref7, 2),
              key = _ref8[0],
              value = _ref8[1];
            // Skip client-only fields; the picked file is sent separately below.
      ...
      if (self.warehouses && self.warehouses.length) {
        self.warehouses.forEach(function (wh) {
          wlPayload[wh.id] = {
            warehouse_location_id: self.warehouse_location_map[wh.id] || null
          };
        });
      }
      ...
      var orderPayload = [];
      (self.product_images || []).forEach(function (r, i) {
        if (r && r.id) {
          orderPayload.push({
            id: r.id,
            sort_order: i
      ...
      var mainRow = (self.product_images || []).find(function (r) {
        return r && r.is_main;
      });
      var main_id = null;
      var main_pending_index = null;
      if (mainRow) {
        if (mainRow.id) {
          main_id = mainRow.id;
        } else {
          var pending = (self.product_images || []).filter(function (r) {
            return r && r._file;
          });
          var pi = pending.findIndex(function (r) {
            return r === mainRow;
          });
          main_pending_index = pi >= 0 ? pi : null;
        }
      }
      var hasPersistedGallery = orderPayload.length > 0;
      var hasGalleryChanges = self.galleryRemoveIds.length > 0 || hasPersistedGallery || (self.product_images || []).some(function (r) {
        return r && r._file;
      });
      ...
      (self.product_images || []).forEach(function (r) {
        if (r && r._file) {
      ...
      axios.post("products/" + this.product.id, self.data).then(function (response) {
        ...
        if (error.errors.code && error.errors.code.length > 0) {
          ...
          _this12.makeToast("danger", error.errors.code[0], _this12.$t("Failed"));
        } else if (error.errors.variants && error.errors.variants.length > 0) {
          _this12.makeToast("danger", error.errors.variants[0], _this12.$t("Failed"));
        } else {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_product_vue_vue_type_style_index_0_id_379e8f98_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Edit_product.vue?vue&type=style&index=0&id=379e8f98&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/Edit_product.vue?vue&type=style&index=0&id=379e8f98&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_product_vue_vue_type_style_index_0_id_379e8f98_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_product_vue_vue_type_style_index_0_id_379e8f98_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Edit_product.vue?vue&type=style&index=0&id=379e8f98&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/Edit_product.vue?vue&type=style&index=0&id=379e8f98&lang=css");
