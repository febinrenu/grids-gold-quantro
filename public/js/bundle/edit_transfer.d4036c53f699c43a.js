  ...
  methods: {
    ...
    Get_Product_Details: function Get_Product_Details(product_id, variant_id) {
      ...
      axios.get(url).then(function (response) {
        ...
        _this6.product.warehouse_location = response.data.warehouse_location ? response.data.warehouse_location.name ? "".concat(response.data.warehouse_location.code, " - ").concat(response.data.warehouse_location.name) : response.data.warehouse_location.code : null;
        ...
        _this6.add_product();
        _this6.Calcul_Total();
        if (_this6.product.is_batch_tracked) {
          var last = _this6.details[_this6.details.length - 1];
          if (last) _this6.fetch_batches_for_detail(last);
        }
      });
    },
    ...
    fetch_batches_for_detail: function fetch_batches_for_detail(detail) {
      ...
      axios.get("batches_for_transfer/".concat(productId, "/").concat(wid, "/").concat(variantSeg), {
        ...
        _this7.$set(detail, "available_batches", list);
          ...
          try {
            var _loop = function _loop() {
              ...
              if (b && b.product_batch_id != null) {
                ...
                _this7.$set(b, "qty_available", ab ? Number(ab.qty_available) || 0 : existingQtyById[b.product_batch_id] || 0);
              }
            };
    ...
    GetElements: function GetElements() {
      ...
      axios.get("transfers/".concat(id, "/edit")).then(function (response) {
        _this8.transfer = response.data.transfer;
        _this8.details = response.data.details;
        _this8.warehouses = response.data.warehouses;
        _this8.to_warehouses = response.data.to_warehouses;
        _this8.Get_Products_By_Warehouse(_this8.transfer.from_warehouse);
        _this8.Calcul_Total();
        ...
        if (Array.isArray(_this8.details)) {
          var _iterator9 = _createForOfIteratorHelper(_this8.details),
            _step9;
          try {
            for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
              var d = _step9.value;
              if (d && d.is_batch_tracked) {
                _this8.fetch_batches_for_detail(d);
              }
            }
          } catch (err) {
            _iterator9.e(err);
...
var render = function render() {
  ...
  return _c("div", {
    ...
    }), _vm._v(_vm._s(_vm.$t("Batches")) + "\n                            ")], 1)]) : _vm._e(), _vm._v(" "), _c("lucide-icon", {
      directives: [{
        name: "show",
        rawName: "v-show",
    ...
    })], 1), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.Net_cost, _vm.priceDecimals)))]), _vm._v(" "), _c("td", [_c("span", {
    ...
    }, [_vm._v("+")])])], 1)], 1)]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.DiscountNet * detail.quantity, _vm.priceDecimals)))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.taxe * detail.quantity, _vm.priceDecimals)))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(detail.subtotal.toFixed(_vm.priceDecimals)))]), _vm._v(" "), _c("td", [_c("a", {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: detail.no_unit !== 0,
    ...
    })], 1)])]), _vm._v(" "), detail.is_batch_tracked && detail.del !== 1 && detail.no_unit !== 0 ? _c("tr", {
  ...
  }), _vm._v(" " + _vm._s(_vm.$t("submit")))], 1)], 1)], 1)], 1)], 1)], 1)], 1)], 1);
};
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_edit_transfer_vue_vue_type_style_index_0_id_09285268_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./edit_transfer.vue?vue&type=style&index=0&id=09285268&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/transfers/edit_transfer.vue?vue&type=style&index=0&id=09285268&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_edit_transfer_vue_vue_type_style_index_0_id_09285268_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_edit_transfer_vue_vue_type_style_index_0_id_09285268_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./edit_transfer.vue?vue&type=style&index=0&id=09285268&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/transfers/edit_transfer.vue?vue&type=style&index=0&id=09285268&lang=css");
