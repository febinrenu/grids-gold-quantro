        ...
        if (result.value) {
          axios["delete"]("units/" + id).then(function (response) {
            if (response.data.success) {
              ...
              _this5.$swal(_this5.$t("Delete_Failed"), _this5.$t("Unit_already_linked_with_sub_unit"), "warning");
            }
  ...
  return _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        ...
        })], 1)]) : props.column.field == "BaseUnit" ? _c("div", [props.row.base_unit_name != "" ? _c("span", [_vm._v(_vm._s(props.row.base_unit_name))]) : _c("span", [_vm._v("N/D")])]) : _vm._e()];
      }
    }], null, false, 2555761797)
  }, [_c("div", {
