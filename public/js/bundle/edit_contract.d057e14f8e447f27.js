(self["webpackChunk"] = self["webpackChunk"] || []).push([["edit_contract"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=script&lang=js"
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=script&lang=js ***!
  \***********************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    "contract.party_type": function contractParty_type(val, old) {
      var _this = this;
      ...
      this.$nextTick(function () {
        if (_this.$refs.ref_edit_contract) _this.$refs.ref_edit_contract.reset();
      });
    }
  },
  mounted: function mounted() {
    var _this2 = this;
    axios.get("contracts/" + this.id + "/edit").then(function (r) {
      var c = r.data.contract || {};
      if (!c.party_type) c.party_type = c.employee_id ? "employee" : "customer";
      _this2.contract = c;
      _this2.clients = r.data.clients || [];
      _this2.employees = r.data.employees || [];
      _this2.projects = r.data.projects || [];
  ...
  methods: {
    ...
    Submit_Contract: function Submit_Contract() {
      var _this3 = this;
      this.$refs.ref_edit_contract.validate().then(function (success) {
        if (!success) return;
        _this3.SubmitProcessing = true;
        axios.put("contracts/" + _this3.id, _this3.contract).then(function () {
          _this3.makeToast("success", _this3.$t("Updated_in_successfully") || "Updated successfully", _this3.$t("Success") || "Success");
          _this3.$router.push("/app/contracts/view/" + _this3.id);
        })["catch"](function (error) {
          if (error.response && error.response.status === 422 && error.response.data && error.response.data.errors) {
            var errors = error.response.data.errors;
            Object.keys(errors).forEach(function (key) {
              (errors[key] || []).forEach(function (msg) {
                return _this3.makeToast("danger", msg, _this3.$t("Validation_Error") || "Validation error");
              });
            });
          } else if (error.response && error.response.data && error.response.data.message) {
            _this3.makeToast("danger", error.response.data.message, _this3.$t("Failed") || "Failed");
          } else {
            _this3.makeToast("danger", _this3.$t("Something_went_wrong") || "Something went wrong", _this3.$t("Failed") || "Failed");
          }
        })["finally"](function () {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=template&id=af9f9868"
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=template&id=af9f9868 ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      page: _vm.$t("Edit_Contract") || "Edit Contract",
      folder: _vm.$t("Contracts") || "Contracts"
    }
  }), _vm._v(" "), _vm.isLoading ? _c("div", {
    staticClass: "loading_page spinner spinner-primary mr-3"
  }) : _vm._e(), _vm._v(" "), !_vm.isLoading && _vm.contract ? _c("validation-observer", {
    ref: "ref_edit_contract"
  }, [_c("b-form", {
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.Submit_Contract.apply(null, arguments);
      }
    }
  }, [_c("b-row", [_c("b-col", {
    attrs: {
    ...
    attrs: {
      label: (_vm.$t("Party_Type") || "Party Type") + " *"
    }
  }, [_c("b-form-radio-group", {
    attrs: {
      options: _vm.partyTypeOptions,
      buttons: "",
      "button-variant": "outline-primary"
    },
    model: {
      value: _vm.contract.party_type,
      callback: function callback($$v) {
        _vm.$set(_vm.contract, "party_type", $$v);
      },
      expression: "contract.party_type"
    }
  })], 1)], 1), _vm._v(" "), _vm.contract.party_type === "customer" ? _c("b-col", {
    attrs: {
      lg: "4",
      md: "6",
      sm: "12"
      ...
      fn: function fn(_ref2) {
        ...
        return [_c("b-form-group", {
          ...
          attrs: {
            ...
            options: _vm.employees.map(function (e) {
              return {
                label: ((e.firstname || "") + " " + (e.lastname || "")).trim(),
                value: e.id
              };
            }),
            placeholder: _vm.$t("Choose_Employee") || "Choose Employee"
          },
          model: {
    ...
    attrs: {
      ...
      options: _vm.projects.map(function (p) {
        return {
          label: p.title,
          value: p.id
        };
    ...
    model: {
      value: _vm.contract.project_id,
      callback: function callback($$v) {
        _vm.$set(_vm.contract, "project_id", $$v);
      },
      expression: "contract.project_id"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "4",
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref3) {
        ...
        return [_c("b-form-group", {
          ...
          model: {
            value: _vm.contract.subject,
            callback: function callback($$v) {
              _vm.$set(_vm.contract, "subject", $$v);
            },
            expression: "contract.subject"
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))])], 1)];
      }
    }], null, false, 241355932)
  })], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "3",
      md: "6",
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref4) {
        ...
        return [_c("b-form-group", {
          ...
          model: {
            value: _vm.contract.value,
            callback: function callback($$v) {
              _vm.$set(_vm.contract, "value", _vm._n($$v));
            },
            expression: "contract.value"
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))])], 1)];
      }
    }], null, false, 4101779855)
  })], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "3",
      md: "6",
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref6) {
        ...
        return [_c("b-form-group", {
          ...
          model: {
            value: _vm.contract.end_date,
            callback: function callback($$v) {
              _vm.$set(_vm.contract, "end_date", $$v);
            },
            expression: "contract.end_date"
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))])], 1)];
      }
    }], null, false, 2215785658)
  })], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "4",
      md: "6",
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref7) {
        ...
        return [_c("b-form-group", {
          ...
          model: {
            value: _vm.contract.status,
            callback: function callback($$v) {
              _vm.$set(_vm.contract, "status", $$v);
            },
            expression: "contract.status"
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))])], 1)];
      }
    }], null, false, 908037983)
  })], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "12"
    }
    ...
    attrs: {
      label: _vm.$t("Details") || "Description"
    }
  }, [_c("RichTextEditor", {
    attrs: {
      "editor-id": "contract-edit-details-editor"
    },
    model: {
    ...
    model: {
      value: _vm.contract.hide_from_customer,
      callback: function callback($$v) {
        _vm.$set(_vm.contract, "hide_from_customer", $$v);
      },
      expression: "contract.hide_from_customer"
    }
  }, [_vm._v("Hide from customer")])], 1) : _vm._e(), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "12"
    }
  }, [_c("b-button", {
    ...
    attrs: {
      to: "/app/contracts/view/" + _vm.id
    }
  }, [_vm._v("View")]), _vm._v(" "), _vm.SubmitProcessing ? _c("div", {
...
/***/ "./resources/src/views/app/pages/contracts/Edit_contract.vue"
/*!*******************************************************************!*\
  !*** ./resources/src/views/app/pages/contracts/Edit_contract.vue ***!
  \*******************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Edit_contract_vue_vue_type_template_id_af9f9868__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Edit_contract.vue?vue&type=template&id=af9f9868 */ "./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=template&id=af9f9868");
/* harmony import */ var _Edit_contract_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Edit_contract.vue?vue&type=script&lang=js */ "./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=script&lang=js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _Edit_contract_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _Edit_contract_vue_vue_type_template_id_af9f9868__WEBPACK_IMPORTED_MODULE_0__.render,
  _Edit_contract_vue_vue_type_template_id_af9f9868__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
if (false) // removed by dead control flow
{ var api; }
component.options.__file = "resources/src/views/app/pages/contracts/Edit_contract.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=script&lang=js"
/*!*******************************************************************************************!*\
  !*** ./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=script&lang=js ***!
  \*******************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_contract_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Edit_contract.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_contract_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=template&id=af9f9868"
/*!*************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=template&id=af9f9868 ***!
  \*************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_contract_vue_vue_type_template_id_af9f9868__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_contract_vue_vue_type_template_id_af9f9868__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_contract_vue_vue_type_template_id_af9f9868__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Edit_contract.vue?vue&type=template&id=af9f9868 */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/contracts/Edit_contract.vue?vue&type=template&id=af9f9868");
