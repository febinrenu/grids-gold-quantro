  ...
  methods: {
    ...
    Submit_sale_return: function Submit_sale_return() {
      ...
      if (this.sale_return.statut === 'received') {
        var bad = this.details.find(function (d) {
          return _this.serialCountMismatch(d);
        });
        if (bad) {
          this.makeToast("danger", "".concat(this.$t('Serials_Count_Mismatch'), " (").concat(bad.name, ")"), this.$t("Failed"));
          return;
        }
      }
    ...
    GetElements: function GetElements() {
      ...
      axios.get("returns/sale/create_sell_return/".concat(id)).then(function (response) {
        _this3.details = (response.data.details || []).map(function (d) {
          if (!Array.isArray(d.serial_numbers)) d.serial_numbers = [];
          // Multi-Pack Selling: carry the original sale's pack snapshot so the
          // return restocks the same base-unit quantity (defaults for legacy rows).
...
var render = function render() {
  ...
  return _c("div", {
    ...
    return [_c("tr", {
    ...
    }, [_vm._v(_vm._s(detail.name))]), _vm._v(" "), detail.pack_name && Number(detail.pack_multiplier) > 1 ? _c("div", {
      staticClass: "mt-1"
    }, [_c("span", {
      staticClass: "badge badge-info"
    }, [_vm._v(_vm._s(_vm.$t("Pack")) + ": " + _vm._s(detail.pack_name) + " (×" + _vm._s(detail.pack_multiplier) + ")")])]) : _vm._e(), _vm._v(" "), detail.is_batch_tracked ? _c("div", {
      staticClass: "mt-1"
    }, [_c("span", {
      staticClass: "badge",
      staticStyle: {
      ...
      attrs: {
        title: _vm.$t("Auto_Batch_Mirror_Hint") || "Original sale batches will be auto-credited proportionally when this return is received."
      }
    }, [_c("lucide-icon", {
      staticStyle: {
        "margin-right": "3px"
    ...
    }), _vm._v(_vm._s(_vm.$t("Batches") || "Batches") + " · Auto\n                            ")], 1)]) : _vm._e()]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.Net_price, _vm.priceDecimals)))]), _vm._v(" "), _c("td", [_c("span", {
    ...
    }, [_vm._v("+")])])], 1)], 1)]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.DiscountNet * detail.quantity, _vm.priceDecimals)))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.taxe * detail.quantity, _vm.priceDecimals)))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(detail.subtotal.toFixed(_vm.priceDecimals)))])]), _vm._v(" "), detail.is_imei ? _c("tr", {
      key: "s-" + detail.detail_id,
      staticStyle: {
      ...
      attrs: {
        ...
        "fetch-params": {
          sale_id: _vm.sale_return.sale_id,
    ...
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.$t("OrderTax")))]), _vm._v(" "), _c("td", [_c("span", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.sale_return.TaxNet.toFixed(_vm.priceDecimals)) + " (" + _vm._s(_vm.formatNumber(_vm.sale_return.tax_rate, 2)) + " %)")])])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.$t("Discount")))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.sale_return.discount.toFixed(_vm.priceDecimals)))])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.$t("Shipping")))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.sale_return.shipping.toFixed(_vm.priceDecimals)))])]), _vm._v(" "), _c("tr", [_c("td", [_c("span", {
