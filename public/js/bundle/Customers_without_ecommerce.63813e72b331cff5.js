...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      page: _vm.$t("Customers_without_Login"),
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        ...
        }), _vm._v(" Register Account")], 1)])]) : _vm._e()];
      }
    }])
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(validationContext) {
        return [_c("b-form-group", {
          ...
          staticClass: "btn btn-link p-0 position-absolute text-secondary d-inline-flex align-items-center justify-content-center",
          staticStyle: {
            top: "50%",
            right: "10px",
          ...
          attrs: {
            type: "button",
            "aria-label": _vm.showPassword ? _vm.$t("Hide") : _vm.$t("Show")
          },
          on: {
            click: function click($event) {
          ...
          attrs: {
            name: _vm.showPassword ? "eye-off" : "eye",
            size: 16
          }
