...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    Fire.$on("Event_Office_Shift", function () {
      setTimeout(function () {
        _this0.Get_Office_Shift(_this0.serverParams.page);
        _this0.$bvModal.hide("New_Office_Shift");
      }, 500);
    });
