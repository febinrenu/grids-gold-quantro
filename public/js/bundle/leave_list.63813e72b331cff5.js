...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              _yield$_this2$$refs$A = _context.v;
    ...
    Update_Leave: function Update_Leave() {
      ...
      axios.post("/leave/" + self.leave.id, self.data).then(function (response) {
        if (response.data.isvalid == false) {
          self.SubmitProcessing = false;
          self.errors = {};
          _this0.makeToast("danger", _this0.$t("remaining_leaves_are_insufficient"), _this0.$t("Failed"));
        } else {
          _this0.SubmitProcessing = false;
          Fire.$emit("Event_Leave");
          _this0.makeToast("success", _this0.$t("Updated_in_successfully"), _this0.$t("Success"));
        }
      })["catch"](function (error) {
        _this0.SubmitProcessing = false;
  ...
  created: function created() {
    ...
    Fire.$on("Event_Leave", function () {
      setTimeout(function () {
        _this11.Get_Leaves(_this11.serverParams.page);
        _this11.$bvModal.hide("New_Modal_Leave");
      }, 500);
    });
