"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["Edit_Customer"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=script&lang=js"
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=script&lang=js ***!
  \*******************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_CustomFieldsForm_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../components/CustomFieldsForm.vue */ "./resources/src/components/CustomFieldsForm.vue");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    CustomFieldsForm: _components_CustomFieldsForm_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  metaInfo: {
    title: "Edit Customer"
  },
  ...
  methods: {
    ...
    Submit_Customer: function Submit_Customer() {
      ...
      var fullName = [this.client.firstname, this.client.lastname].map(function (v) {
        return (v || "").trim();
    ...
    Update_Client: function Update_Client() {
      ...
      axios.put("clients/" + this.client.id, {
        ...
        if (Object.keys(_this2.customFieldValues).length > 0) {
          return axios.post("custom-field-values", {
            entity_type: "App\\Models\\Client",
            entity_id: _this2.client.id,
    ...
    Get_Customer: function Get_Customer() {
      ...
      axios.get("clients/" + id).then(function (response) {
        // Merge to keep default keys even if API omits them
        _this3.client = _objectSpread(_objectSpread({}, _this3.client), response.data.client || {});
        if (_this3.client.preferred_metals) {
          _this3.client.preferred_metals_array = _this3.client.preferred_metals.split(', ').filter(Boolean);
        } else {
          _this3.client.preferred_metals_array = [];
        }

        // Fetch other customers excluding current customer
        axios.get("get_clients_without_paginate").then(function (res) {
          _this3.clients_list = res.data.filter(function (c) {
            return c.id !== _this3.client.id;
          });
        });
        ...
        _this3.Get_Portal_Status();
      })["catch"](function (error) {
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        _this3.makeToast("danger", _this3.$t("Failed_to_load_customer"), _this3.$t("Failed"));
        setTimeout(function () {
          _this3.isLoading = false;
          _this3.$router.push({
            name: 'Customers'
    ...
    Get_Portal_Status: function Get_Portal_Status() {
      var _this4 = this;
      if (!this.client.id) return;
      this.portalLoading = true;
      axios.get("clients/" + this.client.id + "/portal-status").then(function (_ref) {
        var data = _ref.data;
        _this4.portalStatus = data;
      })["catch"](function () {
        _this4.portalStatus = {};
      })["finally"](function () {
        _this4.portalLoading = false;
      });
    },
    openEnablePortalModal: function openEnablePortalModal() {
      this.portalEmail = this.client.email || "";
      this.portalPassword = "";
      this.portalErrors = [];
      this.showEnablePortalModal = true;
    },
    enablePortal: function enablePortal(bvModalEvt) {
      var _this5 = this;
      ...
      axios.post("clients/" + this.client.id + "/portal-enable", {
        ...
        var data = _ref2.data;
        _this5.makeToast("success", data.message || "Portal updated", _this5.$t("Success"));
        _this5.showEnablePortalModal = false;
        _this5.Get_Portal_Status();
      })["catch"](function (e) {
        var _e$response;
        ...
        if (data !== null && data !== void 0 && data.errors) {
          ...
          _this5.portalErrors = messages.length ? messages : [data.message || "Validation failed."];
          _this5.makeToast("danger", _this5.portalErrors.join(" "), _this5.$t("Validation_Error") || "Validation Error");
        } else {
          var msg = (data === null || data === void 0 ? void 0 : data.message) || "Failed";
          _this5.portalErrors = [msg];
          _this5.makeToast("danger", msg, _this5.$t("Failed"));
        }
      })["finally"](function () {
        _this5.portalSending = false;
      });
    },
    disablePortal: function disablePortal() {
      var _this6 = this;
      if (!confirm(this.$t("Portal_Disable_Confirm") || "Disable portal access for this customer?")) return;
      this.portalSending = true;
      axios.post("clients/" + this.client.id + "/portal-disable").then(function (_ref3) {
        var data = _ref3.data;
        _this6.makeToast("success", data.message || "Portal disabled", _this6.$t("Success"));
        _this6.Get_Portal_Status();
      })["catch"](function () {
        return _this6.makeToast("danger", _this6.$t("Failed"), _this6.$t("Failed"));
      })["finally"](function () {
        _this6.portalSending = false;
      });
    },
    //------ Event Validation State
...
var render = function render() {
  ...
  }), _vm._v("\n          " + _vm._s(_vm.$t("CustomFields")) + "\n        ")], 1), _vm._v(" "), _c("hr")])], 1), _vm._v(" "), _vm._l(_vm.customFields, function (field) {
    return _c("b-row", {
      key: field.id,
      staticClass: "mb-3"
    }, [_c("b-col", {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=template&id=6419444a"
/*!******************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=template&id=6419444a ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    model: {
      ...
      callback: function callback($$v) {
        _vm.$set(_vm.client, "zip", $$v);
      },
      expression: "client.zip"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "6",
  ...
  })], 1) : _vm._e(), _vm._v(" "), _vm.client.id ? _c("b-col", {
    staticClass: "mt-4",
    attrs: {
      md: "12",
      sm: "12"
    ...
    attrs: {
      title: _vm.$t("Client_Portal") || "Client Portal"
    }
  }, [_c("p", {
    staticClass: "text-muted small"
  }, [_vm._v(_vm._s(_vm.$t("Client_Portal_Description") || "Let this customer access the portal to view invoices, payments, and statements."))]), _vm._v(" "), _vm.portalLoading ? _c("div", {
    staticClass: "text-muted"
  }, [_vm._v("Loading...")]) : _c("div", [_vm.portalStatus.portal_email ? _c("div", {
    staticClass: "mb-2"
  }, [_c("small", [_c("strong", [_vm._v(_vm._s(_vm.$t("Portal_Email") || "Portal email") + ":")]), _vm._v(" " + _vm._s(_vm.portalStatus.portal_email))]), _vm._v(" "), _vm.portalStatus.portal_enabled ? _c("span", {
    staticClass: "badge badge-success ml-2"
  }, [_vm._v(_vm._s(_vm.$t("Enabled") || "Enabled"))]) : _c("span", {
    staticClass: "badge badge-secondary ml-2"
  }, [_vm._v(_vm._s(_vm.$t("Disabled") || "Disabled"))])]) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "d-flex flex-wrap gap-2"
  }, [!_vm.portalStatus.portal_enabled ? _c("b-button", {
    attrs: {
      size: "sm",
      variant: "primary"
    },
    on: {
      click: _vm.openEnablePortalModal
    }
  }, [_vm._v("\n                    " + _vm._s(_vm.$t("Portal_Enable") || "Enable portal") + "\n                  ")]) : !_vm.portalStatus.has_password ? _c("b-button", {
    attrs: {
      size: "sm",
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.$t("Portal_Set_Password") || "Set password") + "\n                  ")]) : _vm._e(), _vm._v(" "), _vm.portalStatus.portal_enabled ? _c("b-button", {
    attrs: {
      size: "sm",
      variant: "outline-danger",
      disabled: _vm.portalSending
    },
    on: {
      click: _vm.disablePortal
    }
  }, [_vm._v("\n                    " + _vm._s(_vm.$t("Portal_Disable") || "Disable portal") + "\n                  ")]) : _vm._e()], 1)])])], 1) : _vm._e(), _vm._v(" "), _c("b-modal", {
    ref: "enablePortalModal",
    attrs: {
      title: _vm.$t("Portal_Enable") || "Enable Client Portal",
      "ok-disabled": !_vm.portalEmail.trim(),
      "ok-title": "Save"
    },
    on: {
      ok: _vm.enablePortal
    ...
    model: {
      value: _vm.showEnablePortalModal,
      callback: function callback($$v) {
        _vm.showEnablePortalModal = $$v;
      },
      expression: "showEnablePortalModal"
    }
  }, [_vm.portalErrors.length ? _c("b-alert", {
    staticClass: "small",
    attrs: {
      variant: "danger",
      dismissible: "",
  ...
  }, [_vm._v(_vm._s(_vm.portalErrors.join(" ")))]) : _vm._e(), _vm._v(" "), _c("b-form-group", {
    attrs: {
      label: _vm.$t("Portal_Email") || "Portal login email"
    }
  }, [_c("b-form-input", {
    attrs: {
      type: "email",
      placeholder: _vm.client.email
    },
    model: {
      value: _vm.portalEmail,
      callback: function callback($$v) {
        _vm.portalEmail = $$v;
      },
      expression: "portalEmail"
    }
  }), _vm._v(" "), _c("small", {
    staticClass: "text-muted"
  }, [_vm._v(_vm._s(_vm.$t("Portal_Email_Help") || "Email the client will use to log in."))])], 1), _vm._v(" "), _c("b-form-group", {
    attrs: {
      label: _vm.$t("Portal_Password") || "Portal password"
    }
  }, [_c("b-form-input", {
    attrs: {
      type: "password",
    ...
    model: {
      value: _vm.portalPassword,
      callback: function callback($$v) {
        _vm.portalPassword = $$v;
      },
      expression: "portalPassword"
    }
  }), _vm._v(" "), _c("small", {
    staticClass: "text-muted"
  }, [_vm._v(_vm._s(_vm.$t("Portal_Password_Help") || "Set a new password or leave blank to keep the current one."))])], 1)], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mt-3",
    attrs: {
      md: "12"
    }
  ...
  }, [_vm._v(_vm._s(_vm.$t("Cancel")))]), _vm._v(" "), _vm.SubmitProcessing ? _vm._m(0) : _vm._e()], 1)], 1)], 1)], 1)], 1) : _vm._e()], 1);
};
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomFieldsForm_vue_vue_type_style_index_0_id_6b5d7f34_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CustomFieldsForm.vue?vue&type=style&index=0&id=6b5d7f34&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/components/CustomFieldsForm.vue?vue&type=style&index=0&id=6b5d7f34&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomFieldsForm_vue_vue_type_style_index_0_id_6b5d7f34_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/src/views/app/pages/people/EditCustomer.vue"
/*!***************************************************************!*\
  !*** ./resources/src/views/app/pages/people/EditCustomer.vue ***!
  \***************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _EditCustomer_vue_vue_type_template_id_6419444a__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EditCustomer.vue?vue&type=template&id=6419444a */ "./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=template&id=6419444a");
/* harmony import */ var _EditCustomer_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EditCustomer.vue?vue&type=script&lang=js */ "./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=script&lang=js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _EditCustomer_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _EditCustomer_vue_vue_type_template_id_6419444a__WEBPACK_IMPORTED_MODULE_0__.render,
  _EditCustomer_vue_vue_type_template_id_6419444a__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
if (false) // removed by dead control flow
{ var api; }
component.options.__file = "resources/src/views/app/pages/people/EditCustomer.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=script&lang=js"
/*!***************************************************************************************!*\
  !*** ./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=script&lang=js ***!
  \***************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EditCustomer_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditCustomer.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EditCustomer_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=template&id=6419444a"
/*!*********************************************************************************************!*\
  !*** ./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=template&id=6419444a ***!
  \*********************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditCustomer_vue_vue_type_template_id_6419444a__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditCustomer_vue_vue_type_template_id_6419444a__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditCustomer_vue_vue_type_template_id_6419444a__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditCustomer.vue?vue&type=template&id=6419444a */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/people/EditCustomer.vue?vue&type=template&id=6419444a");
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CustomFieldsForm_vue_vue_type_style_index_0_id_6b5d7f34_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CustomFieldsForm.vue?vue&type=style&index=0&id=6b5d7f34&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/components/CustomFieldsForm.vue?vue&type=style&index=0&id=6b5d7f34&scoped=true&lang=css");
