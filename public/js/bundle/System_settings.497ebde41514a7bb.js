...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)("config", ["getThemeMode"])), (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(["currentUser", "getSidebarLayout", "getSideBarToggleProperties"])), {}, {
    ...
    metalPriceProviderOptions: function metalPriceProviderOptions() {
      var labels = {
        goldapi: 'GoldAPI.io'
      };
      var providers = this.setting && this.setting.metal_price_available_providers || ['goldapi'];
      return providers.map(function (value) {
        return {
          value: value,
    ...
    scaleProviderOptions: function scaleProviderOptions() {
      var labels = {
        http_bridge: 'Local Bridge Agent (HTTP)'
      };
      var providers = this.setting && this.setting.scale_available_providers || ['http_bridge'];
      return providers.map(function (value) {
        return {
          value: value,
          text: labels[value] || value
