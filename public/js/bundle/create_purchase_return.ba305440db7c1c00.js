...
var render = function render() {
  ...
  return _c("div", {
    ...
    return [_c("tr", {
    ...
    }, [_vm._v(_vm._s(detail.name))]), _vm._v(" "), detail.is_batch_tracked ? _c("div", {
      staticClass: "mt-1"
    }, [_c("span", {
      staticClass: "badge",
      staticStyle: {
      ...
      attrs: {
        title: _vm.$t("Auto_FEFO_Hint") || "Oldest-expiring batches will be auto-allocated (FEFO) when this return is completed."
      }
    }, [_c("lucide-icon", {
      staticStyle: {
        "margin-right": "3px"
      ...
      attrs: {
        ...
        "fetch-params": {
          purchase_id: _vm.purchase_return.purchase_id,
    ...
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.$t("OrderTax")))]), _vm._v(" "), _c("td", [_c("span", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.purchase_return.TaxNet.toFixed(_vm.priceDecimals)) + " (" + _vm._s(_vm.formatNumber(_vm.purchase_return.tax_rate, 2)) + " %)")])])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.$t("Discount")))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.purchase_return.discount.toFixed(_vm.priceDecimals)))])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "bold"
  }, [_vm._v(_vm._s(_vm.$t("Shipping")))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.purchase_return.shipping.toFixed(_vm.priceDecimals)))])]), _vm._v(" "), _c("tr", [_c("td", [_c("span", {
