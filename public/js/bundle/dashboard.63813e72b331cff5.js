...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/dashboard/dashboard.vue?vue&type=script&setup=true&lang=js"
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/dashboard/dashboard.vue?vue&type=script&setup=true&lang=js ***!
  \************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _utils_priceFormat__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../utils/priceFormat */ "./resources/src/utils/priceFormat.js");
...
var __default__ = {
  components: {
    ...
    "date-range-picker": (vue2_daterange_picker__WEBPACK_IMPORTED_MODULE_3___default())
  },
  metaInfo: {
    title: "Dashboard"
  },
  data: function data() {
    ...
    var end = moment__WEBPACK_IMPORTED_MODULE_5___default()().endOf("day");
  ...
  computed: _objectSpread(_objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(["currentUserPermissions", "currentUser"])), (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)("config", ["getThemeMode"])), {}, {
    // Monetary precision (2 or 3) driven by the "Enable 3 Decimal Pricing" setting.
    priceDecimals: function priceDecimals() {
      return (0,_utils_priceFormat__WEBPACK_IMPORTED_MODULE_6__.getPriceDecimals)({
        store: this.$store
      });
    },
    ...
    defaultDashboardSectionIds: function defaultDashboardSectionIds() {
      return ["header", "stat_cards_1", "stat_cards_2", "chart_sales_purchases", "chart_top_selling", "sales_by_payment_stock_value", "chart_payment_sent_received", "chart_top_customers", "table_stock_alert", "table_top_selling_products", "table_recent_sales"];
    },
    // Ordered list of section ids for display (saved order + any new sections appended)
    orderedDashboardSections: function orderedDashboardSections() {
      var saved = this.dashboardSectionOrder || [];
      var defaultIds = this.defaultDashboardSectionIds || [];
      var byId = {};
    ...
    dashboardFontStyle: function dashboardFontStyle() {
      var s = {};
  ...
  watch: {
    'getThemeMode.dark': function getThemeModeDark() {
      var _this = this;
      this.$nextTick(function () {
        _this.refreshChartTheme();
      });
    }
  },
  methods: {
    themeVar: function themeVar(name, fallback) {
      try {
    ...
    chartPalette: function chartPalette() {
      return {
        sales: [this.themeVar('--chart-accent-1', '#b48852'), this.themeVar('--chart-accent-5', '#c5a67a')],
        products: [this.themeVar('--chart-accent-1', '#b48852'), this.themeVar('--chart-accent-2', '#6b7a66'), this.themeVar('--chart-accent-3', '#8f6b58'), this.themeVar('--chart-accent-4', '#8e8071'), this.themeVar('--chart-accent-6', '#4a5a62')],
        customers: [this.themeVar('--chart-accent-1', '#b48852'), this.themeVar('--chart-accent-5', '#c5a67a'), this.themeVar('--chart-accent-4', '#8e8071'), this.themeVar('--chart-accent-2', '#6b7a66'), this.themeVar('--chart-accent-3', '#8f6b58')],
        payments: [this.themeVar('--chart-accent-3', '#8f6b58'), this.themeVar('--chart-accent-2', '#6b7a66')],
        grid: this.themeVar('--chart-grid', 'rgba(96, 74, 48, 0.12)')
      };
    },
    refreshChartTheme: function refreshChartTheme() {
      var theme = this.chartPalette();
      if (this.chartSalesOptions && Object.keys(this.chartSalesOptions).length) {
        this.chartSalesOptions = _objectSpread(_objectSpread({}, this.chartSalesOptions), {}, {
          colors: theme.sales,
          grid: _objectSpread(_objectSpread({}, this.chartSalesOptions.grid || {}), {}, {
            borderColor: theme.grid
          })
        });
      }
      if (this.chartProductOptions && Object.keys(this.chartProductOptions).length) {
        this.chartProductOptions = _objectSpread(_objectSpread({}, this.chartProductOptions), {}, {
          colors: theme.products
        });
      }
      if (this.chartCustomerOptions && Object.keys(this.chartCustomerOptions).length) {
        this.chartCustomerOptions = _objectSpread(_objectSpread({}, this.chartCustomerOptions), {}, {
          colors: theme.customers
        });
      }
      if (this.chartPaymentOptions && Object.keys(this.chartPaymentOptions).length) {
        this.chartPaymentOptions = _objectSpread(_objectSpread({}, this.chartPaymentOptions), {}, {
          colors: theme.payments,
          grid: _objectSpread(_objectSpread({}, this.chartPaymentOptions.grid || {}), {}, {
            borderColor: theme.grid
          })
        });
      }
    ...
    fmt: function fmt(d) {
      return moment__WEBPACK_IMPORTED_MODULE_5___default()(d).format("YYYY-MM-DD");
    },
    quick: function quick(key) {
      ...
      switch (key) {
        ...
        case "90d":
          ...
          break;
        case "mtd":
          start = moment__WEBPACK_IMPORTED_MODULE_5___default()().startOf("month");
          break;
        case "ytd":
          start = moment__WEBPACK_IMPORTED_MODULE_5___default()().startOf("year");
          break;
      }
      this.dateRange = {
        startDate: start.toDate(),
    ...
    Submit_filter_dateRange: function Submit_filter_dateRange() {
      var s = moment__WEBPACK_IMPORTED_MODULE_5___default()(this.dateRange.startDate);
      var e = moment__WEBPACK_IMPORTED_MODULE_5___default()(this.dateRange.endDate);
    ...
    get_data_loaded: function get_data_loaded() {
      if (this.today_mode) {
        var end = moment__WEBPACK_IMPORTED_MODULE_5___default()().endOf("day");
        var start = end.clone();
        var range = this.defaultDateRange || "week";
        if (range === "today") {
          start = end.clone().startOf("day");
        } else if (range === "week") {
          start = end.clone().subtract(6, "days").startOf("day");
    ...
    all_dashboard_data: function all_dashboard_data() {
      ...
      axios.get("/dashboard_data?warehouse_id=".concat(this.warehouse_id, "&to=").concat(this.endDate, "&from=").concat(this.startDate)).then(function (response) {
        ...
        var seriesSalesName = _this2.$t('Sales');
        var seriesPurchasesName = _this2.$t('Purchases');
        var amountLabel = _this2.$t('Amount');
        var totalSalesLabel = _this2.$t('Total_Sales');
        var salesLabel = _this2.$t('Sales');
        var paymentSentName = _this2.$t('Payment_Sent');
        var paymentReceivedName = _this2.$t('Payment_Received');
        var chartTheme = _this2.chartPalette();
        ...
        _this2.report_today = _objectSpread(_objectSpread({}, reportData), {}, {
        ...
        _this2.stock_alerts = response.data.report_dashboard.original.stock_alert;
        _this2.products = response.data.report_dashboard.original.products;
        _this2.sales = response.data.report_dashboard.original.last_sales;
        ...
        if (response.data.sales_by_payment && Array.isArray(response.data.sales_by_payment)) {
          ...
          _this2.sales_by_payment = response.data.sales_by_payment.map(function (payment) {
            return {
              name: payment.name,
          ...
          yaxis: {
            ...
            labels: {
              formatter: function formatter(value) {
                try {
                  return _this2.formatPriceDisplay(value, 2);
                } catch (e) {
                  var n = Number(value);
                  if (isNaN(n)) return value;
                  var s = n.toFixed(_this2.priceDecimals);
                  return s.replace(/\.00$/, "");
                }
              }
            }
          ...
          tooltip: {
            y: {
              formatter: function formatter(val) {
                try {
                  return _this2.formatPriceDisplay(val, 2);
                } catch (e) {
                  var n = Number(val);
        ...
        _this2.chartProductSeries = productData.map(function (item) {
          return item.value;
        });
        _this2.chartProductOptions = {
          chart: {
            type: "donut",
            fontFamily: "inherit"
          },
        ...
        _this2.chartCustomerSeries = customerData.map(function (item) {
          return item.value;
        });
        _this2.chartCustomerOptions = {
          chart: {
            type: "pie",
            fontFamily: "inherit"
          },
    ...
    formatPriceDisplay: function formatPriceDisplay(number, dec) {
      try {
        ...
        var key = this.price_format_key || (0,_utils_priceFormat__WEBPACK_IMPORTED_MODULE_6__.getPriceFormatSetting)({
          store: this.$store
        });
        if (key) {
        ...
        return (0,_utils_priceFormat__WEBPACK_IMPORTED_MODULE_6__.formatPriceDisplay)(n, decimals, effectiveKey);
      } catch (e) {
    ...
    loadDefaultDateRangeSetting: function loadDefaultDateRangeSetting() {
      var _this3 = this;
      return axios.get("get_Settings_data").then(function (response) {
        var settings = response.data && response.data.settings || {};
        var value = settings.default_dashboard_date_range;
        if (value === "today" || value === "week" || value === "month") {
          _this3.defaultDateRange = value;
        } else {
          _this3.defaultDateRange = "week";
        }
        // Apply dashboard widget order from System Settings
        var raw = settings.dashboard_section_order;
        var order = [];
        try {
          if (raw && typeof raw === "string") order = JSON.parse(raw);else if (Array.isArray(raw)) order = raw;
        } catch (e) {}
        _this3.dashboardSectionOrder = order;
        _this3.dashboardFontSize = settings.dashboard_font_size || "";
        _this3.dashboardFontFamily = settings.dashboard_font_family || "";
        return _this3.defaultDateRange;
      })["catch"](function () {
        _this3.defaultDateRange = "week";
        return "week";
      });
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            _context.n = 1;
            return _this4.loadDefaultDateRangeSetting();
          case 1:
            range = _context.v;
            _this4.defaultDateRange = range;
            _context.n = 2;
            return _this4.all_dashboard_data();
          case 2:
            _this4.GetMonth();
          case 3:
            return _context.a(2);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/Object.assign(__default__, {
  ...
  setup: function setup(__props) {
    ...
    var mobileQuickModules = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
      if (!vm) return [];
      var $t = vm.$t.bind(vm);
      var rows = [];
      var push = function push(keys, to, iconName, toneClass, labelKey, fallback) {
        if (!hasPerm(keys)) return;
        var label = $t(labelKey) || fallback;
        rows.push({
          key: "".concat(to, "::").concat(labelKey),
          to: to,
          iconName: iconName,
          toneClass: toneClass,
          label: label
    ...
    var mobileTabBarItems = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
      if (!vm) return [];
      var $t = vm.$t.bind(vm);
      var perms = currentUserPermissions.value;
      var hasReports = REPORTS_MENU_PERMISSIONS.some(function (p) {
        return perms.includes(p);
      });
      var settingsTo = perms.includes("setting_system") ? "/app/settings/System_settings" : "/app/profile";
      var settingsLabel = perms.includes("setting_system") ? $t("Settings") || "Settings" : $t("profil") || "Account";
      return [{
        to: "/app/dashboard",
    ...
    var mobileTabBarItemsFiltered = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
      return mobileTabBarItems.value.filter(function (t) {
        return t.show;
      }).map(function (t, i) {
        return {
          key: "tab-".concat(t.to, "-").concat(i),
          to: t.to,
          label: t.label,
          iconName: t.iconName,
          exact: t.exact
    ...
    return {
      __sfc: true,
      MOBILE_MQ: MOBILE_MQ,
      DASHBOARD_TABBAR_BODY_CLASS: DASHBOARD_TABBAR_BODY_CLASS,
      _inst: _inst,
      vm: vm,
      store: store,
      ...
      syncDashboardTabbarBodyClass: syncDashboardTabbarBodyClass,
      REPORTS_MENU_PERMISSIONS: REPORTS_MENU_PERMISSIONS,
      hasPerm: hasPerm,
      mobileQuickModules: mobileQuickModules,
      mobileTabBarItems: mobileTabBarItems,
      mobileTabBarItemsFiltered: mobileTabBarItemsFiltered,
      mqCleanup: mqCleanup,
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }) : !_vm.loading && _setup.currentUserPermissions && _setup.currentUserPermissions.includes("dashboard") ? _c("div", {
    staticClass: "dashboard-static dashboard-page-root",
    "class": {
      "dashboard-static--mobile-app": _setup.isMobileViewport
    },
    style: _vm.dashboardFontStyle
  }, [_vm._l(_vm.orderedDashboardSections, function (sectionId) {
    return [sectionId === "header" ? [_c("div", {
      key: "hdr-" + sectionId,
      staticClass: "dashboard-header mb-3"
    }, [_c("div", {
      staticClass: "row align-items-center"
    }, [_c("div", {
      staticClass: "col-md-6 dashboard-header-titles"
    }, [_c("h2", {
      ...
      staticClass: "col-md-6 text-right dashboard-header-filters-col"
    }, [_c("div", {
      ...
      key: "mq-" + sectionId,
      staticClass: "dashboard-mobile-only mobile-quick-modules",
      attrs: {
        "aria-label": "Quick modules"
      }
    }, [_c("div", {
      staticClass: "mobile-module-grid"
    }, _vm._l(_setup.mobileQuickModules, function (mod) {
      return _c("router-link", {
        key: mod.key,
        staticClass: "mobile-module-tile ripple-touch",
        attrs: {
          to: mod.to
        }
      }, [_c("div", {
        staticClass: "mobile-module-icon",
        "class": mod.toneClass
      }, [_c("lucide-icon", {
        attrs: {
          name: mod.iconName
        ...
        staticClass: "mobile-module-label"
      }, [_vm._v(_vm._s(mod.label))])]);
    }), 1)])] : sectionId === "stat_cards_1" ? _c("b-row", {
      key: sectionId,
      staticClass: "mb-3 align-items-stretch dashboard-mobile-stat-grid"
    }, [_c("b-col", {
      ...
      staticClass: "stat-card sales-card h-100",
      attrs: {
        to: "/app/sales/list"
      }
    }, [_c("div", {
    ...
    }, [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, _vm.report_today.today_sales || 0, 2)))])])])], 1), _vm._v(" "), _c("b-col", {
      staticClass: "mb-3 mb-md-0",
      attrs: {
        md: "3",
        sm: "6"
      ...
      staticClass: "stat-card purchases-card h-100",
      attrs: {
      ...
      staticClass: "stat-card-value"
    }, [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, _vm.report_today.today_purchases || 0, 2)))])])])], 1), _vm._v(" "), _c("b-col", {
      staticClass: "mb-3 mb-md-0",
      attrs: {
        md: "3",
        sm: "6"
      ...
      staticClass: "stat-card returns-card h-100",
      attrs: {
      ...
      staticClass: "stat-card-value"
    }, [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, _vm.report_today.return_sales || 0, 2)))])])])], 1), _vm._v(" "), _c("b-col", {
      staticClass: "mb-3 mb-md-0",
      attrs: {
        md: "3",
        sm: "6"
      ...
      staticClass: "stat-card revenue-card h-100",
      attrs: {
      ...
      staticClass: "stat-card-value"
    }, [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, _vm.report_today.return_purchases || 0, 2)))])])])], 1)], 1) : sectionId === "stat_cards_2" ? _c("b-row", {
      key: sectionId,
      staticClass: "mb-3 align-items-stretch dashboard-mobile-stat-grid"
    }, [_c("b-col", {
      staticClass: "mb-3 mb-md-0",
      ...
      staticClass: "stat-card sales-due-card h-100",
      attrs: {
        to: "/app/sales/list"
      }
    }, [_c("div", {
      ...
      staticClass: "stat-card-value"
    }, [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, _vm.report_today.sales_due || 0, 2)))])])])], 1), _vm._v(" "), _c("b-col", {
      staticClass: "mb-3 mb-md-0",
      attrs: {
        md: "3",
        sm: "6"
      ...
      staticClass: "stat-card purchase-due-card h-100",
      attrs: {
        to: "/app/purchases/list"
      }
    }, [_c("div", {
      ...
      staticClass: "stat-card-label"
    }, [_vm._v(_vm._s(_vm.$t("Total_Purchase_Due")))]), _vm._v(" "), _c("h3", {
      staticClass: "stat-card-value"
    }, [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, _vm.report_today.purchase_due || 0, 2)))])])])], 1), _vm._v(" "), _c("b-col", {
      staticClass: "mb-3 mb-md-0",
      attrs: {
        md: "3",
        sm: "6"
      ...
      staticClass: "stat-card invoices-card h-100",
      attrs: {
        to: "/app/sales/list"
      }
    }, [_c("div", {
      ...
      staticClass: "stat-card-label"
    }, [_vm._v(_vm._s(_vm.$t("Invoice")))]), _vm._v(" "), _c("h3", {
      staticClass: "stat-card-value"
    }, [_vm._v(_vm._s(_vm.report_today.today_invoices ? _vm.report_today.today_invoices : 0))])])])], 1), _vm._v(" "), _c("b-col", {
      staticClass: "mb-3 mb-md-0",
      attrs: {
        md: "3",
        sm: "6"
      ...
      staticClass: "stat-card profit-card h-100",
      attrs: {
      ...
      staticClass: "stat-card-label"
    }, [_vm._v(_vm._s(_vm.$t("Profit")))]), _vm._v(" "), _c("h3", {
      staticClass: "stat-card-value"
    }, [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, _vm.report_today.today_profit || 0, 2)))])])])], 1)], 1) : sectionId === "chart_sales_purchases" ? _c("b-row", {
      key: sectionId,
      staticClass: "mb-3 align-items-stretch"
    }, [_c("b-col", {
      attrs: {
        cols: "12"
      }
    }, [_c("div", {
      staticClass: "chart-card h-100"
    }, [_c("div", {
    ...
    })])], 1)])])], 1) : sectionId === "chart_top_selling" ? _c("b-row", {
      key: sectionId,
      staticClass: "mb-3 align-items-stretch"
    }, [_c("b-col", {
      attrs: {
      ...
      staticClass: "spinner spinner-primary"
    })])], 1)])])], 1) : sectionId === "sales_by_payment_stock_value" ? _c("b-row", {
      key: sectionId,
      staticClass: "mb-3 align-items-stretch"
    }, [_c("b-col", {
      staticClass: "mb-3 mb-md-0",
      ...
      staticClass: "info-card h-100"
    }, [_c("div", {
      staticClass: "info-card-header"
    }, [_c("h4", {
      staticClass: "info-card-title"
    }, [_vm._v(_vm._s(_vm.$t("Sales_by_Payment") || "Sales by Payment"))]), _vm._v(" "), _c("div", {
      ...
      staticClass: "info-card-title"
    }, [_vm._v(_vm._s(_vm.$t("Stock_Value") || "Stock Value"))]), _vm._v(" "), _c("div", {
      staticClass: "info-card-menu"
    }, [_c("lucide-icon", {
      attrs: {
        name: "more-vertical"
    ...
    })], 1), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.$t("Stock_Value_by_Cost") || "Stock Value by Cost"))])]), _vm._v(" "), _c("div", {
      staticClass: "info-card-item-value"
    }, [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, _vm.stock_value.by_cost || 0, 2)))])])]), _vm._v(" "), _c("div", {
      staticClass: "info-card-item stock-value-item"
    }, [_c("div", {
      staticClass: "info-card-item-header"
    }, [_c("div", {
    ...
    })], 1), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.$t("Stock_Value_by_Retail") || "Stock Value by Retail"))])]), _vm._v(" "), _c("div", {
      staticClass: "info-card-item-value"
    }, [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, _vm.stock_value.by_retail || 0, 2)))])])]), _vm._v(" "), _c("div", {
      staticClass: "info-card-item stock-value-item"
    }, [_c("div", {
      staticClass: "info-card-item-header"
    }, [_c("div", {
    ...
    })], 1), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.$t("Stock_Value_by_Wholesale") || "Stock Value by Wholesale"))])]), _vm._v(" "), _c("div", {
      staticClass: "info-card-item-value"
    }, [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, _vm.stock_value.by_wholesale || 0, 2)))])])])])])])], 1) : sectionId === "chart_payment_sent_received" ? _c("b-row", {
      key: sectionId,
      staticClass: "mb-3 align-items-stretch"
    }, [_c("b-col", {
      attrs: {
      ...
      staticClass: "spinner spinner-primary"
    })])], 1)])])], 1) : sectionId === "chart_top_customers" ? _c("b-row", {
      key: sectionId,
      staticClass: "mb-3 align-items-stretch"
    }, [_c("b-col", {
      attrs: {
      ...
      staticClass: "spinner spinner-primary"
    })])], 1)])])], 1) : sectionId === "table_stock_alert" ? _c("b-row", {
      key: sectionId,
      staticClass: "mb-3 align-items-stretch"
    }, [_c("b-col", {
      attrs: {
    ...
    }, [_vm._v(_vm._s(_vm.$t("View")) + " " + _vm._s(_vm.$t("All")) + " "), _c("lucide-icon", {
      attrs: {
        name: "arrow-right"
      }
    })], 1)], 1), _vm._v(" "), _c("div", {
    ...
    })], 1)])])], 1) : sectionId === "table_top_selling_products" ? _c("b-row", {
      key: sectionId,
      staticClass: "mb-3 align-items-stretch"
    }, [_c("b-col", {
      attrs: {
    ...
    })], 1)])])], 1) : sectionId === "table_recent_sales" ? _c("b-row", {
      key: sectionId,
      staticClass: "mb-3"
    }, [_c("b-col", {
      attrs: {
      ...
      scopedSlots: _vm._u([{
        ...
        fn: function fn(props) {
          return [props.column.field == "statut" ? _c("div", [props.row.statut == "completed" ? _c("span", {
            ...
            staticClass: "badge badge-warning"
          }, [_vm._v(_vm._s(_vm.$t("Unpaid")))])]) : props.column.field == "GrandTotal" ? _c("span", [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, props.row.GrandTotal, 2)))]) : props.column.field == "paid_amount" ? _c("span", [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, props.row.paid_amount, 2)))]) : props.column.field == "due" ? _c("span", [_vm._v(_vm._s(_vm.formatPriceWithSymbol(_vm.currentUser && _vm.currentUser.currency, props.row.due, 2)))]) : _vm._e()];
        }
      }], null, true)
    }) : _vm._e()], 1)])])], 1) : _vm._e()];
  }), _vm._v(" "), _c("nav", {
    staticClass: "dashboard-mobile-only mobile-tabbar",
    attrs: {
      role: "navigation",
      "aria-label": _vm.$t("dashboard") || "Dashboard"
    }
  }, _vm._l(_setup.mobileTabBarItemsFiltered, function (tab) {
    return _c("router-link", {
      key: tab.key,
      staticClass: "mobile-tabbar__item ripple-touch",
      attrs: {
        to: tab.to,
        exact: tab.exact,
      ...
      staticClass: "mobile-tabbar__label"
  ...
  })], 1), _vm._v(" "), _c("h3", [_vm._v(_vm._s(_vm.$t("Welcome_to_your_Dashboard")))]), _vm._v(" "), _c("p", {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_dashboard_vue_vue_type_style_index_0_id_5fd1f857_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./dashboard.vue?vue&type=style&index=0&id=5fd1f857&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/dashboard/dashboard.vue?vue&type=style&index=0&id=5fd1f857&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_dashboard_vue_vue_type_style_index_0_id_5fd1f857_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _dashboard_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard.vue?vue&type=script&setup=true&lang=js */ "./resources/src/views/app/dashboard/dashboard.vue?vue&type=script&setup=true&lang=js");
...
/***/ "./resources/src/views/app/dashboard/dashboard.vue?vue&type=script&setup=true&lang=js"
/*!********************************************************************************************!*\
  !*** ./resources/src/views/app/dashboard/dashboard.vue?vue&type=script&setup=true&lang=js ***!
  \********************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dashboard_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./dashboard.vue?vue&type=script&setup=true&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/dashboard/dashboard.vue?vue&type=script&setup=true&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_dashboard_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_dashboard_vue_vue_type_style_index_0_id_5fd1f857_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./dashboard.vue?vue&type=style&index=0&id=5fd1f857&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/dashboard/dashboard.vue?vue&type=style&index=0&id=5fd1f857&scoped=true&lang=css");
