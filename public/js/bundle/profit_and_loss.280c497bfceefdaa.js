...
var StatTile = {
  ...
  render: function render(h, _ref) {
    ...
    return h('div', {
      "class": ['stat-card', "theme-".concat(props.theme), 'shadow-soft', 'rounded-xl', 'mb-2']
    }, [h('div', {
      "class": 'stat-inner'
    }, [h('div', {
      "class": 'stat-icon'
      ...
      "class": 'stat-label'
    }, props.label), props.sub ? h('div', {
      "class": 'stat-sub text-muted'
    }, props.sub) : null, h('div', {
      "class": 'stat-value'
    }, props.value), props.hint ? h('div', {
      "class": 'stat-hint text-muted'
    }, props.hint) : null])])]);
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    var start = moment__WEBPACK_IMPORTED_MODULE_4___default()().startOf('day').toDate();
    var end = moment__WEBPACK_IMPORTED_MODULE_4___default()().endOf('day').toDate();
    return {
      warehouses: [],
      warehouse_id: null,
      isLoading: true,
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(["currentUser"])), {}, {
    ...
    priceDecimals: function priceDecimals() {
      return (0,_utils_priceFormat__WEBPACK_IMPORTED_MODULE_5__.getPriceDecimals)({
        store: this.$store
      });
    },
  ...
  methods: {
    ...
    money: function money(v) {
      try {
        ...
        var formatted = (0,_utils_priceFormat__WEBPACK_IMPORTED_MODULE_5__.formatPriceDisplay)(n, this.priceDecimals, effectiveKey);
    ...
    shortMoney: function shortMoney(v) {
      var n = this.num(v);
      return new Intl.NumberFormat(undefined, {
        notation: 'compact',
    ...
    printTableOnly: function printTableOnly() {
      var title = "".concat(this.$t("Reports"), " / ").concat(this.$t("ProfitandLoss"));
      ...
      var tableHtml = "<table style=\"width: 100%; border-collapse: collapse; font-size: 11px; margin-top: 16px;\">";

      // Header section
      tableHtml += "<thead><tr><th colspan=\"2\" style=\"border: 1px solid #ddd; padding: 12px; background-color: #f5f5f5; font-weight: bold; text-align: left;\">".concat(title, "</th></tr>");
      tableHtml += "<tr><td colspan=\"2\" style=\"border: 1px solid #ddd; padding: 8px; background-color: #f9f9f9; font-size: 10px;\">".concat(dateRangeText).concat(warehouseText, "</td></tr>");
      tableHtml += "</thead>";
      ...
      // Sales
      tableHtml += "<tr><td style=\"border: 1px solid #ddd; padding: 8px; font-weight: 600;\">".concat(this.$t('Sales'), " (").concat(this.num(this.infos.sales_count), ")</td><td style=\"border: 1px solid #ddd; padding: 8px; text-align: right;\">").concat(this.money(this.infos.sales_sum), "</td></tr>");

      // Purchases
      tableHtml += "<tr><td style=\"border: 1px solid #ddd; padding: 8px; font-weight: 600;\">".concat(this.$t('Purchases'), " (").concat(this.num(this.infos.purchases_count), ")</td><td style=\"border: 1px solid #ddd; padding: 8px; text-align: right;\">").concat(this.money(this.infos.purchases_sum), "</td></tr>");

      // Sales Return
      tableHtml += "<tr><td style=\"border: 1px solid #ddd; padding: 8px; font-weight: 600;\">".concat(this.$t('SalesReturn'), " (").concat(this.num(this.infos.returns_sales_count), ")</td><td style=\"border: 1px solid #ddd; padding: 8px; text-align: right;\">").concat(this.money(this.infos.returns_sales_sum), "</td></tr>");

      // Purchases Return
      tableHtml += "<tr><td style=\"border: 1px solid #ddd; padding: 8px; font-weight: 600;\">".concat(this.$t('PurchasesReturn'), " (").concat(this.num(this.infos.returns_purchases_count), ")</td><td style=\"border: 1px solid #ddd; padding: 8px; text-align: right;\">").concat(this.money(this.infos.returns_purchases_sum), "</td></tr>");

      // Separator
      tableHtml += "<tr><td colspan=\"2\" style=\"border: 1px solid #ddd; padding: 4px; background-color: #f5f5f5;\"></td></tr>";

      // Revenue
      tableHtml += "<tr><td style=\"border: 1px solid #ddd; padding: 8px; font-weight: 700; background-color: #eef0ff;\">".concat(this.$t('Revenue'), "</td><td style=\"border: 1px solid #ddd; padding: 8px; text-align: right; font-weight: 700; background-color: #eef0ff;\">").concat(this.money(this.infos.total_revenue), "</td></tr>");

      // Payments Received
      tableHtml += "<tr><td style=\"border: 1px solid #ddd; padding: 8px; font-weight: 600;\">".concat(this.$t('PaiementsReceived'), "</td><td style=\"border: 1px solid #ddd; padding: 8px; text-align: right;\">").concat(this.money(this.infos.payment_received), "</td></tr>");

      // Payments Sent
      tableHtml += "<tr><td style=\"border: 1px solid #ddd; padding: 8px; font-weight: 600;\">".concat(this.$t('PaiementsSent'), "</td><td style=\"border: 1px solid #ddd; padding: 8px; text-align: right;\">").concat(this.money(this.infos.payment_sent), "</td></tr>");

      // Expenses
      tableHtml += "<tr><td style=\"border: 1px solid #ddd; padding: 8px; font-weight: 600;\">".concat(this.$t('Expenses'), "</td><td style=\"border: 1px solid #ddd; padding: 8px; text-align: right;\">").concat(this.money(this.infos.expenses_sum), "</td></tr>");

      // Payments Net
      tableHtml += "<tr><td style=\"border: 1px solid #ddd; padding: 8px; font-weight: 700; background-color: #eef2f7;\">".concat(this.$t('PaiementsNet'), "</td><td style=\"border: 1px solid #ddd; padding: 8px; text-align: right; font-weight: 700; background-color: #eef2f7;\">").concat(this.money(this.infos.paiement_net), "</td></tr>");

      // Separator
      tableHtml += "<tr><td colspan=\"2\" style=\"border: 1px solid #ddd; padding: 4px; background-color: #f5f5f5;\"></td></tr>";

      // Profit Net (FIFO)
      tableHtml += "<tr><td style=\"border: 1px solid #ddd; padding: 8px; font-weight: 700; background-color: #e6fbff;\">".concat(this.$t('ProfitNet'), " (FIFO)</td><td style=\"border: 1px solid #ddd; padding: 8px; text-align: right; font-weight: 700; background-color: #e6fbff;\">").concat(this.money(this.infos.profit_fifo), "</td></tr>");

      // Profit Net (Average Cost)
      tableHtml += "<tr><td style=\"border: 1px solid #ddd; padding: 8px; font-weight: 700; background-color: #fff8e1;\">".concat(this.$t('ProfitNet'), " (").concat(this.$t('AverageCost'), ")</td><td style=\"border: 1px solid #ddd; padding: 8px; text-align: right; font-weight: 700; background-color: #fff8e1;\">").concat(this.money(this.infos.profit_average_cost), "</td></tr>");
    ...
    fetchPnl: function fetchPnl() {
      var _this2 = this;
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().start();
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().set(0.1);
      this.isLoading = true;
      var from = this.fmtDate(this.dateRange.startDate);
      var to = this.fmtDate(this.dateRange.endDate);
      var wh = this.warehouse_id || '';
      axios.get("report/profit_and_loss?from=".concat(from, "&to=").concat(to, "&warehouse_id=").concat(wh)).then(function (_ref2) {
        var data = _ref2.data;
        _this2.infos = data.data || {};
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/profit_and_loss.vue?vue&type=template&id=b6b30cee&scoped=true"
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/profit_and_loss.vue?vue&type=template&id=b6b30cee&scoped=true ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.warehouseLabel))]) : _vm._e()])])])], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
      md: "6",
      sm: "6"
    ...
    attrs: {
      icon: "banknote",
      label: _vm.$t("Sales"),
      sub: "(".concat(_vm.num(_vm.infos.sales_count), ")"),
      value: _vm.money(_vm.infos.sales_sum),
      theme: "blue"
    }
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    ...
    attrs: {
      icon: "shopping-cart",
      label: _vm.$t("Purchases"),
      sub: "(".concat(_vm.num(_vm.infos.purchases_count), ")"),
      value: _vm.money(_vm.infos.purchases_sum),
      theme: "teal"
    }
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    ...
    attrs: {
      icon: "repeat",
      label: _vm.$t("SalesReturn"),
      sub: "(".concat(_vm.num(_vm.infos.returns_sales_count), ")"),
      value: _vm.money(_vm.infos.returns_sales_sum),
      theme: "orange"
    }
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    ...
    attrs: {
      icon: "undo",
      label: _vm.$t("PurchasesReturn"),
      sub: "(".concat(_vm.num(_vm.infos.returns_purchases_count), ")"),
      value: _vm.money(_vm.infos.returns_purchases_sum),
      theme: "purple"
    }
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    ...
    attrs: {
      icon: "trending-up",
      label: _vm.$t("Revenue"),
      value: _vm.money(_vm.infos.total_revenue),
      theme: "indigo",
      hint: "".concat(_vm.$t("Sales"), " \u2013 ").concat(_vm.$t("SalesReturn"))
    }
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
    ...
    attrs: {
      icon: "wallet",
      label: _vm.$t("PaiementsReceived"),
      value: _vm.money(_vm.infos.payment_received),
      theme: "green",
      hint: "".concat(_vm.$t("PaymentsSales"), " + ").concat(_vm.$t("PurchasesReturn"))
    }
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
    ...
    attrs: {
      icon: "user-minus",
      label: _vm.$t("PaiementsSent"),
      value: _vm.money(_vm.infos.payment_sent),
      theme: "rose",
      hint: "".concat(_vm.$t("PaymentsPurchases"), " + ").concat(_vm.$t("SalesReturn"), " + ").concat(_vm.$t("Expenses"))
    }
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
    ...
    attrs: {
      icon: "receipt",
      label: _vm.$t("Expenses"),
      value: _vm.money(_vm.infos.expenses_sum),
      theme: "rose"
    }
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    ...
    attrs: {
      icon: "banknote",
      label: _vm.$t("PaiementsNet"),
      value: _vm.money(_vm.infos.paiement_net),
      theme: "slate",
      hint: "".concat(_vm.$t("Recieved"), " \u2013 ").concat(_vm.$t("Sent"))
    }
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
    ...
    attrs: {
      icon: "bar-chart",
      label: _vm.$t("ProfitNet") + " (FIFO)",
      value: _vm.money(_vm.infos.profit_fifo),
      theme: "cyan",
      hint: "".concat(_vm.$t("Sales"), " \u2013 ").concat(_vm.$t("Product_Cost"), " \u2013 ").concat(_vm.$t("Expenses"))
    }
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
    ...
    attrs: {
      icon: "bar-chart",
      label: _vm.$t("ProfitNet") + " (" + _vm.$t("AverageCost") + ")",
      value: _vm.money(_vm.infos.profit_average_cost),
      theme: "amber",
      hint: "".concat(_vm.$t("Sales"), " \u2013 ").concat(_vm.$t("Product_Cost"), " \u2013 ").concat(_vm.$t("Expenses"))
    }
  })], 1)], 1)], 1);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.rounded-xl[data-v-b6b30cee] { border-radius: 1rem;\n}\n.shadow-soft[data-v-b6b30cee] { box-shadow: 0 12px 24px rgba(0,0,0,0.06), 0 2px 6px rgba(0,0,0,0.05);\n}\n.toolbar-card[data-v-b6b30cee] { background: #fff;\n}\n.btn-pill[data-v-b6b30cee] { border-radius: 999px;\n}\n.w-280[data-v-b6b30cee] { width: 280px;\n}\n.stat-card[data-v-b6b30cee] {\n  background: linear-gradient(135deg, var(--gradA,#f7f9ff), var(--gradB,#ffffff));\n  padding: 14px 16px; min-height: 110px; position: relative;\n}\n.stat-inner[data-v-b6b30cee] { display: flex; align-items: center;\n}\n.stat-icon[data-v-b6b30cee] {\n  width: 48px; height: 48px; border-radius: 12px; margin-right: 12px;\n  display:flex; align-items:center; justify-content:center;\n  background: rgba(255,255,255,0.75);\n  box-shadow: inset 0 1px 0 rgba(255,255,255,0.7), 0 1px 2px rgba(0,0,0,0.05);\n}\n.stat-icon i[data-v-b6b30cee]{ font-size: 22px;\n}\n.stat-label[data-v-b6b30cee]{ font-size: .85rem; font-weight: 600;\n}\n.stat-sub[data-v-b6b30cee]{ font-size: .75rem; margin-top: -2px;\n}\n.stat-value[data-v-b6b30cee]{ font-size: 1.35rem; font-weight: 700; line-height: 1.2; margin-top: 2px;\n}\n.stat-hint[data-v-b6b30cee]{ font-size: .75rem; margin-top: 2px;\n}\n.theme-blue[data-v-b6b30cee]   { --gradA:#e6f0ff; --gradB:#ffffff; color:#0b5fff;\n}\n.theme-teal[data-v-b6b30cee]   { --gradA:#e6fbf6; --gradB:#ffffff; color:#138f7a;\n}\n.theme-orange[data-v-b6b30cee] { --gradA:#fff4e6; --gradB:#ffffff; color:#cc6b00;\n}\n.theme-purple[data-v-b6b30cee] { --gradA:#f5e6ff; --gradB:#ffffff; color:#6a2ecc;\n}\n.theme-indigo[data-v-b6b30cee] { --gradA:#eef0ff; --gradB:#ffffff; color:#3949ab;\n}\n.theme-green[data-v-b6b30cee]  { --gradA:#edf9ee; --gradB:#ffffff; color:#2e7d32;\n}\n.theme-rose[data-v-b6b30cee]   { --gradA:#ffe8f0; --gradB:#ffffff; color:#c2185b;\n}\n.theme-slate[data-v-b6b30cee]  { --gradA:#eef2f7; --gradB:#ffffff; color:#455a64;\n}\n.theme-cyan[data-v-b6b30cee]   { --gradA:#e6fbff; --gradB:#ffffff; color:#00838f;\n}\n.theme-amber[data-v-b6b30cee]  { --gradA:#fff8e1; --gradB:#ffffff; color:#b28704;\n}\n.formula[data-v-b6b30cee] { background: #fafbff;\n}\n\n/* Keep the picker above navbars/modals/offcanvas */\n.daterangepicker[data-v-b6b30cee] { z-index: 2055 !important;\n}\n\n/* Mobile layout: full-width-ish and stacked */\n@media (max-width: 576px) {\n.daterangepicker[data-v-b6b30cee] {\n    left: 8px !important;\n    right: 8px !important;\n    width: auto !important;\n    max-width: calc(100vw - 16px) !important;\n}\n.daterangepicker .drp-calendar[data-v-b6b30cee],\n  .daterangepicker .ranges[data-v-b6b30cee] {\n    float: none !important;\n    width: 100% !important;\n}\n\n  /* Make Quick ranges wrap into two columns on small screens */\n.quick-ranges[data-v-b6b30cee] {\n    display: flex !important;\n    flex-wrap: wrap;\n    width: 100%;\n}\n.quick-ranges .btn[data-v-b6b30cee] {\n    flex: 1 1 calc(50% - 6px);\n    margin-bottom: 6px;\n}\n}\n\n\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_profit_and_loss_vue_vue_type_style_index_0_id_b6b30cee_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./profit_and_loss.vue?vue&type=style&index=0&id=b6b30cee&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/profit_and_loss.vue?vue&type=style&index=0&id=b6b30cee&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_profit_and_loss_vue_vue_type_style_index_0_id_b6b30cee_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _profit_and_loss_vue_vue_type_template_id_b6b30cee_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profit_and_loss.vue?vue&type=template&id=b6b30cee&scoped=true */ "./resources/src/views/app/pages/reports/profit_and_loss.vue?vue&type=template&id=b6b30cee&scoped=true");
...
/* harmony import */ var _profit_and_loss_vue_vue_type_style_index_0_id_b6b30cee_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./profit_and_loss.vue?vue&type=style&index=0&id=b6b30cee&scoped=true&lang=css */ "./resources/src/views/app/pages/reports/profit_and_loss.vue?vue&type=style&index=0&id=b6b30cee&scoped=true&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _profit_and_loss_vue_vue_type_template_id_b6b30cee_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _profit_and_loss_vue_vue_type_template_id_b6b30cee_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "b6b30cee",
  null
...
/***/ "./resources/src/views/app/pages/reports/profit_and_loss.vue?vue&type=template&id=b6b30cee&scoped=true"
/*!*************************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/profit_and_loss.vue?vue&type=template&id=b6b30cee&scoped=true ***!
  \*************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_profit_and_loss_vue_vue_type_template_id_b6b30cee_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_profit_and_loss_vue_vue_type_template_id_b6b30cee_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_profit_and_loss_vue_vue_type_template_id_b6b30cee_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./profit_and_loss.vue?vue&type=template&id=b6b30cee&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/profit_and_loss.vue?vue&type=template&id=b6b30cee&scoped=true");


/***/ },

/***/ "./resources/src/views/app/pages/reports/profit_and_loss.vue?vue&type=style&index=0&id=b6b30cee&scoped=true&lang=css"
/*!***************************************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/profit_and_loss.vue?vue&type=style&index=0&id=b6b30cee&scoped=true&lang=css ***!
  \***************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_profit_and_loss_vue_vue_type_style_index_0_id_b6b30cee_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./profit_and_loss.vue?vue&type=style&index=0&id=b6b30cee&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/profit_and_loss.vue?vue&type=style&index=0&id=b6b30cee&scoped=true&lang=css");
