...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    printTableOnly: function printTableOnly() {
      var _this$rows$,
        _this = this;
      var title = "".concat(this.$t("Reports"), " / ").concat(this.$t("Dead_Stock_Report"));
      var items = Array.isArray((_this$rows$ = this.rows[0]) === null || _this$rows$ === void 0 ? void 0 : _this$rows$.children) ? this.rows[0].children : [];
        ...
        _this.columns.forEach(function (col) {
          ...
          if (col.field === 'code') {
            ...
            if (!item.last_movement_at) {
              cellValue = _this.$t('Never_Moved') || 'Never Moved';
            } else {
    ...
    fetchDeadStock: function fetchDeadStock() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var page, qp, config, _yield$axios$get, data, items, r, _axios$isCancel, _axios, _this2$$bvToast, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              page = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : 1;
              // cancel previous in-flight request (if any)
              if (_this2._cancelSource && typeof _this2._cancelSource.cancel === 'function') {
                _this2._cancelSource.cancel('New request triggered');
              }
              _this2._cancelSource = axios.CancelToken ? axios.CancelToken.source() : null;
              nprogress__WEBPACK_IMPORTED_MODULE_0___default().start();
              nprogress__WEBPACK_IMPORTED_MODULE_0___default().set(0.1);
              _this2.isLoading = true;
              _context.p = 1;
              qp = _this2._buildQuery({
                page: page
              });
              config = _this2._cancelSource ? {
                cancelToken: _this2._cancelSource.token
              } : {};
              _context.n = 2;
            ...
            case 2:
              ...
              r = data.range || {};
              _this2.range = {
                from: Number(r.from || (_this2.totalRows ? 1 : 0)),
                to: Number(r.to || Math.min(_this2.totalRows, (_this2.serverParams.page - 1) * (_this2.serverParams.perPage === -1 ? _this2.totalRows : _this2.serverParams.perPage) + items.length))
              };
            ...
            case 3:
              ...
              if (!((_axios$isCancel = (_axios = axios).isCancel) !== null && _axios$isCancel !== void 0 && _axios$isCancel.call(_axios, _t))) {
                (_this2$$bvToast = _this2.$bvToast) === null || _this2$$bvToast === void 0 || _this2$$bvToast.toast(_this2.$t('UnexpectedError') || 'Unexpected error.', {
                  variant: 'danger',
                  solid: true
                });
    ...
    exportPdf: function exportPdf() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var _this3$rows, items, _this3$$bvToast, _t2;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              ...
              _context2.p = 2;
              items = ((_this3$rows = _this3.rows) === null || _this3$rows === void 0 || (_this3$rows = _this3$rows[0]) === null || _this3$rows === void 0 ? void 0 : _this3$rows.children) || [];
              _context2.n = 3;
    ...
    exportPdfAll: function exportPdfAll() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var _this4$_buildQuery, _this4$serverParams, _this4$serverParams2, qp, _yield$axios$get2, data, items, _this4$$bvToast, _t3;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              if (!_this4.disableExport) {
                _context3.n = 1;
                break;
              }
              return _context3.a(2);
            case 1:
              _this4.exporting = true;
              nprogress__WEBPACK_IMPORTED_MODULE_0___default().start();
              nprogress__WEBPACK_IMPORTED_MODULE_0___default().set(0.2);
              _context3.p = 2;
              qp = ((_this4$_buildQuery = _this4._buildQuery) === null || _this4$_buildQuery === void 0 ? void 0 : _this4$_buildQuery.call(_this4, {
                page: 1,
                limitOverride: -1
              })) || new URLSearchParams({
                page: '1',
                limit: '-1',
                SortField: ((_this4$serverParams = _this4.serverParams) === null || _this4$serverParams === void 0 || (_this4$serverParams = _this4$serverParams.sort) === null || _this4$serverParams === void 0 ? void 0 : _this4$serverParams.field) || 'last_movement_at',
                SortType: ((_this4$serverParams2 = _this4.serverParams) === null || _this4$serverParams2 === void 0 || (_this4$serverParams2 = _this4$serverParams2.sort) === null || _this4$serverParams2 === void 0 ? void 0 : _this4$serverParams2.type) || 'asc',
                search: _this4.search || '',
                period: String(_this4.period),
                warehouse_id: _this4.warehouse_id || '',
                brand_id: _this4.brand_id || '',
            ...
            case 3:
              ...
              _context3.n = 4;
              return _this4._buildAndSavePdf(items, {
                suffix: 'all'
              });
            case 4:
              _context3.n = 6;
            ...
            case 5:
              _context3.p = 5;
              _t3 = _context3.v;
              (_this4$$bvToast = _this4.$bvToast) === null || _this4$$bvToast === void 0 || _this4$$bvToast.toast(_this4.$t ? _this4.$t('Export_Failed') : 'Export failed. Please try again.', {
                variant: 'danger',
                solid: true
              });
              // eslint-disable-next-line no-console
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            ...
            case 2:
              ...
              // RTL detection
              rtl = _this5.$i18n && ['ar', 'fa', 'ur', 'he'].includes(_this5.$i18n.locale) || typeof document !== 'undefined' && document.documentElement.dir === 'rtl'; // Localized labels (fallback to English)
              t = function t(k, d) {
                return _this5.$t ? _this5.$t(k) : d || k;
              };
              title = t('Dead_Stock_Report', 'Dead Stock Report'); // Period label from your dropdown (already localized in UI)
              periodLabel = ((_find = (_this5.periodOptions || []).find(function (o) {
                return String(o.value) === String(_this5.period);
              })) === null || _find === void 0 ? void 0 : _find.text) || {
                '30': 'Last 30 days',
                '60': 'Last 60 days',
                '90': 'Last 90 days'
              }[String(_this5.period)] || String(_this5.period); // Try to resolve names for filters if lists exist; fallback to ID
              ...
              warehouseLabel = _this5.warehouses ? getLabel(_this5.warehouses, _this5.warehouse_id, 'name') : _this5.warehouse_id || t('All', 'All');
              brandLabel = _this5.brands ? getLabel(_this5.brands, _this5.brand_id, 'name') : _this5.brand_id || null;
              categoryLabel = _this5.categories ? getLabel(_this5.categories, _this5.category_id, 'name') : _this5.category_id || null; // Header
              margin = 40;
              ...
              doc.setFont('Vazirmatn', 'normal');
              doc.setFontSize(10);
              filtersLine = ["".concat(t('Period', 'Period'), ": ").concat(periodLabel), _this5.warehouse_id ? "".concat(t('warehouse', 'Warehouse'), ": ").concat(warehouseLabel) : "".concat(t('warehouse', 'Warehouse'), ": ").concat(t('All', 'All')), _this5.brand_id ? "".concat(t('Brand', 'Brand'), ": ").concat(brandLabel) : null, _this5.category_id ? "".concat(t('Category', 'Category'), ": ").concat(categoryLabel) : null, _this5.search ? "".concat(t('Search_this_table', 'Search'), ": \"").concat(_this5.search, "\"") : null].filter(Boolean).join('   •   ');
              ...
              file = "dead_stock_".concat(String(_this5.period), "_").concat(suffix, "_").concat(stamp, ".pdf");
              doc.save(file);
            case 3:
