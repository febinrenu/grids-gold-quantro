...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapGetters)(["currentUserPermissions", "currentUser"])), {}, {
    ...
    firstBatchErrorDetail: function firstBatchErrorDetail() {
      ...
      return this.details.find(function (d) {
        if (!d || !d.is_batch_tracked) return false;
        if (!Array.isArray(d.batches) || d.batches.length === 0) return true;
        return _this2.batchQtyMismatch(d);
      }) || null;
    },
    // True if any serialized line's serial count doesn't match its quantity.
    ...
    firstSerialErrorDetail: function firstSerialErrorDetail() {
      var _this4 = this;
      if (!Array.isArray(this.details)) return null;
      return this.details.find(function (d) {
        return _this4.serialCountMismatch(d);
      }) || null;
    }
  }),
  methods: {
    ...
    Submit_Purchase: function Submit_Purchase() {
      ...
      // Block submission when a serialized line's serial count != quantity.
      if (this.purchase.statut === 'received' && this.hasSerialValidationErrors) {
        var _d = this.firstSerialErrorDetail;
        this.makeToast("danger", "".concat(this.$t('Serials_Count_Mismatch'), " ").concat(_d ? '(' + _d.name + ')' : ''), this.$t("Failed"));
        return;
      }
      ...
      if (this.purchase.warehouse_id != "" && this.purchase.warehouse_id != null) {
        this.timer = setTimeout(function () {
          ...
          if (product_filter.length === 1) {
            _this0.SearchProduct(product_filter[0]);
          } else {
            ...
            if (_this0.product_filter.length <= 0) {
              _this0.makeToast("warning", "Product Not Found", "Warning");
            }
          }
        }, 800);
      } else {
    ...
    Get_Product_Details: function Get_Product_Details(product_id, variant_id) {
      ...
      axios.get(url).then(function (response) {
        ...
        _this11.product.Net_cost = response.data.Net_cost;
        _this11.product.Unit_cost = response.data.Unit_cost;
        _this11.product.taxe = response.data.tax_cost;
        _this11.product.tax_method = response.data.tax_method;
        _this11.product.tax_percent = response.data.tax_percent;
        _this11.product.unitPurchase = response.data.unitPurchase;
        _this11.product.fix_cost = response.data.fix_cost;
        _this11.product.purchase_unit_id = response.data.purchase_unit_id;
        _this11.product.is_imei = response.data.is_imei;
        _this11.product.imei_number = '';
        _this11.$set(_this11.product, 'serial_numbers', []);
        _this11.product.is_batch_tracked = !!response.data.is_batch_tracked;
        _this11.$set(_this11.product, 'batches', []);
        _this11.product.warehouse_location = response.data.warehouse_location ? response.data.warehouse_location.name ? "".concat(response.data.warehouse_location.code, " - ").concat(response.data.warehouse_location.name) : response.data.warehouse_location.code : null;
        _this11.add_product();
        _this11.Calcul_Total();
      });
    },
    //------------------------------ Quick Add Supplier -------------------------\\
    Quick_Add_Supplier: function Quick_Add_Supplier() {
      this.reset_Form_supplier();
      this.$bvModal.show("Quick_Add_Supplier");
    },
    reset_Form_supplier: function reset_Form_supplier() {
      this.supplier = {
        id: "",
        name: "",
        email: "",
    ...
    Submit_Quick_Add_Supplier: function Submit_Quick_Add_Supplier() {
      var _this12 = this;
      nprogress__WEBPACK_IMPORTED_MODULE_1___default().start();
      nprogress__WEBPACK_IMPORTED_MODULE_1___default().set(0.1);
      this.SubmitProcessing = true;
      this.$refs.Quick_Add_Supplier_Form && this.$refs.Quick_Add_Supplier_Form.validate().then(function (success) {
        if (!success) {
          nprogress__WEBPACK_IMPORTED_MODULE_1___default().done();
        ...
        axios.post("providers", {
          name: _this12.supplier.name,
          email: _this12.supplier.email || "",
          phone: _this12.supplier.phone || "",
          tax_number: _this12.supplier.tax_number || "",
          country: _this12.supplier.country || "",
          city: _this12.supplier.city || "",
          adresse: _this12.supplier.adresse || ""
        }).then(function (_ref3) {
          var data = _ref3.data;
          nprogress__WEBPACK_IMPORTED_MODULE_1___default().done();
          _this12.SubmitProcessing = false;
          var newSupplier = data && data.provider ? data.provider : data;
          if (newSupplier && newSupplier.id) {
            _this12.suppliers.push({
              id: newSupplier.id,
              name: newSupplier.name,
              phone: newSupplier.phone || ""
            });
            _this12.purchase.supplier_id = newSupplier.id;
          }
          _this12.makeToast("success", _this12.$t("Successfully_Created"), _this12.$t("Success"));
          _this12.$bvModal.hide("Quick_Add_Supplier");
          _this12.reset_Form_supplier();
        })["catch"](function (error) {
          nprogress__WEBPACK_IMPORTED_MODULE_1___default().done();
          _this12.SubmitProcessing = false;
    ...
    GetElements: function GetElements() {
      ...
      axios.get("purchases/create").then(function (response) {
        _this13.suppliers = response.data.suppliers;
...
var render = function render() {
  ...
  return _c("div", {
    ...
    ref: "Quick_Add_Supplier_Form"
  }, [_c("b-modal", {
    attrs: {
      "hide-footer": "",
      size: "lg",
      id: "Quick_Add_Supplier",
      title: _vm.$t("Quick_Add_Supplier")
    }
  }, [_c("b-form", {
    staticClass: "quick-add-supplier-form",
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.Submit_Quick_Add_Supplier.apply(null, arguments);
      }
    }
  }, [_c("b-row", [_c("b-col", {
    attrs: {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(validationContext) {
        return [_c("b-form-group", {
          ...
          attrs: {
            id: "supplier-name-feedback"
          }
        }, [_vm._v(_vm._s(validationContext.errors[0]))])], 1)];
      }
    }], null, false, 3335898420)
  })], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "6",
      sm: "12"
    ...
    model: {
      value: _vm.supplier.country,
      callback: function callback($$v) {
        _vm.$set(_vm.supplier, "country", $$v);
      },
      expression: "supplier.country"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "6",
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.supplier.adresse,
      expression: "supplier.adresse"
    }],
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.supplier, "adresse", $event.target.value);
      }
    }
  })])], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mt-3",
    ...
    on: {
      click: function click($event) {
        return _vm.$bvModal.hide("Quick_Add_Supplier");
      }
    }
  ...
  }, [_vm._v(_vm._s(_vm.$t("submit")))]), _vm._v(" "), _vm.SubmitProcessing ? _vm._m(0) : _vm._e()], 1)], 1)], 1)], 1)], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
      lg: "4",
      md: "4",
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        ...
        }), _vm._v(" "), _vm.currentUserPermissions && _vm.currentUserPermissions.includes("Suppliers_add") ? _c("b-input-group-append", [_c("b-button", {
    ...
    }, [_vm._v("+")])])], 1)], 1)]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.DiscountNet * detail.quantity, _vm.priceDecimals)))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.formatNumber(detail.taxe * detail.quantity, _vm.priceDecimals)))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(detail.subtotal.toFixed(_vm.priceDecimals)))]), _vm._v(" "), _c("td", [_vm.currentUserPermissions && _vm.currentUserPermissions.includes("edit_product_purchase") ? _c("lucide-icon", {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_create_purchase_vue_vue_type_style_index_0_id_3022e24c_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./create_purchase.vue?vue&type=style&index=0&id=3022e24c&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/purchases/create_purchase.vue?vue&type=style&index=0&id=3022e24c&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_create_purchase_vue_vue_type_style_index_0_id_3022e24c_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_create_purchase_vue_vue_type_style_index_0_id_3022e24c_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./create_purchase.vue?vue&type=style&index=0&id=3022e24c&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/purchases/create_purchase.vue?vue&type=style&index=0&id=3022e24c&lang=css");
