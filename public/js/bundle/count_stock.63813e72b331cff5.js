...
var render = function render() {
  ...
  return _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        return [props.column.field == "file_stock" ? _c("span", [_c("a", {
          attrs: {
            href: _vm.$imgUrl("count_stock", props.row.file_stock)
          }
        }, [_c("span", {
          staticClass: "ul-btn__text ml-1"
        }, [_vm._v(" " + _vm._s(_vm.$t("Download")))])])]) : _vm._e()];
      }
    }], null, false, 3470360464)
  }, [_c("div", {
    ...
    model: {
      value: _vm.stock.category_id,
      callback: function callback($$v) {
        _vm.$set(_vm.stock, "category_id", $$v);
      },
      expression: "stock.category_id"
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mt-3",
    attrs: {
