"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["Batch_Register_Report"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=script&lang=js"
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=script&lang=js ***!
  \*****************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(["currentUser"])), {}, {
    ...
    columns: function columns() {
      return [{
        ...
        label: this.$t('Unit_Cost') || 'Unit Cost',
        field: 'unit_cost',
        sortable: false,
        tdClass: 'text-right',
        thClass: 'text-right'
        ...
        label: this.$t('Purchase_Ref') || 'Purchase Ref',
        field: 'origin_purchase_ref',
        sortable: false,
        tdClass: 'text-left',
        thClass: 'text-left'
      }, {
        label: this.$t('Supplier') || 'Supplier',
        field: 'origin_supplier_name',
        sortable: false,
        tdClass: 'text-left',
        thClass: 'text-left'
      }, {
  ...
  methods: {
    ...
    openHistory: function openHistory(row) {
      this.$router.push({
    ...
    fetch: function fetch(page) {
      ...
      axios.get('report/batches/register', {
        params: params
      }).then(function (response) {
        _this.rows = response.data.batches || [];
    ...
    printTableOnly: function printTableOnly() {
      var _this2 = this;
      var title = "".concat(this.$t('Reports'), " / ").concat(this.$t('Batch_Register_Report') || 'Batch Register');
      var items = this.rows || [];
      var html = '<table style="width:100%; border-collapse:collapse; font-size:11px;">';
      html += '<thead><tr>';
      var headers = ['Product', 'Batch No', 'Warehouse', 'Mfg', 'Expiry', 'Qty', 'Unit Cost', 'Value', 'Status', 'Purchase Ref', 'Supplier'];
      ...
      items.forEach(function (r) {
        html += '<tr>';
        html += "<td style=\"border:1px solid #ddd; padding:6px;\">".concat(r.product_name || '').concat(r.product_code ? ' [' + r.product_code + ']' : '', "</td>");
        html += "<td style=\"border:1px solid #ddd; padding:6px;\">".concat(r.batch_no || '', "</td>");
        html += "<td style=\"border:1px solid #ddd; padding:6px;\">".concat(r.warehouse_name || '', "</td>");
        html += "<td style=\"border:1px solid #ddd; padding:6px;\">".concat(r.mfg_date || '—', "</td>");
        html += "<td style=\"border:1px solid #ddd; padding:6px;\">".concat(r.expiry_date || '—', "</td>");
        html += "<td style=\"border:1px solid #ddd; padding:6px; text-align:right;\">".concat(_this2.formatNumber(r.qty), "</td>");
        html += "<td style=\"border:1px solid #ddd; padding:6px; text-align:right;\">".concat(r.unit_cost !== null ? _this2.formatNumber(r.unit_cost, _this2.priceDecimals) : '—', "</td>");
        html += "<td style=\"border:1px solid #ddd; padding:6px; text-align:right;\">".concat(r.value !== null ? _this2.formatNumber(r.value, _this2.priceDecimals) : '—', "</td>");
        html += "<td style=\"border:1px solid #ddd; padding:6px;\">".concat(r.status || '', "</td>");
        html += "<td style=\"border:1px solid #ddd; padding:6px;\">".concat(r.origin_purchase_ref || '—', "</td>");
        html += "<td style=\"border:1px solid #ddd; padding:6px;\">".concat(r.origin_supplier_name || '—', "</td>");
        html += '</tr>';
      });
      html += '</tbody></table>';
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=template&id=6e8e8c64"
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=template&id=6e8e8c64 ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      page: _vm.$t("Batch_Register_Report") || "Batch Register",
    ...
    staticClass: "mb-0 mr-2 d-block"
  }, [_vm._v(_vm._s(_vm.$t("Warehouse")))]), _vm._v(" "), _c("b-form-select", {
    staticClass: "w-auto",
    attrs: {
      size: "sm"
    },
    ...
    staticClass: "mb-0 mr-2 d-block"
  }, [_vm._v(_vm._s(_vm.$t("Supplier") || "Supplier"))]), _vm._v(" "), _c("b-form-select", {
    staticClass: "w-auto",
    attrs: {
      size: "sm"
    },
  ...
  }, [_vm._v(_vm._s(_vm.$t("All")))]), _vm._v(" "), _vm._l(_vm.suppliers, function (s) {
    return _c("option", {
      key: s.id,
      domProps: {
        value: s.id
    ...
    staticClass: "mb-0 mr-2 d-block"
  }, [_vm._v(_vm._s(_vm.$t("Expiry_Window")))]), _vm._v(" "), _c("b-form-select", {
    staticClass: "w-auto",
    attrs: {
      size: "sm"
    },
  ...
  }, [_vm._v(_vm._s(_vm.$t("Valid")))]), _vm._v(" "), _c("option", {
    attrs: {
      value: "expired_or_near"
    }
  }, [_vm._v(_vm._s(_vm.$t("Expired")) + " + " + _vm._s(_vm.$t("Near_Expiry")))])])], 1), _vm._v(" "), _c("div", {
    staticClass: "mr-3 mb-2"
  }, [_c("label", {
    staticClass: "mb-0 mr-2 d-block"
  }, [_vm._v(_vm._s(_vm.$t("Status")))]), _vm._v(" "), _c("b-form-select", {
    staticClass: "w-auto",
    attrs: {
      size: "sm"
    },
  ...
  }, [_vm._v(_vm._s(_vm.$t("Batch_Status_written_off")))])])], 1), _vm._v(" "), _c("div", {
    staticClass: "mr-3 mb-2"
  }, [_c("label", {
    staticClass: "mb-0 mr-2 d-block"
  }, [_vm._v(_vm._s(_vm.$t("From") || "From"))]), _vm._v(" "), _c("b-form-input", {
    staticStyle: {
      width: "140px"
    },
    attrs: {
    ...
    model: {
      value: _vm.filters.purchase_date_from,
      callback: function callback($$v) {
        _vm.$set(_vm.filters, "purchase_date_from", $$v);
      },
      expression: "filters.purchase_date_from"
    }
  })], 1), _vm._v(" "), _c("div", {
    staticClass: "mr-3 mb-2"
  }, [_c("label", {
    staticClass: "mb-0 mr-2 d-block"
  }, [_vm._v(_vm._s(_vm.$t("To") || "To"))]), _vm._v(" "), _c("b-form-input", {
    staticStyle: {
      width: "140px"
    },
    attrs: {
    ...
    model: {
      value: _vm.filters.purchase_date_to,
      callback: function callback($$v) {
        _vm.$set(_vm.filters, "purchase_date_to", $$v);
      },
      expression: "filters.purchase_date_to"
    }
  })], 1), _vm._v(" "), _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        return [props.column.field === "product" ? _c("span", [_c("div", [_c("strong", [_vm._v(_vm._s(props.row.product_name))]), _vm._v(" "), props.row.product_code ? _c("small", {
        ...
        }, [_vm._v("\n            " + _vm._s(props.row.generic_name) + "\n            "), props.row.strength ? _c("span", [_vm._v(" · " + _vm._s(props.row.strength))]) : _vm._e(), _vm._v(" "), props.row.dosage_form ? _c("span", [_vm._v(" · " + _vm._s(props.row.dosage_form))]) : _vm._e()]) : _vm._e(), _vm._v(" "), props.row.variant_name ? _c("div", [_c("span", {
          staticClass: "badge badge-pill",
          staticStyle: {
            background: "#ede9fe",
            color: "#6d28d9"
          }
        }, [_vm._v(_vm._s(props.row.variant_name))])]) : _vm._e()]) : props.column.field === "batch_no" ? _c("span", [_c("a", {
          ...
          on: {
            click: function click($event) {
              ...
              return _vm.openHistory(props.row);
            }
          }
        }, [_vm._v("\n            " + _vm._s(props.row.batch_no || "—") + "\n          ")])]) : props.column.field === "expiry_date" ? _c("span", [props.row.expiry_date ? _c("span", [_vm._v("\n            " + _vm._s(props.row.expiry_date) + "\n            "), _c("br"), _vm._v(" "), _c("small", {
          "class": {
          ...
          staticClass: "text-muted"
        }, [_vm._v("—")])]) : props.column.field === "qty" ? _c("span", [_vm._v("\n          " + _vm._s(_vm.formatNumber(props.row.qty)) + "\n        ")]) : props.column.field === "unit_cost" ? _c("span", [props.row.unit_cost !== null ? _c("span", [_vm._v("\n            " + _vm._s(_vm.currencySymbol) + " " + _vm._s(_vm.formatNumber(props.row.unit_cost, _vm.priceDecimals)) + "\n          ")]) : _c("span", {
          staticClass: "text-muted"
        }, [_vm._v("—")])]) : props.column.field === "value" ? _c("span", [props.row.value !== null ? _c("span", [_vm._v("\n            " + _vm._s(_vm.currencySymbol) + " " + _vm._s(_vm.formatNumber(props.row.value, _vm.priceDecimals)) + "\n          ")]) : _c("span", {
          staticClass: "text-muted"
        }, [_vm._v("—")])]) : props.column.field === "origin_purchase_ref" ? _c("span", [props.row.origin_purchase_id ? _c("router-link", {
          staticClass: "text-primary",
          attrs: {
            to: {
              name: "detail_purchase",
              params: {
                id: props.row.origin_purchase_id
              }
            }
          }
        }, [_vm._v("\n            " + _vm._s(props.row.origin_purchase_ref) + "\n          ")]) : _c("span", {
          staticClass: "text-muted"
        }, [_vm._v("—")]), _vm._v(" "), props.row.origin_purchase_date ? _c("div", {
          staticClass: "small text-muted"
        }, [_vm._v("\n            " + _vm._s(props.row.origin_purchase_date) + "\n          ")]) : _vm._e()], 1) : props.column.field === "origin_supplier_name" ? _c("span", [_vm._v("\n          " + _vm._s(props.row.origin_supplier_name || "—") + "\n        ")]) : props.column.field === "status" ? _c("span", [_c("span", {
          staticClass: "badge",
          "class": _vm.statusBadge(props.row.status)
        }, [_vm._v("\n            " + _vm._s(_vm.$t("Batch_Status_" + props.row.status) || props.row.status) + "\n          ")])]) : props.column.field === "actions" ? _c("span", [_c("b-button", {
          staticClass: "btn-pill",
          attrs: {
            size: "sm",
...
/***/ "./resources/src/views/app/pages/reports/Batch_Register_Report.vue"
/*!*************************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/Batch_Register_Report.vue ***!
  \*************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Batch_Register_Report_vue_vue_type_template_id_6e8e8c64__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Batch_Register_Report.vue?vue&type=template&id=6e8e8c64 */ "./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=template&id=6e8e8c64");
/* harmony import */ var _Batch_Register_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Batch_Register_Report.vue?vue&type=script&lang=js */ "./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=script&lang=js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _Batch_Register_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _Batch_Register_Report_vue_vue_type_template_id_6e8e8c64__WEBPACK_IMPORTED_MODULE_0__.render,
  _Batch_Register_Report_vue_vue_type_template_id_6e8e8c64__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
{ var api; }
component.options.__file = "resources/src/views/app/pages/reports/Batch_Register_Report.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ },

/***/ "./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=script&lang=js"
/*!*************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Batch_Register_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Batch_Register_Report.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Batch_Register_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ },

/***/ "./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=template&id=6e8e8c64"
/*!*******************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=template&id=6e8e8c64 ***!
  \*******************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Batch_Register_Report_vue_vue_type_template_id_6e8e8c64__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Batch_Register_Report_vue_vue_type_template_id_6e8e8c64__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Batch_Register_Report_vue_vue_type_template_id_6e8e8c64__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Batch_Register_Report.vue?vue&type=template&id=6e8e8c64 */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Batch_Register_Report.vue?vue&type=template&id=6e8e8c64");
