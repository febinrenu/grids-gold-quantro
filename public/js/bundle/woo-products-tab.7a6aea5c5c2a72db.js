...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    pullOrders: function pullOrders() {
      var _this8 = this;
      if (this.pullingOrders) return;
      this.pullingOrders = true;
      axios.post('woocommerce/sync/orders').then(function (_ref11) {
        var data = _ref11.data;
        if (data && data.ok !== false) {
          var created = data.created != null ? data.created : 0;
          var skipped = data.skipped != null ? data.skipped : 0;
          var errors = data.errors != null ? data.errors : 0;
          var variant = errors > 0 ? 'warning' : 'success';
          _this8.toast(variant, "Orders pulled \u2014 created: ".concat(created, " \xB7 skipped: ").concat(skipped, " \xB7 errors: ").concat(errors));
          _this8.$emit('refreshed');
        } else {
          _this8.toast('danger', "Order sync failed: ".concat(data && data.error || 'Unknown error'));
        }
      })["catch"](function (err) {
        _this8.toast('danger', "Order sync failed: ".concat(err && err.message || 'Network error'));
      })["finally"](function () {
        _this8.pullingOrders = false;
      });
    },
    autoLinkBySku: function autoLinkBySku() {
      var _this9 = this;
      if (this.autoLinking) return;
      this.autoLinking = true;
      axios.post('woocommerce/products/auto-link').then(function (_ref12) {
        var data = _ref12.data;
        if (data && data.ok) {
          var p = data.products || {};
          var v = data.variants || {};
          var variant = (p.linked || 0) + (v.linked || 0) > 0 ? 'success' : 'warning';
          _this9.toast(variant, "Linked ".concat(p.linked || 0, " products & ").concat(v.linked || 0, " variants \xB7 ambiguous: ").concat(p.ambiguous || 0, " \xB7 no match: ").concat(p.no_match || 0));
          // Refresh stats and modal if open
          _this9.load();
          if (_this9.unmappedModal) _this9.loadUnmappedReport();
          _this9.$emit('refreshed');
        } else {
          _this9.toast('danger', "Auto-link failed: ".concat(data && data.error || 'Unknown error'));
        }
      })["catch"](function (err) {
        _this9.toast('danger', "Auto-link failed: ".concat(err && err.message || 'Network error'));
      })["finally"](function () {
        _this9.autoLinking = false;
      });
    },
    openUnmappedModal: function openUnmappedModal() {
      this.unmappedModal = true;
      this.loadUnmappedReport();
    },
    loadUnmappedReport: function loadUnmappedReport() {
      var _this0 = this;
      this.loadingUnmapped = true;
      this.unmappedReport = null;
      axios.get('woocommerce/products/unmapped-report', {
        params: {
          limit: 100
        }
        ...
        if (data && data.ok) {
          _this0.unmappedReport = data;
        } else {
          _this0.toast('danger', "Failed to load report: ".concat(data && data.error || 'Unknown error'));
          _this0.unmappedModal = false;
        }
      })["catch"](function (err) {
        _this0.toast('danger', "Failed to load report: ".concat(err && err.message || 'Network error'));
        _this0.unmappedModal = false;
      })["finally"](function () {
        _this0.loadingUnmapped = false;
      });
    }
  },
...
var render = function render() {
  ...
  return _c("div", [_c("b-tabs", {
  ...
  }, [!_vm.isSyncActive ? [_c("lucide-icon", {
    staticClass: "mr-2",
    attrs: {
      name: "play"
    }
  ...
  }), _vm._v(" "), !_vm.stopping ? _c("span", [_vm._v("Stop Sync")]) : _c("span", [_vm._v("Stopping...")])], 1) : _vm._e(), _vm._v(" "), _vm.isSyncActive ? _c("b-button", {
  ...
  }), _vm._v(" "), !_vm.refreshing ? _c("span", [_vm._v(_vm._s(_vm.$t("Refresh")))]) : _c("span", [_vm._v(_vm._s(_vm.$t("Refresh")) + "...")])], 1) : _vm._e(), _vm._v(" "), _c("b-button", {
  ...
  }), _vm._v(" "), !_vm.resetting ? _c("span", [_vm._v(_vm._s(_vm.$t("Reset_Sync_State")))]) : _c("span", [_vm._v(_vm._s(_vm.$t("Resetting")) + "...")])], 1), _vm._v(" "), _c("b-button", {
  ...
  }, [!_vm.fixingCategories ? [_c("lucide-icon", {
    staticClass: "mr-1",
    attrs: {
      name: "folder"
    }
    ...
    staticClass: "ml-1"
  }, [_vm._v(_vm._s(_vm.displayProcessed) + "/" + _vm._s(_vm.displayTotal) + " products")])], 1) : _vm._e(), _vm._v(" "), _vm.progress.current_sku || _vm.progress.current_product_id ? _c("div", {
    staticClass: "progress-detail-item mb-2"
  }, [_c("lucide-icon", {
    staticClass: "mr-2 text-primary",
    attrs: {
    ...
    staticClass: "ml-1"
  }, [_vm._v(_vm._s(_vm.progress.current_sku || "#".concat(_vm.progress.current_product_id)))])], 1) : _vm._e(), _vm._v(" "), _vm.progress.stage ? _c("div", {
    staticClass: "progress-detail-item mb-2"
  }, [_c("lucide-icon", {
    ...
    staticClass: "ml-1"
  }, [_vm._v(_vm._s(_vm.progress.stage))])], 1) : _vm._e(), _vm._v(" "), _vm.stopping ? _c("div", {
    staticClass: "progress-detail-item mb-2"
  }, [_c("lucide-icon", {
  ...
  }, [_vm._v("Stopping… current item will finish then the sync will stop.")])], 1) : _vm._e(), _vm._v(" "), _vm.progress.failed_products > 0 ? _c("div", {
  ...
  }), _vm._v("\n              " + _vm._s(_vm.$t("View_Logs")) + "\n            ")], 1)], 1) : _vm._e()])], 1) : _vm._e()], 1), _vm._v(" "), _c("b-tab", {
    scopedSlots: _vm._u([{
      key: "title",
      fn: function fn() {
        return [_c("lucide-icon", {
  ...
  }), _vm._v(" "), !_vm.resetting ? _c("span", [_vm._v(_vm._s(_vm.$t("Reset_Sync_State")))]) : _c("span", [_vm._v(_vm._s(_vm.$t("Resetting")) + "...")])], 1)], 1), _vm._v(" "), _c("hr", {
    staticClass: "my-3"
  }), _vm._v(" "), _c("div", {
    ...
    attrs: {
      variant: "primary",
      size: "sm",
      disabled: _vm.pullingOrders || _vm.isSyncActive
    },
    on: {
      click: _vm.pullOrders
    }
  }, [!_vm.pullingOrders ? [_c("lucide-icon", {
    staticClass: "mr-1",
    attrs: {
      name: "shopping-cart"
    }
    ...
    attrs: {
      variant: "info",
      size: "sm",
      disabled: _vm.autoLinking || _vm.isSyncActive
    },
    on: {
      click: _vm.autoLinkBySku
    }
  }, [!_vm.autoLinking ? [_c("lucide-icon", {
    staticClass: "mr-1",
    attrs: {
      name: "link"
    }
    ...
    attrs: {
      variant: "outline-secondary",
      size: "sm",
      disabled: _vm.loadingUnmapped
    },
    on: {
      click: _vm.openUnmappedModal
    }
  }, [!_vm.loadingUnmapped ? [_c("lucide-icon", {
    staticClass: "mr-1",
    attrs: {
      name: "clipboard-list"
    }
    ...
    staticClass: "mini-spinner mr-2"
  }), _vm._v("\n              Loading...\n            ")]], 2)], 1)]), _vm._v(" "), _c("b-modal", {
    attrs: {
      size: "xl",
      title: "Unmapped Items Report",
      "hide-footer": "",
      scrollable: ""
    },
    model: {
      value: _vm.unmappedModal,
      callback: function callback($$v) {
        _vm.unmappedModal = $$v;
      },
      expression: "unmappedModal"
    }
  }, [!_vm.unmappedReport ? _c("div", {
    staticClass: "text-center text-muted py-4"
  }, [_c("span", {
    staticClass: "mini-spinner mr-2"
  }), _vm._v(" Loading...\n        ")]) : _c("div", [_c("p", {
    staticClass: "text-muted small"
  }, [_vm._v("\n            Items below are why orders may fail with "), _c("strong", [_vm._v('"Order contains unmapped products"')]), _vm._v(".\n            Use "), _c("em", [_vm._v("Auto-Link Products by SKU")]), _vm._v(" first to fix the easy ones, then sync products from WooCommerce to import what's still missing.\n          ")]), _vm._v(" "), _c("h6", {
  ...
  }, [_vm._v(_vm._s(_vm.unmappedReport.order_failures.length))])], 1), _vm._v(" "), !_vm.unmappedReport.order_failures.length ? _c("div", {
    staticClass: "text-muted small mb-3"
  }, [_vm._v("No recent failures.")]) : _c("b-table", {
    staticClass: "mb-3",
    attrs: {
      small: "",
      striped: "",
      responsive: "",
      items: _vm.unmappedReport.order_failures,
      fields: _vm.orderFailureFields
    }
  }), _vm._v(" "), _c("h6", {
  ...
  }, [_vm._v(_vm._s(_vm.unmappedReport.unlinked_products.total))])], 1), _vm._v(" "), _c("div", {
    staticClass: "text-muted small"
  }, [_vm._v("Showing latest " + _vm._s(_vm.unmappedReport.unlinked_products.sample.length) + " of " + _vm._s(_vm.unmappedReport.unlinked_products.total) + ".")]), _vm._v(" "), _vm.unmappedReport.unlinked_products.sample.length ? _c("b-table", {
    staticClass: "mb-3",
    attrs: {
      small: "",
      striped: "",
      responsive: "",
      items: _vm.unmappedReport.unlinked_products.sample,
      fields: _vm.unlinkedProductFields
    }
  }) : _vm._e(), _vm._v(" "), _c("h6", {
    staticClass: "mt-4 font-weight-bold"
  }, [_c("lucide-icon", {
  ...
  }, [_vm._v(_vm._s(_vm.unmappedReport.unlinked_variants.total))])], 1), _vm._v(" "), _c("div", {
    staticClass: "text-muted small"
  }, [_vm._v("Showing latest " + _vm._s(_vm.unmappedReport.unlinked_variants.sample.length) + " of " + _vm._s(_vm.unmappedReport.unlinked_variants.total) + ".")]), _vm._v(" "), _vm.unmappedReport.unlinked_variants.sample.length ? _c("b-table", {
    staticClass: "mb-3",
    attrs: {
      small: "",
      striped: "",
      responsive: "",
      items: _vm.unmappedReport.unlinked_variants.sample,
      fields: _vm.unlinkedVariantFields
    }
  ...
  }), _vm._v("\n              Auto-Link by SKU\n            ")], 1)], 1)], 1)]), _vm._v(" "), _vm.isSyncActive && _vm.syncMode === "pull" && !_vm.progress.finished ? _c("b-card", {
    staticClass: "progress-card shadow-sm"
  }, [_c("div", {
    staticClass: "progress-header mb-3"
  }, [_c("h6", {
    ...
    staticClass: "ml-1"
  }, [_vm._v(_vm._s(_vm.progress.current_sku || "#".concat(_vm.progress.current_woocommerce_id)))])], 1) : _vm._e(), _vm._v(" "), _vm.progress.stage ? _c("div", {
    staticClass: "progress-detail-item mb-2"
  }, [_c("lucide-icon", {
    staticClass: "mr-2 text-info",
    attrs: {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsTab_vue_vue_type_style_index_0_id_69529b76_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ProductsTab.vue?vue&type=style&index=0&id=69529b76&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/settings/woocommerce/ProductsTab.vue?vue&type=style&index=0&id=69529b76&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsTab_vue_vue_type_style_index_0_id_69529b76_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsTab_vue_vue_type_style_index_0_id_69529b76_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ProductsTab.vue?vue&type=style&index=0&id=69529b76&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/settings/woocommerce/ProductsTab.vue?vue&type=style&index=0&id=69529b76&scoped=true&lang=css");
