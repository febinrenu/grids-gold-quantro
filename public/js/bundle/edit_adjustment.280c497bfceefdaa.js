...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    // Adjustments have no money — this controls how fractional quantities (e.g. 0.066) display.
    ...
    hasBatchValidationErrors: function hasBatchValidationErrors() {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var total = Math.round(batches.reduce(function (sum, b) {
  ...
  methods: {
    ...
    fetch_batches_for_detail: function fetch_batches_for_detail(detail) {
      ...
      var wid = this.adjustment && this.adjustment.warehouse_id;
      ...
      var existingQtyById = {};
      var existingBatches = Array.isArray(detail.batches) ? detail.batches : [];
      var _iterator6 = _createForOfIteratorHelper(existingBatches),
        _step6;
      try {
      ...
      axios.get("batches_for_adjustment/".concat(productId, "/").concat(wid, "/").concat(variantSeg), {
        timeout: 15000
          ...
          try {
            var _loop = function _loop() {
              ...
              if (b && b.product_batch_id != null) {
                ...
                _this4.$set(b, "batch_no", ab ? ab.batch_no : b.batch_no || "");
                _this4.$set(b, "expiry_date", ab ? ab.expiry_date : b.expiry_date || null);
              }
            };
    ...
    has_batch_validation_errors: function has_batch_validation_errors() {
      if (!Array.isArray(this.details)) return false;
      ...
      try {
        for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
          ...
          var _iterator9 = _createForOfIteratorHelper(batches),
            _step9;
          try {
          ...
          var seen = new Set();
          var _iterator0 = _createForOfIteratorHelper(batches),
            _step0;
          try {
            for (_iterator0.s(); !(_step0 = _iterator0.n()).done;) {
              var _b = _step0.value;
              if (seen.has(_b.product_batch_id)) return true;
              seen.add(_b.product_batch_id);
            }
          } catch (err) {
            _iterator0.e(err);
          } finally {
    ...
    verifiedForm: function verifiedForm() {
      if (this.details.length <= 0) {
        ...
        if (this.has_batch_validation_errors()) {
          this.makeToast("danger", this.$t("Total_batch_qty_mismatch") || "Batch quantities are invalid", this.$t("Failed"));
          return false;
        }
        return true;
      }
    ...
    Selected_Warehouse: function Selected_Warehouse(value) {
      ...
      if (Array.isArray(this.details)) {
        var _iterator1 = _createForOfIteratorHelper(this.details),
          _step1;
        try {
    ...
    Get_Product_Details: function Get_Product_Details(product_id, variant_id) {
      ...
      axios.get("/show_product_data/" + product_id + "/" + variant_id).then(function (response) {
        ...
        _this6.product.type = "add";
        _this6.product.unit = response.data.unit;
        _this6.product.is_batch_tracked = !!response.data.is_batch_tracked;
        _this6.add_product();
      });
    },
    ...
    GetElements: function GetElements() {
      ...
      axios.get("adjustments/".concat(id, "/edit")).then(function (response) {
        _this7.adjustment = response.data.adjustment;
        _this7.details = response.data.details;
        _this7.warehouses = response.data.warehouses;
        _this7.Get_Products_By_Warehouse(_this7.adjustment.warehouse_id);
        ...
        if (Array.isArray(_this7.details)) {
          var _iterator10 = _createForOfIteratorHelper(_this7.details),
            _step10;
          try {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    return [_c("tr", {
    ...
    }, [_vm._v("\n                                    · " + _vm._s(_vm.$t("Total") || "Total") + ": " + _vm._s(_vm.formatNumber(_vm.batch_total_qty(detail), _vm.priceDecimals)) + " / " + _vm._s(_vm.formatNumber(Number(detail.quantity) || 0, _vm.priceDecimals)) + "\n                                  ")]) : _vm._e()])], 1), _vm._v(" "), _c("button", {
      staticStyle: {
        padding: "4px 10px",
        "font-size": "11px",
        "font-weight": "600",
    ...
    }), _vm._v("\n                              " + _vm._s(_vm.$t("Loading") || "Loading...") + "\n                            ")]) : detail.type !== "add" && !(detail.available_batches && detail.available_batches.length) ? _c("div", {
      staticStyle: {
        padding: "12px 14px",
        "text-align": "center",
        color: "#b91c1c",
    ...
    }), _vm._v(" "), detail.type === "add" ? _c("span", [_vm._v("\n                                " + _vm._s(_vm.$t("Adjustment_Add_Batch_Hint") || 'For "Addition" adjustments, the per-batch ledger is only updated when you provide explicit batch info.') + "\n                              ")]) : _c("span", [_vm._v("\n                                " + _vm._s(_vm.$t("Adjustment_Sub_Batch_Hint") || 'Click "Add" to pick a batch (or leave empty to auto-allocate FEFO on save).') + "\n                              ")])], 1) : _c("table", {
      staticStyle: {
        width: "100%",
      ...
      }, [_vm._v("\n                                    " + _vm._s(_vm.formatNumber(Number(b.qty_available) || 0, _vm.priceDecimals)) + "\n                                  ")]), _vm._v(" "), _c("td", {
        staticStyle: {
          padding: "6px 8px",
          "vertical-align": "middle"
        }
    ...
    }), _vm._v("\n                              " + _vm._s(_vm.$t("Total_batch_qty_mismatch") || "Total batch quantity does not match the line quantity") + "\n                              (" + _vm._s(_vm.formatNumber(_vm.batch_total_qty(detail), _vm.priceDecimals)) + " / " + _vm._s(_vm.formatNumber(Number(detail.quantity) || 0, _vm.priceDecimals)) + ")\n                            ")], 1) : _vm._e()])])]) : _vm._e()];
  })], 2)])])]), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "12"
    }
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_Adjustment_vue_vue_type_style_index_0_id_09aad8bd_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Edit_Adjustment.vue?vue&type=style&index=0&id=09aad8bd&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/adjustment/Edit_Adjustment.vue?vue&type=style&index=0&id=09aad8bd&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_Adjustment_vue_vue_type_style_index_0_id_09aad8bd_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_Adjustment_vue_vue_type_style_index_0_id_09aad8bd_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Edit_Adjustment.vue?vue&type=style&index=0&id=09aad8bd&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/adjustment/Edit_Adjustment.vue?vue&type=style&index=0&id=09aad8bd&lang=css");
