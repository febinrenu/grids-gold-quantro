...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    printTableOnly: function printTableOnly() {
      var _this$rows$,
        _this = this;
      var title = "".concat(this.$t("Reports"), " / ").concat(this.$t("CustomersReport"));
      var clients = Array.isArray((_this$rows$ = this.rows[0]) === null || _this$rows$ === void 0 ? void 0 : _this$rows$.children) ? this.rows[0].children : [];
      ...
      clients.forEach(function (client) {
        ...
        _this.columns.filter(function (col) {
          ...
          if (col.field === 'name') {
            ...
            cellValue = _this.formatNumber(client[col.field] || 0, _this.priceDecimals);
          } else {
    ...
    Get_Client_Report: function Get_Client_Report(page) {
      ...
      axios.get("report/client?page=" + page + "&SortField=" + this.serverParams.sort.field + "&SortType=" + this.serverParams.sort.type + "&search=" + this.search + "&limit=" + this.limit).then(function (response) {
        _this2.clients = response.data.report;
        _this2.totalRows = response.data.totalRows;
        _this2.rows[0].children = _this2.clients;
