(self["webpackChunk"] = self["webpackChunk"] || []).push([["cash_register_report"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=script&lang=js"
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=script&lang=js ***!
  \****************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    columns: function columns() {
      ...
      // vue-good-table re-formats decimal type, causing NaN when parsing strings like "1,234.56"
      {
        ...
        headerField: this.sumOpeningBalance,
        thClass: 'text-right',
        tdClass: 'text-right',
        sortable: true
      }, {
        label: this.$t('Cash In'),
        field: 'cash_in',
        headerField: this.sumCashIn,
        thClass: 'text-right',
        tdClass: 'text-right',
        sortable: true
      }, {
        label: this.$t('Cash Out'),
        field: 'cash_out',
        headerField: this.sumCashOut,
        thClass: 'text-right',
        tdClass: 'text-right',
        sortable: true
      }, {
        ...
        headerField: this.sumClosingBalance,
        thClass: 'text-right',
        tdClass: 'text-right',
        sortable: true
      }, {
        ...
        field: 'difference',
        headerField: this.sumDifference,
        thClass: 'text-right',
        tdClass: 'text-right',
        sortable: true
      }, {
  ...
  created: function created() {
    var _this = this;
    this.bootstrapFilters()["finally"](function () {
      _this.getData(1);
    });
  },
  methods: {
    ...
    onDateRangeUpdate: function onDateRangeUpdate() {
      this.getData(1);
    },
    bootstrapFilters: function bootstrapFilters() {
    ...
    getData: function getData() {
      ...
      var preloadOnly = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      ...
      return axios.get('report/cash_registers', {
        params: params
      }).then(function (res) {
        // Mirrors sales_report payload style
        var payload = res.data || {};
        var data = payload.registers || [];
        if (!preloadOnly) {
          _this2.rows[0].children = data;
          _this2.totalRows = payload.totalRows || data.length;
        }
        // Preload users & warehouses for filters
        if (Array.isArray(payload.users)) {
          var users = payload.users.map(function (x) {
            return {
              value: x.id,
              text: x.firstname && x.lastname ? x.firstname + ' ' + x.lastname : x.username || x.name || 'User #' + x.id
            };
          });
          _this2.userOptions = [{
            value: '',
        ...
        if (Array.isArray(payload.warehouses)) {
          var warehouses = payload.warehouses.map(function (x) {
            return {
              value: x.id,
              text: x.name
            };
          });
          _this2.warehouseOptions = [{
            value: '',
            text: _this2.$t('All')
          }].concat(_toConsumableArray(warehouses));
        }
      })["catch"](function () {
        if (_this2.$bvToast && _this2.$bvToast.toast) _this2.$bvToast.toast(_this2.$t('OperationFailed'), {
    ...
    formatMoney: function formatMoney(x) {
      try {
        ...
        return (0,_utils_priceFormat__WEBPACK_IMPORTED_MODULE_5__.formatPriceDisplay)(n, this.priceDecimals, effectiveKey);
      } catch (e) {
        var _n = parseFloat(x || 0);
        return _n.toFixed(this.priceDecimals);
      }
    },
    formatDate: function formatDate(x) {
      if (!x) return '-';
      ...
      return _utils__WEBPACK_IMPORTED_MODULE_4__["default"].formatDisplayDate(x, dateFormat);
    },
    formatCashier: function formatCashier(row) {
      var first = row.cashier_firstname || '';
      var last = row.cashier_lastname || '';
    ...
    sumOpeningBalance: function sumOpeningBalance(rowObj) {
      if (!rowObj || !Array.isArray(rowObj.children)) {
        return this.formatMoney(0);
      }
      var sum = 0;
      for (var i = 0; i < rowObj.children.length; i++) {
        var value = parseFloat(rowObj.children[i].opening_balance || 0);
    ...
    sumCashIn: function sumCashIn(rowObj) {
      if (!rowObj || !Array.isArray(rowObj.children)) {
        return this.formatMoney(0);
      }
      var sum = 0;
      for (var i = 0; i < rowObj.children.length; i++) {
        var value = parseFloat(rowObj.children[i].cash_in || 0);
        if (Number.isFinite(value)) {
          sum += value;
        }
      }
    ...
    sumCashOut: function sumCashOut(rowObj) {
      if (!rowObj || !Array.isArray(rowObj.children)) {
        return this.formatMoney(0);
      }
      var sum = 0;
      for (var i = 0; i < rowObj.children.length; i++) {
        var value = parseFloat(rowObj.children[i].cash_out || 0);
        if (Number.isFinite(value)) {
          sum += value;
        }
      }
    ...
    sumTotalSales: function sumTotalSales(rowObj) {
      ...
      var sum = 0;
      for (var i = 0; i < rowObj.children.length; i++) {
        var value = parseFloat(rowObj.children[i].total_sales || 0);
        if (Number.isFinite(value)) {
          sum += value;
        }
      }
    ...
    sumClosingBalance: function sumClosingBalance(rowObj) {
      if (!rowObj || !Array.isArray(rowObj.children)) {
        return this.formatMoney(0);
      }
      var sum = 0;
      for (var i = 0; i < rowObj.children.length; i++) {
        var value = parseFloat(rowObj.children[i].closing_balance || 0);
        if (Number.isFinite(value)) {
          sum += value;
        }
      }
    ...
    sumDifference: function sumDifference(rowObj) {
      if (!rowObj || !Array.isArray(rowObj.children)) {
        return this.formatMoney(0);
      }
      var sum = 0;
      for (var i = 0; i < rowObj.children.length; i++) {
        var value = parseFloat(rowObj.children[i].difference || 0);
        if (Number.isFinite(value)) {
          sum += value;
        }
      }
    ...
    printTableOnly: function printTableOnly() {
      var _this$rows$,
        _this3 = this;
      var title = "".concat(this.$t("Reports"), " / ").concat(this.$t("Cash_Register_Report"));
      var registers = Array.isArray((_this$rows$ = this.rows[0]) === null || _this$rows$ === void 0 ? void 0 : _this$rows$.children) ? this.rows[0].children : [];
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=template&id=1905a9de&scoped=true"
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=template&id=1905a9de&scoped=true ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      page: _vm.$t("Cash_Register_Report"),
    ...
    staticClass: "col-md-3 mb-2"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("Cashier")))]), _vm._v(" "), _c("b-form-select", {
    attrs: {
  ...
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("Status")))]), _vm._v(" "), _c("b-form-select", {
    attrs: {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        return [props.column.field === "cashier" ? _c("span", [_vm._v("\n          " + _vm._s(_vm.formatCashier(props.row)) + "\n        ")]) : props.column.field === "warehouse" ? _c("span", [_vm._v("\n          " + _vm._s(props.row.warehouse_name) + "\n        ")]) : props.column.field === "opened_at" || props.column.field === "closed_at" ? _c("span", [_vm._v("\n          " + _vm._s(_vm.formatDate(props.row[props.column.field])) + "\n        ")]) : ["opening_balance", "cash_in", "cash_out", "total_sales", "closing_balance", "difference"].includes(props.column.field) ? _c("span", [_vm._v("\n          " + _vm._s(_vm.formatMoney(props.row[props.column.field])) + "\n        ")]) : props.column.field === "status" ? _c("span", [_c("span", {
          staticClass: "badge",
          "class": props.row.status === "open" ? "badge-success" : "badge-danger"
        }, [_vm._v(_vm._s(props.row.status))])]) : _c("span", [_vm._v("\n          " + _vm._s(props.formattedRow[props.column.field]) + "\n        ")])];
      }
    }], null, false, 1980330374)
  }, [_c("div", {
...
/***/ "./resources/src/views/app/pages/reports/Cash_Register_Report.vue"
/*!************************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/Cash_Register_Report.vue ***!
  \************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Cash_Register_Report_vue_vue_type_template_id_1905a9de_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Cash_Register_Report.vue?vue&type=template&id=1905a9de&scoped=true */ "./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=template&id=1905a9de&scoped=true");
/* harmony import */ var _Cash_Register_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Cash_Register_Report.vue?vue&type=script&lang=js */ "./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=script&lang=js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _Cash_Register_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _Cash_Register_Report_vue_vue_type_template_id_1905a9de_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _Cash_Register_Report_vue_vue_type_template_id_1905a9de_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "1905a9de",
  null
...
{ var api; }
component.options.__file = "resources/src/views/app/pages/reports/Cash_Register_Report.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ },

/***/ "./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=script&lang=js"
/*!************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=script&lang=js ***!
  \************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Cash_Register_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Cash_Register_Report.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Cash_Register_Report_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ },

/***/ "./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=template&id=1905a9de&scoped=true"
/*!******************************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=template&id=1905a9de&scoped=true ***!
  \******************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Cash_Register_Report_vue_vue_type_template_id_1905a9de_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Cash_Register_Report_vue_vue_type_template_id_1905a9de_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Cash_Register_Report_vue_vue_type_template_id_1905a9de_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Cash_Register_Report.vue?vue&type=template&id=1905a9de&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/reports/Cash_Register_Report.vue?vue&type=template&id=1905a9de&scoped=true");
